...
# $Header: /var/cvsroot/gentoo-x86/sci-biology/emboss/emboss-6.1.0.ebuild,v 1.6 2011/07/26 19:28:04 xarthisius Exp $
...
src_install() {
	...
	# package.
	rm "${D}"/usr/share/EMBOSS/doc/programs/text/frestdist.txt || \
