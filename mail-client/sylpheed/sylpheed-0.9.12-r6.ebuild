...
# $Header: /var/cvsroot/gentoo-x86/mail-client/sylpheed/sylpheed-0.9.12-r6.ebuild,v 1.1 2004/09/22 13:05:38 hattya Exp $
...
SRC_URI="http://sylpheed.good-day.net/${PN}/${P}.tar.bz2
	gtk2? ( mirror://sourceforge/${PN}-gtk2/${MY_P}.diff.gz
		mirror://sourceforge/${PN}-gtk2/${MY_P}-summary_search_fix.diff.gz )"
...
src_unpack() {
	...
	if use gtk2; then
		...
		epatch ${WORKDIR}/${MY_P}-summary_search_fix.diff
