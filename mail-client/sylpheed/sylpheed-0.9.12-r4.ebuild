...
# $Header: /var/cvsroot/gentoo-x86/mail-client/sylpheed/sylpheed-0.9.12-r4.ebuild,v 1.4 2004/10/11 11:50:23 hattya Exp $
...
SRC_URI="http://sylpheed.good-day.net/${PN}/${P}.tar.bz2
	gtk2? ( mirror://sourceforge/${PN}-gtk2/${P}-gtk2-${GTK2_PV}.diff.gz )"
...
src_unpack() {
	...
	if use gtk2; then
		epatch ${WORKDIR}/${P}-gtk2-${GTK2_PV}.diff
