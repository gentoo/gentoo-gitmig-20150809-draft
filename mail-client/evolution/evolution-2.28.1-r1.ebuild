...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/evolution-2.28.1-r1.ebuild,v 1.1 2009/11/26 19:05:00 mrpouet Exp $
...
src_prepare() {
	...
	# Fix crash when adding a new task or memo, bug #294436,
	# patch import from upstream bug #599627. WILL NOT needed for 2.28.2.
	epatch "${FILESDIR}/${P}-new-task-sigsegv.patch"
