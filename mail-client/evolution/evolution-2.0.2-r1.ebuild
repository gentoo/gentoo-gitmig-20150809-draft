...
# $Header: /var/cvsroot/gentoo-x86/mail-client/evolution/evolution-2.0.2-r1.ebuild,v 1.3 2005/01/24 15:55:46 gustavoz Exp $
...
src_unpack() {
	...
	# bug #67824 -- fix typo of USE -ipv6
	epatch ${FILESDIR}/${P}-camel_typo.patch
	# bug #79183 -- security vuln in camel
