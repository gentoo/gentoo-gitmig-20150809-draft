...
# $Header: /var/cvsroot/gentoo-x86/mail-client/pine/pine-4.61-r1.ebuild,v 1.7 2004/11/05 23:07:43 mr_bones_ Exp $
...
SRC_URI="ftp://ftp.cac.washington.edu/pine/${PN}${PV}.tar.bz2
	mirror://gentoo/${PF}-chappa-all.patch.gz"
#	ipv6? (
...
src_unpack() {
	...
	epatch "${WORKDIR}/${PF}-chappa-all.patch"
