...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mozilla-thunderbird/mozilla-thunderbird-2.0.0.9.ebuild,v 1.6 2007/11/18 15:37:13 dertobi123 Exp $
...
PATCH="${P}-patches-0.1"
LANGS="be bg ca cs da de el en-GB es-AR es-ES eu fi fr ga-IE he hu it ja ko lt mk nb-NO nl nn-NO pa-IN pl pt-BR pt-PT ru sk sl sv-SE tr zh-CN zh-TW"
...
PDEPEND="crypt? ( >=x11-plugins/enigmail-0.95.3-r1 )
