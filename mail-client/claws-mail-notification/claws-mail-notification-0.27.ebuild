...
# $Header: /var/cvsroot/gentoo-x86/mail-client/claws-mail-notification/claws-mail-notification-0.27.ebuild,v 1.4 2011/07/16 18:17:33 hwoarang Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-libnotify-0.7-extra.patch
}
