...
# $Header: /var/cvsroot/gentoo-x86/mail-client/claws-mail/claws-mail-3.7.5-r1.ebuild,v 1.1 2010/04/20 19:05:11 fauli Exp $
...
src_prepare() {
	# fix configure check for >libetpan-0.57 (bug #314181, fixed upstream)
