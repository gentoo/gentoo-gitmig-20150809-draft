...
# $Header: /var/cvsroot/gentoo-x86/mail-client/claws-mail/claws-mail-3.8.1-r3.ebuild,v 1.1 2012/11/04 16:40:39 fauli Exp $
...
PATCHES=(
	...
	"${FILESDIR}"/claws-mail-${PV}_fix-gnutls-3.1.3.patch
)
