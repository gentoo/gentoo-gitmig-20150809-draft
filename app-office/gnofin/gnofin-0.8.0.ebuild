...
# $Header: /var/cvsroot/gentoo-x86/app-office/gnofin/gnofin-0.8.0.ebuild,v 1.2 2000/08/16 04:38:00 drobbins Exp $

P=gnofin-0.8.0
A=${P}.tar.gz
S=${WORKDIR}/${P}
DESCRIPTION="a personal finance application for GNOME"
SRC_URI="ftp://ftp.gnofin.sourceforge.net/pub/gnofin/stable/source/${A}
