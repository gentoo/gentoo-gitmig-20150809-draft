...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-ximian-bin/openoffice-ximian-bin-1.1.52.ebuild,v 1.1 2004/04/02 14:15:43 suka Exp $
...
src_install() {
	...
	doins ${FILESDIR}/${OO_VER}/DicOOo.sxw
