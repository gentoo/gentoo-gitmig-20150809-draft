...
# $Header: /var/cvsroot/gentoo-x86/app-office/abiword/abiword-2.4.6.ebuild,v 1.2 2007/01/04 00:33:13 compnerd Exp $
...
src_install() {
	dodir /usr/{bin,lib}
	make DESTDIR="${D}" icondir="${ROOT}usr/share/pixmaps" install || die "install failed"
