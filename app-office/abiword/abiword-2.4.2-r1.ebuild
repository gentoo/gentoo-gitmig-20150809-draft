...
# $Header: /var/cvsroot/gentoo-x86/app-office/abiword/abiword-2.4.2-r1.ebuild,v 1.2 2006/07/05 07:51:25 mr_bones_ Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/${P}-spell_crash_1.patch
	epatch ${FILESDIR}/${P}-spell_crash_2.patch
}
