...
# $Header: /var/cvsroot/gentoo-x86/app-office/scribus/scribus-1.3.1-r1.ebuild,v 1.1 2005/12/20 23:40:04 hanno Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/scribus-1.3.1-memleak.patch
	epatch ${FILESDIR}/scribus-1.3.1-gcc41.patch
}
