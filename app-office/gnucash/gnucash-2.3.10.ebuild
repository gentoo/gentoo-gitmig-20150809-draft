...
# $Header: /var/cvsroot/gentoo-x86/app-office/gnucash/gnucash-2.3.10.ebuild,v 1.1 2010/02/22 18:21:14 tove Exp $
...
src_unpack() {
	default
	cp "${FILESDIR}"/test-dbi-stuff.h "${S}"/src/backend/dbi/test || die
}
