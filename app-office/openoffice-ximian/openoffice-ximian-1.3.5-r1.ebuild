...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-ximian/openoffice-ximian-1.3.5-r1.ebuild,v 1.8 2005/01/01 15:39:20 eradicator Exp $
...
PATCHDIR=${WORKDIR}/ooo-build-${PV}.5
...
SRC_URI="mirror://openoffice/stable/${OO_VER}/OOo_${OO_VER}_source.tar.gz
	http://ooo.ximian.com/packages/${PATCHLEVEL}/ooo-build-${PV}.5.tar.gz
...
src_unpack() {
	...
	cd ${PATCHDIR}
	epatch ${FILESDIR}/${OO_VER}/gentoo-${PV}-r1.patch
