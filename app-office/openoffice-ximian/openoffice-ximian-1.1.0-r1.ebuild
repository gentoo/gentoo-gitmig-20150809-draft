...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice-ximian/openoffice-ximian-1.1.0-r1.ebuild,v 1.4 2003/11/14 12:39:58 seemant Exp $
...
src_unpack() {
	...
	cd ${WORKDIR}
	unpack OOo_${PV}_source.tar.bz2 ooo-build-${XIMIAN_VER}.tar.gz ooo-icons-${ICON_VER}.tar.gz
