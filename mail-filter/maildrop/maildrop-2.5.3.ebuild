...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/maildrop/maildrop-2.5.3.ebuild,v 1.2 2011/05/15 10:10:31 xarthisius Exp $
...
src_install() {
	...
	docinto unicode
	dodoc unicode/README || die
	docinto maildir
	dodoc maildir/AUTHORS maildir/INSTALL maildir/README*.txt || die

	dodir "/usr/share/doc/${PF}"
	mv "${D}/usr/share/maildrop/html" "${D}/usr/share/doc/${PF}/"

	dohtml *.html maildir/*.html || die
