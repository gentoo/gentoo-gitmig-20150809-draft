...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/openttd/openttd-0.4.8_rc1.ebuild,v 1.1 2006/07/12 19:27:40 pylon Exp $

inherit eutils games

SCENARIO_VERSION="0.4.7"

DESCRIPTION="OpenTTD is a clone of Transport Tycoon Deluxe"
HOMEPAGE="http://www.openttd.com/"
SRC_URI="mirror://gentoo/openttd/${P/_rc/-RC}-source.tar.bz2
	scenarios? ( mirror://sourceforge/openttd/${PN}-${SCENARIO_VERSION}-source-scenarios.zip )"
...
src_unpack() {
	unpack ${P/_rc1/-RC1}-source.tar.bz2
	if use scenarios; then
		cd ${S}/scenario/
		unpack ${PN}-${SCENARIO_VERSION}-source-scenarios.zip
	fi
	cd ${S}
}
