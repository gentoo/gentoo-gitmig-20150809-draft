...
# $Header: /var/cvsroot/gentoo-x86/app-mobilephone/smstools/smstools-2.2.12.ebuild,v 1.1 2006/12/02 14:46:29 mrness Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/2.2.12-buffer-overflow.patch
	if use stats; then
