...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.20.1.ebuild,v 1.8 2007/11/26 14:30:54 corsair Exp $
...
RDEPEND="
	...
	>=gnome-extra/evolution-data-server-1.12.1
	...
	accessibility? (
		...
		>=app-accessibility/orca-2.20.0.1 )
	cups? ( >=net-print/gnome-cups-manager-0.31-r2 )

	mono? ( >=app-misc/tomboy-0.8.1 )"
