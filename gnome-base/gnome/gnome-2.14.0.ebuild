...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.14.0.ebuild,v 1.4 2006/05/06 13:50:24 allanonjl Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=gnome-extra/gnome-games-2.14.0
	>=gnome-base/librsvg-2.14.2

	>=gnome-extra/gnome-system-monitor-2.14.0
	...
	>=gnome-extra/zenity-2.14.0

	>=net-analyzer/gnome-netstatus-2.12.0
	>=net-analyzer/gnome-nettool-2.14.0

	cdr? ( >=gnome-extra/nautilus-cd-burner-2.14.0.2 )
	dvdr? ( >=gnome-extra/nautilus-cd-burner-2.14.0.2 )

	hal? ( >=gnome-base/gnome-volume-manager-1.5.15 )

	>=gnome-extra/gtkhtml-3.10.0
	>=mail-client/evolution-2.6.0
	>=gnome-extra/evolution-data-server-1.6.0
