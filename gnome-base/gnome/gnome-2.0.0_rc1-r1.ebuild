...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.0.0_rc1-r1.ebuild,v 1.1 2002/06/18 00:42:34 spider Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=gnome-base/gconf-1.2.0-r1
	>=gnome-base/eel-2.0.0-r1
	>=gnome-base/nautilus-2.0.0-r1
	>=gnome-base/gnome-session-2.0.0
	>=gnome-base/gnome-panel-2.0.1
	>=gnome-base/gnome-applets-2.0.0
	>=gnome-base/gnome-desktop-2.0.1
	>=gnome-base/gnome-vfs-2.0.0-r1
	...
	>=gnome-extra/gnome-games-2.0.0
	>=app-editors/gedit-1.199.0
