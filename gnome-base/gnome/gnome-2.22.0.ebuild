...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.22.0.ebuild,v 1.7 2008/09/25 17:27:24 jer Exp $
EAPI="1"
...
RDEPEND="
	...
	>=gnome-base/gnome-keyring-2.22.0
	>=app-crypt/seahorse-2.22.0
	...
	>=dev-libs/totem-pl-parser-2.22.1
	>=media-video/totem-2.22.0

	>=media-gfx/eog-2.22.0

	>=www-client/epiphany-2.22.0
	>=app-arch/file-roller-2.22.0
	>=gnome-extra/gcalctool-5.22.0
	...
	>=gnome-extra/gnome-games-2.22.0
	...
	>=gnome-extra/zenity-2.22.0

	>=net-analyzer/gnome-netstatus-2.12.1
	>=net-analyzer/gnome-nettool-2.22.0

	cdr? ( >=gnome-extra/nautilus-cd-burner-2.22.0 )
	dvdr? ( >=gnome-extra/nautilus-cd-burner-2.22.0 )

	>=gnome-extra/gtkhtml-3.18.0
	...
	>=gnome-extra/gnome-screensaver-2.22.0
	...
	accessibility? (
		...
		>=gnome-extra/mousetweaks-2.22.0 )
