...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.4.2.ebuild,v 1.17 2005/01/08 23:58:23 slarti Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=media-gfx/eog-2.4.1
	!ia64? ( >=app-arch/file-roller-2.4.4-r2
	...
	accessibility? ( >=gnome-extra/libgail-gnome-1.0.2
		...
		>=app-accessibility/gnome-speech-0.2.8
		>=app-accessibility/gnome-mag-0.10.4
		>=app-accessibility/gok-0.9.1
		>=app-accessibility/gnopernicus-0.7.1 )
