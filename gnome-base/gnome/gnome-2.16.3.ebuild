...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.16.3.ebuild,v 1.10 2007/07/15 05:15:41 mr_bones_ Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=media-gfx/eog-2.16.3

	>=www-client/epiphany-2.16.3
	...
	>=gnome-extra/gnome-games-2.16.3
	...
	>=gnome-extra/zenity-2.16.3

	>=net-analyzer/gnome-netstatus-2.12.0
	>=net-analyzer/gnome-nettool-2.16.0

	cdr? ( >=gnome-extra/nautilus-cd-burner-2.16.3 )
	dvdr? ( >=gnome-extra/nautilus-cd-burner-2.16.3 )

	hal? ( >=gnome-base/gnome-volume-manager-2.15.0 )

	>=gnome-extra/gtkhtml-3.12.2
	>=mail-client/evolution-2.8.3
	>=gnome-extra/evolution-data-server-1.8.3
	...
	accessibility? (
		...
		>=app-accessibility/dasher-4.2.2
		>=app-accessibility/gnome-mag-0.13.1
		>=app-accessibility/gnome-speech-0.4.8
		>=app-accessibility/gok-1.2.1
