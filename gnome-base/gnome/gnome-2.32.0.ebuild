...
RDEPEND="
	...
	>=gnome-base/gnome-settings-daemon-2.32.0
	>=gnome-base/gnome-control-center-2.32.0

	>=gnome-base/nautilus-2.32.0
	...
	>=media-gfx/eog-2.32.0

	!ppc64? ( >=www-client/epiphany-2.30.6 )
	>=app-arch/file-roller-2.32.0
	>=gnome-extra/gcalctool-5.32.0
	...
	>=x11-themes/gnome-themes-2.32.0
	>=gnome-extra/deskbar-applet-2.32.0
	>=gnome-extra/hamster-applet-2.32.0

	>=x11-themes/gtk-engines-2.20.2
	>=x11-themes/gnome-backgrounds-2.32.0

	>=x11-libs/vte-0.26.1
	>=x11-terms/gnome-terminal-2.32.0

	>=gnome-extra/gucharmap-2.32.0
	...
	>=gnome-extra/zenity-2.32.0

	>=net-analyzer/gnome-netstatus-2.28.2
	>=net-analyzer/gnome-nettool-2.32.0

	cdr? ( >=app-cdr/brasero-2.32.0 )
	dvdr? ( >=app-cdr/brasero-2.32.0 )

	>=gnome-extra/gtkhtml-3.32.0
	>=mail-client/evolution-2.32.0
	...
	accessibility? (
		...
		>=app-accessibility/orca-2.32.0
		>=gnome-extra/mousetweaks-2.32.0 )
...
DEPEND=""
PDEPEND=">=gnome-base/gvfs-1.6.5[gdu]"
