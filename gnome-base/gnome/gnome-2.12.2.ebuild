...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome/gnome-2.12.2.ebuild,v 1.5 2006/01/22 17:32:09 dertobi123 Exp $
...
RDEPEND="!gnome-base/gnome-core
	...
	>=media-gfx/eog-2.12.2

	>=www-client/epiphany-1.8.3
	>=app-arch/file-roller-2.12.2
	...
	>=gnome-base/gnome-desktop-2.12.2
	>=gnome-base/gnome-session-2.12.0
	>=gnome-base/gnome-applets-2.12.2
	...
	>=x11-themes/gtk-engines-2.6.6
	>=x11-themes/gnome-backgrounds-2.12.2

	>=x11-libs/vte-0.11.16
	...
	>=gnome-extra/gnome-games-2.12.2
	...
	cdr? ( >=gnome-extra/nautilus-cd-burner-2.12.2 )
	dvdr? ( >=gnome-extra/nautilus-cd-burner-2.12.2 )
	...
	>=app-admin/system-tools-backends-1.4.1

	accessibility? (
		>=gnome-extra/libgail-gnome-1.1.2
		>=gnome-base/gail-1.8.5
		>=gnome-extra/at-spi-1.6.6
		>=app-accessibility/dasher-3.2.18
		>=app-accessibility/gnome-mag-0.12.2
