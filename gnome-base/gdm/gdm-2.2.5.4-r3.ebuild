...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gdm/gdm-2.2.5.4-r3.ebuild,v 1.1 2002/01/21 02:01:31 azarah Exp $
...
src_install() {
	...
	doexe ${D}/etc/X11/gdm/Sessions/Gnome
