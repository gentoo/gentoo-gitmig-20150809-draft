...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-panel/gnome-panel-2.0.2.ebuild,v 1.3 2002/07/24 06:19:34 drobbins Exp $
...
src_compile() {
	...
	#version 2.0.2 doesn't like parallel make (drobbins, 24 Jul 2002)
	make || die
}
