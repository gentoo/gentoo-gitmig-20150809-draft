...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-applets/gnome-applets-2.14.0.ebuild,v 1.4 2006/04/13 16:32:41 foser Exp $
...
src_unpack() {
	...
	cd ${S}/cpufreq/src
	epatch ${FILESDIR}/${P}-prefs_startup-r1.patch
