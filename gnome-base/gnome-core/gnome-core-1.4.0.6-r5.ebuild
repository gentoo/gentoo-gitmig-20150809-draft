...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-core/gnome-core-1.4.0.6-r5.ebuild,v 1.1 2002/04/04 19:39:00 azarah Exp $
...
src_unpack() {
	...
	# fix bug #382
	cd ${S}
	patch -p1 <${FILESDIR}/gnome-core-es-doc.patch || die
