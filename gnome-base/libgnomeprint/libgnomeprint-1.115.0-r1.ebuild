...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/libgnomeprint/libgnomeprint-1.115.0-r1.ebuild,v 1.2 2002/07/11 06:30:26 drobbins Exp $
...
G2CONF="${G2CONF} --enable-font-install=no"
