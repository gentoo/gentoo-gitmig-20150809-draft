...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gconf/gconf-1.2.1.ebuild,v 1.1 2002/08/05 20:46:08 spider Exp $
...
SRC_URI="mirror://gnome/sources/${MY_PN}/${MY_PN}-${PV}.tar.bz2"
