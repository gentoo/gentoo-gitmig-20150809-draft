...
# $Header: /var/cvsroot/gentoo-x86/gnome-base/gnome-shell/gnome-shell-3.8.4-r2.ebuild,v 1.1 2013/12/27 21:11:36 pacho Exp $
...
src_prepare() {
	...
	# Close runDialog as necessary on session mode changes (from 3.10 branch)
	epatch "${FILESDIR}/${PN}-3.8.4-close-rundialog.patch"
