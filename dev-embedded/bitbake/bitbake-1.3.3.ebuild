...
# $Header: /var/cvsroot/gentoo-x86/dev-embedded/bitbake/bitbake-1.3.3.ebuild,v 1.1 2006/03/29 05:49:04 vapier Exp $

inherit eutils

DESCRIPTION="package management tool for OpenEmbedded"
HOMEPAGE="http://developer.berlios.de/projects/bitbake/"
SRC_URI="http://handhelds.org/~zecke/downloads/${PN}/${P}.tar.gz"
