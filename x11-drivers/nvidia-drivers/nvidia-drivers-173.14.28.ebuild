...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/nvidia-drivers/nvidia-drivers-173.14.28.ebuild,v 1.5 2011/05/28 15:15:41 vapier Exp $
...
src_prepare() {
	...
	if use kernel_linux; then
		...
		epatch "${FILESDIR}"/${PN}-173.14.30-2.6.39.patch #368939
