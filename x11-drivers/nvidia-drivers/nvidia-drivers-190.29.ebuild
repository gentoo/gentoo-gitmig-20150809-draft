...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/nvidia-drivers/nvidia-drivers-190.29.ebuild,v 1.1 2009/11/12 19:11:00 cardoe Exp $
...
SRC_URI="x86? ( http://developer.download.nvidia.com/compute/cuda/2_3/opencl/drivers/nvdrivers_2.3_linux_32_${PV}.run )
amd64? ( http://developer.download.nvidia.com/compute/cuda/2_3/opencl/drivers/nvdrivers_2.3_linux_64_${PV}.run )"
