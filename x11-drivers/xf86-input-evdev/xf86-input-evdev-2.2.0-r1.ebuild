...
# $Header: /var/cvsroot/gentoo-x86/x11-drivers/xf86-input-evdev/xf86-input-evdev-2.2.0-r1.ebuild,v 1.3 2009/04/14 18:54:11 scarabeus Exp $
...
PATCHES="${FILESDIR}/${PV}-Restore-repeat-filtering-for-server-1.5-and-earlier.patch"
