...
# $Header: /var/cvsroot/gentoo-x86/media-video/transcode/transcode-1.0.4-r3.ebuild,v 1.6 2008/07/16 17:08:15 beandog Exp $
...
src_unpack() {
	...
	eautoreconf
	sed -i -e "s:-lMagick:-lMagickCore:g" "${S}"/configure || die
}
