...
# $Header: /var/cvsroot/gentoo-x86/media-video/transcode/transcode-1.0.2-r3.ebuild,v 1.1 2006/08/21 17:51:09 beandog Exp $
...
DEPEND="${RDEPEND}
	...
	X? ( || ( x11-proto/xextproto <virtual/x11-7 ) )"
