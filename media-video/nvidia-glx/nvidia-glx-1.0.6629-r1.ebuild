...
# $Header: /var/cvsroot/gentoo-x86/media-video/nvidia-glx/nvidia-glx-1.0.6629-r1.ebuild,v 1.5 2005/05/22 15:38:44 swegener Exp $
...
src_install() {
	...
	if has_version ">=x11-base/xorg-x11-6.8.0-r4" ; then
		local X11_LIB_DIR="/usr/lib"
	else
		local X11_LIB_DIR="/usr/X11R6/lib"
	fi
