...
# $Header: /var/cvsroot/gentoo-x86/media-video/mkvtoolnix/mkvtoolnix-0.7.7.ebuild,v 1.2 2004/02/23 16:43:10 mholzer Exp $
...
src_compile() {
	...
	MAKEOPTS="-j1"
	emake CXX="${CXX} -include /usr/include/errno.h" || die "make failed"
}
