...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/mplayer-1.0_rc4_p20091026.ebuild,v 1.2 2009/10/26 18:37:32 ssuominen Exp $
...
+cdio cdparanoia cpudetection custom-cpuopts debug dga +dirac directfb doc +dts
+dv dvb +dvd +dvdnav dxr3 +enca +encode esd +faac +faad fbcon ftp gif ggi
-gmplayer +iconv ipv6 jack joystick jpeg kernel_linux ladspa libcaca lirc +live
lzo mad md5sum +mmx mmxext mng +mp2 +mp3 nas +network nut openal +opengl
...
+theora +tremor +truetype +unicode v4l v4l2 vdpau vidix +vorbis win32codecs
