...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/mplayer-0.90_rc2.ebuild,v 1.5 2003/02/13 13:30:53 vapier Exp $
...
src_unpack() {
	...
	cd ${S}; epatch ${FILESDIR}/${PN}-0.90_rc1-gtk2.patch
}
