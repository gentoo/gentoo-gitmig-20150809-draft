...
# $Header: /var/cvsroot/gentoo-x86/media-video/rivatv/rivatv-0.8.0.ebuild,v 1.1 2002/06/07 15:12:59 blauwers Exp $
...
LICENSE="GPL-2"
DEPEND="virtual/x11
	>=sys-kernel/linux-sources-2.4.17"

src_compile() {
	#cd rivatv/linux/drivers/media/video
	emake KERNEL="/usr/src/linux-${KV}" || die
}
