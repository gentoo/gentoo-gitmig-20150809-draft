...
# $Header: /var/cvsroot/gentoo-x86/media-video/minitube/minitube-0.8.ebuild,v 1.1 2009/11/18 20:39:49 hwoarang Exp $
...
KEYWORDS="~amd64 ~x86"
IUSE="debug kde"
LNGS="cs de es es_AR fr he hr hu it ja pl pt_BR ru uk"
for lng in ${LNGS}; do
