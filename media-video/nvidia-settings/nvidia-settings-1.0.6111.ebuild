...
# $Header: /var/cvsroot/gentoo-x86/media-video/nvidia-settings/nvidia-settings-1.0.6111.ebuild,v 1.5 2006/02/03 13:39:57 blubb Exp $
...
src_unpack() {
	...
	use amd64 && \
		cp ${FILESDIR}/libXNVCtrl.a ${S}/src/libXNVCtrl/libXNVCtrl.a
}
