...
# $Header: /var/cvsroot/gentoo-x86/media-video/nvidia-settings/nvidia-settings-173.14.31.ebuild,v 1.3 2012/05/05 14:37:26 idl0r Exp $
...
RDEPEND="=x11-drivers/nvidia-drivers-173.14*[-gtk]
	${COMMON_DEPEND}"
DEPEND="${RDEPEND}
	virtual/pkgconfig
	x11-proto/xproto"
