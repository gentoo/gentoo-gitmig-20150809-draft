...
# $Header: /var/cvsroot/gentoo-x86/media-video/vlc/vlc-0.9.4-r1.ebuild,v 1.2 2008/10/19 09:39:59 corsair Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/0001-Fix-build-with-x264-build-65.patch"
	epatch "${FILESDIR}/embeddedvideo.patch"
