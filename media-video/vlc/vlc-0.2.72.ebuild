...
# $Header: /var/cvsroot/gentoo-x86/media-video/vlc/vlc-0.2.72.ebuild,v 1.1 2001/04/27 00:08:54 achim Exp $

P=vlc-0.2.72
A=vlc-0.2.72.tar.gz
S=${WORKDIR}/vlc-0.2.72
DESCRIPTION="DVD / video player"
SRC_URI="http://www.videolan.org/packages/0.2.72/${A}"
