...
# $Header: /var/cvsroot/gentoo-x86/media-video/totem/totem-0.100-r3.ebuild,v 1.1 2005/04/26 11:00:09 zaheerm Exp $
...
src_unpack() {
	...
	# fix for xine-lib NULL cdrom
	cd ${S}/src
	epatch ${FILESDIR}/${P}-xine_backend-nocdrom.patch
	cd ${S}
