...
# $Header: /var/cvsroot/gentoo-x86/media-video/totem/totem-2.26.3-r1.ebuild,v 1.6 2009/11/28 18:35:20 armin76 Exp $
...
src_prepare() {
	...
	# Fix playing youtube videos results in 404 in gst_soup_http_src_parse_status(),
	# patch import from upstream bug #594320.
	epatch "${FILESDIR}/${P}-youtube-plugin-404-error.patch"
