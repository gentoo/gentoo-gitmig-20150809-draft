...
# $Header: /var/cvsroot/gentoo-x86/media-video/totem/totem-3.2.2.ebuild,v 1.5 2012/09/10 17:17:46 tetromino Exp $
...
IUSE="bluetooth doc grilo +introspection iplayer lirc nautilus nsplugin +python +youtube vala zeitgeist" # test zeroconf
...
# XXX: pylint checks fail, need to investigate why
RESTRICT="test"
