...
# $Header: /var/cvsroot/gentoo-x86/media-video/avidemux/avidemux-2.0.32.ebuild,v 1.1 2004/10/29 09:36:40 zypher Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/avidemux-2.0.32_mpeg_ps_fix.patch
}
