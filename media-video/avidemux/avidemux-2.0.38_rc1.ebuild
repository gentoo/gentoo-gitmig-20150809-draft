...
# $Header: /var/cvsroot/gentoo-x86/media-video/avidemux/avidemux-2.0.38_rc1.ebuild,v 1.3 2005/04/15 14:45:43 luckyduck Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S} || die
	epatch ${FILESDIR}/2.0.38_rc1_mpegidentify.patch || die
}
