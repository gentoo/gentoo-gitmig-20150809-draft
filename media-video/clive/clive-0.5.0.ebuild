...
# $Header: /var/cvsroot/gentoo-x86/media-video/clive/clive-0.5.0.ebuild,v 1.1 2008/08/05 13:28:00 aballier Exp $
...
SRC_URI="http://dl.gna.org/clive/$(get_version_component_range 1-2 ${PV})/${P}.tar.bz2"
