...
# $Header: /var/cvsroot/gentoo-x86/media-video/xvideoservicethief/xvideoservicethief-2.4.ebuild,v 1.2 2010/04/23 08:55:09 hwoarang Exp $
...
src_prepare() {
	...
	"${S}"/resources/transaltions/${RES_NAME}_ko.ts
