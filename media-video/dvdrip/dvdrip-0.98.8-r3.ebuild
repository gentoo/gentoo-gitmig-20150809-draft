...
# $Header: /var/cvsroot/gentoo-x86/media-video/dvdrip/dvdrip-0.98.8-r3.ebuild,v 1.1 2008/10/15 12:04:36 flameeyes Exp $
...
DEPEND=">=dev-perl/Event-ExecFlow-0.63
	...
	<media-video/transcode-1.1.0_pre0[dvdread]"
RDEPEND="${DEPEND}
	x11-libs/gtk+:2[jpeg]
