...
# $Header: /var/cvsroot/gentoo-x86/media-video/ffmpeg/ffmpeg-0.7_rc1.ebuild,v 1.2 2011/05/15 18:42:47 armin76 Exp $
...
SLOT="0"
if [ "${PV#9999}" = "${PV}" ] ; then
	KEYWORDS="~alpha ~amd64 ~arm ~ia64 ~sparc ~x86-fbsd"
fi
IUSE="
