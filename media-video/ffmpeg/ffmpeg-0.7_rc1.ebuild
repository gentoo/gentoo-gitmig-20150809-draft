...
# $Header: /var/cvsroot/gentoo-x86/media-video/ffmpeg/ffmpeg-0.7_rc1.ebuild,v 1.8 2011/06/26 14:58:54 ranger Exp $
...
SLOT="0"
if [ "${PV#9999}" = "${PV}" ] ; then
	KEYWORDS="alpha ~amd64 ~arm hppa ~ia64 ~sparc x86 ~x86-fbsd ppc"
fi
IUSE="
