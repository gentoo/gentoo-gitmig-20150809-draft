...
# $Header: /var/cvsroot/gentoo-x86/sci-mathematics/ginac/ginac-1.5.3.ebuild,v 1.3 2009/12/26 15:34:16 armin76 Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-1.5.1-lexer_cpp.patch
	epatch "${FILESDIR}"/${PN}-1.5.1-pkgconfig.patch
	epatch "${FILESDIR}"/${PN}-1.5.3-parser.patch
}
