...
# /home/cvsroot/gentoo-x86/net-www/mozilla/mozilla-0.9.4.ebuild,v 1.2 2001/09/23 17:33:47 azarah Exp
...
src_install () {
    ...
    # Take care of the component registration and non root execution (hopefully)
    # NOTE: maintainer will have to build and use that specific component.reg each
    # time ...
    cp ${FILESDIR}/component.reg ${D}/opt/mozilla
    chmod -R g+r,o+r ${D}/opt/mozilla
