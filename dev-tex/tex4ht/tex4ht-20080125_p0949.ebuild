...
# $Header: /var/cvsroot/gentoo-x86/dev-tex/tex4ht/tex4ht-20080125_p0949.ebuild,v 1.1 2008/02/10 12:35:01 aballier Exp $
...
src_unpack() {
	...
	# Bug #197213
	mv "${S}/bin/unix/ht" "${S}/bin/unix/ht.tex4ht"
}
