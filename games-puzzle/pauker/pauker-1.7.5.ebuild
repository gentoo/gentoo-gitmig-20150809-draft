...
# $Header: /var/cvsroot/gentoo-x86/games-puzzle/pauker/pauker-1.7.5.ebuild,v 1.3 2008/01/17 18:47:21 mr_bones_ Exp $
...
src_compile() {
	local cp
	cp=$(java-pkg_getjars browserlauncher2-1.0,lucene-2,javahelp,swing-layout-1)
