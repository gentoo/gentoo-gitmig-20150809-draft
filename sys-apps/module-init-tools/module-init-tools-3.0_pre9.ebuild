...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/module-init-tools/module-init-tools-3.0_pre9.ebuild,v 1.2 2004/02/23 00:46:33 agriffis Exp $
...
src_unpack() {
	...
	# Handle cases where generate-modprobe.conf do not detect an alias
	# set to 'off' due to trailing space
	epatch ${FILESDIR}/${P}-properly-handle-alias_off.patch
