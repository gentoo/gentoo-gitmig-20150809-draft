...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/lm_sensors/lm_sensors-2.8.7.ebuild,v 1.2 2005/02/27 12:23:49 brix Exp $
...
src_unpack() {
	unpack ${A} || die
	cd ${S} || die
	epatch ${FILESDIR}/lm_sensors-2.8.7-sensors-detect-gentoo.diff > /dev/null || die
