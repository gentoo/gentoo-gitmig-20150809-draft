...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1_rc1-r2.ebuild,v 1.1 2006/05/15 00:36:13 zmedico Exp $
...
RDEPEND="!build? ( >=dev-lang/python-2.3
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	[ -n "${PATCHVER}" ] && epatch "${WORKDIR}/${PN}-${PV}${PATCHVER}.patch"
