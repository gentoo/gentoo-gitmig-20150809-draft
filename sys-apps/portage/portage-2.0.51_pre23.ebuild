...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.51_pre23.ebuild,v 1.2 2004/09/12 00:55:16 carpaski Exp $
...
pkg_postinst() {
	...
	einfo "        /etc/portage/profiles/virtuals and will never be modified by portage."
	echo
