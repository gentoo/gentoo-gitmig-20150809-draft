...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.45-r6.ebuild,v 1.1 2002/12/17 09:57:58 azarah Exp $
...
src_unpack() {
	cd ${WORKDIR}
	echo tar xjf ${FILESDIR}/${PF}.tar.bz2
	tar xjf ${FILESDIR}/${PF}.tar.bz2 || die "No portage tarball in distfiles."
