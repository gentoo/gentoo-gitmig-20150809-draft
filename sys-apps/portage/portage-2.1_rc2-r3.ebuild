...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1_rc2-r3.ebuild,v 1.1 2006/05/25 14:04:14 zmedico Exp $
...
src_unpack() {
	...
	if [ "${PR}" != "r0" ]; then
		...
		epatch "${FILESDIR}"/bug_101196_wget_timeout.patch
