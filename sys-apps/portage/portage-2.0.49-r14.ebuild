...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.49-r14.ebuild,v 1.3 2003/10/16 16:19:57 carpaski Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}/pym
	gzip -dc ${FILESDIR}/portage-2.0.49-r13_fixdbmsg.diff.gz | sed 's:49-r13:49-r14:' | patch &> /dev/null
}
