...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.2_rc32.ebuild,v 1.1 2009/05/02 02:22:07 zmedico Exp $
...
src_install() {
	...
	local symlinks
	dodir ${portage_base}/bin/ebuild-helpers/3 || die "dodir failed"
