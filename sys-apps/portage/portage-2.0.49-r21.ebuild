...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.49-r21.ebuild,v 1.3 2004/02/23 00:49:09 agriffis Exp $
...
pkg_postinst() {
	...
	einfo "Feature additions are noted in help and make.conf.example descriptions."
	echo
