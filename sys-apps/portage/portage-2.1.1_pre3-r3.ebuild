...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1.1_pre3-r3.ebuild,v 1.1 2006/07/20 22:01:25 zmedico Exp $
...
src_unpack() {
	...
	if [ -n "${PATCHVER}" ]; then
		...
		epatch "${FILESDIR}/2.1.1_pre3-r3-fixes.patch"
	fi
	if [ "${PR}" != "r0" ]; then
