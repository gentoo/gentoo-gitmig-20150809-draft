...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1.2_rc3-r2.ebuild,v 1.1 2006/12/11 00:08:11 zmedico Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/buildpkgonly_blockers.patch
	if [ "${PR}" != "r0" ]; then
