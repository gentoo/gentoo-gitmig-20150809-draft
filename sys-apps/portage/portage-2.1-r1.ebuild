...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1-r1.ebuild,v 1.7 2006/06/25 09:53:47 dertobi123 Exp $
...
if [ "${PR}" != "r0" ]; then
	...
	linguas_pl? ( mirror://gentoo/${PN}-man-pl-${PV_PL}${PATCHVER_PL}.patch.bz2
