...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.51_pre14.ebuild,v 1.1 2004/08/02 19:21:37 carpaski Exp $
...
pkg_postinst() {
	...
	einfo "        /etc/portage/profile/virtuals and will never be modified by portage."
	echo
