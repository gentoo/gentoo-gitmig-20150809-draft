...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.0.47-r4.ebuild,v 1.1 2003/02/25 10:55:08 carpaski Exp $
...
pkg_postinst() {
	...
	chgrp -R portage /var/cache/edb/dep &>/dev/null
	chmod -R ug+rw   /var/cache/edb/dep &>/dev/null
}
