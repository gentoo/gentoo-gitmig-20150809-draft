...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1.2_pre3-r1.ebuild,v 1.1 2006/10/14 14:28:13 zmedico Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/blockers_151331.patch"
	if [ "${PR}" != "r0" ]; then
