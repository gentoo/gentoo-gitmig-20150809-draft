...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.1.2_pre2-r8.ebuild,v 1.1 2006/10/10 21:27:44 zmedico Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/repoman_settings.patch"
	if [ "${PR}" != "r0" ]; then
