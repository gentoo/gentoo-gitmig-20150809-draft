...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/hfsplusutils/hfsplusutils-1.0.4.ebuild,v 1.1 2002/06/20 06:17:51 gerk Exp $

A="hfsplus_1.0.4.src.tar.bz2"
S=${WORKDIR}/hfsplus-1.0.4
DESCRIPTION="HFS+ FS Access utils (read only)"
