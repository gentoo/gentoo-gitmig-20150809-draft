...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.8.6.9.ebuild,v 1.1 2003/07/17 21:44:53 azarah Exp $
...
RDEPEND="${DEPEND}
	...
	|| ( >=sys-apps/util-linux-2.11z-r6
	     ( !build? ( >=sys-apps/util-linux-2.11z-r6 ) )
	     ( !bootstrap? ( >=sys-apps/util-linux-2.11z-r6 ) )
	   )"
