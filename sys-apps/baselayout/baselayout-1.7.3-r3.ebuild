...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.7.3-r3.ebuild,v 1.3 2002/03/07 00:11:43 azarah Exp $
...
EOF
	...
	for x in depscan.sh functions.sh runscript.sh checkroot net.lo consolefont keymaps xdm
	do
