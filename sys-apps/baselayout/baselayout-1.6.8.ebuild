...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.6.8.ebuild,v 1.1 2001/12/17 20:20:26 azarah Exp $
...
pkg_postinst() {
	...
	#old sysvinit ?
	if [ -e /sbin/init.system ] && [ -z "`use build`" ]
	then
		mv -f /sbin/init.system /sbin/init
	fi
}
