...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-2.0.0_rc4-r1.ebuild,v 1.5 2007/09/26 20:03:29 vapier Exp $
...
pkg_postinst() {
	...
	echo "Gentoo Base System release ${PV}-${PR}" > "${ROOT}"/etc/gentoo-release
