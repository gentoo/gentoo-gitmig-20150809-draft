...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.11.9-r1.ebuild,v 1.7 2005/03/10 23:45:56 eradicator Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/rc-scripts-${SV}-domainname.patch #80174
	epatch ${FILESDIR}/rc-scripts-${SV}-ifconfig.patch #80183
	epatch ${FILESDIR}/rc-scripts-${SV}-checkfs-lvm.patch #80206
