...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.12.0_pre17-r1.ebuild,v 1.1 2006/04/11 14:54:46 uberlord Exp $
...
src_unpack() {
	...
	# Fixes #128908, #129331, #129437 and the ccwgroup module.
	epatch "${FILESDIR}/${P}-1975.patch"
