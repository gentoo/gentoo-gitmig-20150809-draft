...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.11.12-r2.ebuild,v 1.1 2005/05/25 10:01:42 uberlord Exp $
...
src_unpack() {
	...
	# Ensure ifconfig works with CIDR addresses #93237
	epatch "${FILESDIR}"/${P}-ifconfig-cidr.patch
