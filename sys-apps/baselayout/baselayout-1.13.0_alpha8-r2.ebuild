...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.13.0_alpha8-r2.ebuild,v 1.1 2006/12/09 20:21:23 uberlord Exp $
...
src_unpack() {
	...
	# Fix bug #157589.
	epatch "${FILESDIR}/baselayout-1.13.0_alpha8-use.patch"

	# Fix the stopping of some services
	epatch "${FILESDIR}/baselayout-1.13.0_alpha8-stop.patch"
