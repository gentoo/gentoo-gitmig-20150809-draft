...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/baselayout/baselayout-1.12.0_pre7-r1.ebuild,v 1.1 2005/09/01 06:57:13 uberlord Exp $
...
src_unpack() {
	...
	# Fix ifconfig from bringing lo up and then working out aliases, #104415
	epatch "${FILESDIR}/baselayout-1.12.0_pre7-ifconfig.patch"
