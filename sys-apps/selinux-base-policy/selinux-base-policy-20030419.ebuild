...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/selinux-base-policy/selinux-base-policy-20030419.ebuild,v 1.1 2003/04/20 01:53:34 pebenito Exp $
...
KEYWORDS="~x86"
RDEPEND="|| (
		>=sys-kernel/selinux-sources-2.4.20-r4
