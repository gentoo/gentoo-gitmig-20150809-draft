...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/openrc/openrc-0.2.ebuild,v 1.1 2008/03/26 20:11:27 cardoe Exp $
...
LICENSE="BSD-2"
SLOT="0"
KEYWORDS="~amd64" #"~alpha ~amd64 ~arm ~hppa ~ia64 ~ppc ~ppc64 ~sh ~sparc ~sparc-fbsd ~x86 ~x86-fbsd"
