...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/coreutils/coreutils-4.5.10-r1.ebuild,v 1.1 2003/03/20 07:24:34 method Exp $
...
use selinux && SRC_URI="${SRC_URI} http://www.ibiblio.org/gentoo/distfiles/coreutils-4.5.10.diff"
...
src_unpack() {
	...
	use selinux && epatch ${DISTDIR}/coreutils-4.5.10.diff
