...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/coreutils/coreutils-4.5.9-r2.ebuild,v 1.1 2003/03/17 20:00:39 method Exp $
...
use selinux && SRC_URI="${SRC_URI} http://www.coker.com.au/selinux/coreutils/core-diff-4.5.9"
...
src_unpack() {
	...
	use selinux && epatch ${DISTDIR}/core-diff-4.5.9
