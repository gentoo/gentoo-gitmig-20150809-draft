...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/initng/initng-0.0.8.ebuild,v 1.1 2005/05/07 23:54:27 vapier Exp $
...
src_install() {
	...
	dodoc README AUTHORS Changelog NEWS TEMPLEATE_HEADER TODO doc/databases.txt doc/empty.conf doc/hard.conf
}
