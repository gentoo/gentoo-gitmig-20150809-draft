...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/ibm-powerpc-utils/ibm-powerpc-utils-1.0.4.ebuild,v 1.3 2008/02/21 18:29:43 ranger Exp $
...
src_unpack() {
	unpack ${A}
	epatch "${FILESDIR}"/ibm-powerpc-utils-1.0.4-remove-doc.patch
}
