...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/util-linux/util-linux-2.11w.ebuild,v 1.1 2002/10/27 07:43:12 woodchip Exp $

IUSE="crypt nls"

CRYPT_PATCH_P=${PN}-${PV/1w/1r}
S=${WORKDIR}/${P}
...
src_unpack() {
	...
	patch -p0 < ${FILESDIR}/util-linux-2.11u-gentoo.patch || die
