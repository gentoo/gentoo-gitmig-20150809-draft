...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/ibm-powerpc-utils-papr/ibm-powerpc-utils-papr-1.1.2.ebuild,v 1.2 2010/01/18 14:53:01 ranger Exp $
...
src_unpack() {
	unpack ${A}
	epatch "${FILESDIR}"/ibm-powerpc-utils-papr-1.1.2-removeinitandvscsis.patch
}
