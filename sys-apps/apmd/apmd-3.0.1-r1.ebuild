...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/apmd/apmd-3.0.1-r1.ebuild,v 1.1 2001/10/14 09:11:36 woodchip Exp $
...
src_install () {
	...
	exeinto /etc/rc.d/init.d ; newexe ${FILESDIR}/apmd.rc5 apmd
}
