...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/rsbac-sources/rsbac-sources-2.4.99.ebuild,v 1.2 2005/06/04 20:43:27 swegener Exp $
...
src_unpack() {
	ESVN_REPO_URI="svn://rsbac.mprivacy-update.de/rsbac/linux-2.4.30-rsbac-v1.2.5"
