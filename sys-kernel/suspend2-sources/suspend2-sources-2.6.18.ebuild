...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/suspend2-sources/suspend2-sources-2.6.18.ebuild,v 1.3 2006/09/26 09:19:49 phreak Exp $
...
UNIPATCH_LIST="${DISTDIR}/${SUSPEND2_SRC}"
...
RDEPEND="${RDEPEND}
		...
		>=sys-power/hibernate-script-1.93"
