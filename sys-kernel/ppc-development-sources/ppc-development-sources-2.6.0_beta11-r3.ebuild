...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ppc-development-sources/ppc-development-sources-2.6.0_beta11-r3.ebuild,v 1.1 2003/12/18 03:25:01 lu_zero Exp $
...
pkg_postinst() {
	...
	then
		ln -sf ${PF} ${ROOT}/usr/src/linux-beta
	fi
