...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/mm-sources/mm-sources-2.6.3_rc1-r1.ebuild,v 1.1 2004/02/10 01:54:31 latexer Exp $

UNIPATCH_LIST="${DISTDIR}/${KV}.bz2 ${FILESDIR}/${KV}-nfs-fix.diff"
K_PREPATCHED="yes"
