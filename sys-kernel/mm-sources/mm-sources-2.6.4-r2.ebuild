...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/mm-sources/mm-sources-2.6.4-r2.ebuild,v 1.1 2004/03/15 17:12:00 latexer Exp $

UNIPATCH_LIST="${DISTDIR}/${KV}.bz2 ${FILESDIR}/${PVR}-kbuild-fix.diff"
K_PREPATCHED="yes"
