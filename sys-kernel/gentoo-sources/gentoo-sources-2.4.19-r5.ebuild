...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gentoo-sources/gentoo-sources-2.4.19-r5.ebuild,v 1.4 2002/12/18 00:12:48 lostlogic Exp $
...
#		acpi-20020404-2.4.18.diff.gz (and an SMP compile fix in our -r5 kernel)
