...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hppa-headers/hppa-headers-2.4.21_p13.ebuild,v 1.1 2003/10/27 22:05:58 gmsoft Exp $
...
src_unpack() {
	...
	do
		...
		zcat ${DISTDIR}/patch-${OKV}-pa${a}-pa${b}.gz | patch -sp 1 > /dev/null
	done
