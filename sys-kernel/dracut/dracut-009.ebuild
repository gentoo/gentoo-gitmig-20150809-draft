...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/dracut/dracut-009.ebuild,v 1.1 2011/03/28 23:38:14 aidecoe Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-don-t-skip-zero-length-string-outfile.patch"
}
