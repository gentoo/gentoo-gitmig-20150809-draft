...
A="linux-2.2.17.tar.bz2 i2c-2.5.2.tar.gz lm_sensors-2.5.2.tar.gz
   ...
   ide.2.2.17.all.20000904.patch.bz2 reiserfs-3.5.22-knfsd-7.gz 
   raid-2.2.17-A0 patch-2.2.16-agpgart.bz2 pppoed0.47.tgz
   linux-2.2.17-nfsv3-0.23.1.dif.bz2 kernel-nfs-dhiggen_merge-3.0.tar.gz"
...
SRC_URI="ftp://ftp.uk.kernel.org/pub/linux/kernel/v2.2/linux-2.2.17.tar.bz2
	 ...
	 http://devlinux.com/pub/namesys/linux-2.2.17-reiserfs-3.5.25-patch.gz
	 ...
	 ftp://ftp.kernel.org/pub/linux/kernel/people/hedrick/ide.2.2.17.all.20000904.patch.bz2
	 http://www.davin.ottawa.on.ca/pppoe/pppoed0.47.tgz
	 http://www.fys.uio.no/~trondmy/src/linux-2.2.17-nfsv3-0.23.1.dif.bz2
	 http://download.sourceforge.net/nfs/kernel-nfs-dhiggen_merge-3.0.tar.gz"
...
src_unpack() {
    ...
    cd ${S}
    echo "Applying nfsv3 patch..."
    bzip2 -dc ${DISTDIR}/linux-2.2.17-nfsv3-0.23.1.dif.bz2 | patch -p1
    unpack kernel-nfs-dhiggen_merge-3.0.tar.gz
    patch -p2 < dhiggen-over-0.22.0
    echo "Applying UDMA patch..."
    bzip2 -dc ${DISTDIR}/ide.2.2.17.all.20000904.patch.bz2 | patch -p1
    echo "Applying reiserfs-patch..."
    gzip -dc ${DISTDIR}/linux-2.2.17-reiserfs-3.5.25-patch.gz | patch -p1
