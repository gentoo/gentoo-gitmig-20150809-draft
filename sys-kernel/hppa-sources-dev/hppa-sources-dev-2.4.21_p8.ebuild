...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hppa-sources-dev/hppa-sources-dev-2.4.21_p8.ebuild,v 1.3 2003/08/07 01:59:40 gmsoft Exp $
...
src_unpack() {
	...
	cat ${DISTDIR}/parisc-linux-2.4.21-pa8-grsecurity-1.9.11.patch | patch -p 1 || die Unable to patch the kernel
