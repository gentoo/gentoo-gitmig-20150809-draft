...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hppa-sources-dev/hppa-sources-dev-2.4.21_p8.ebuild,v 1.1 2003/08/04 01:31:53 gmsoft Exp $
...
SRC_URI="http://www.kernel.org/pub/linux/kernel/v2.4/linux-${OKV}.tar.bz2
	...
	http://nikita.ath.cx/users/pappy/grsecurity-parisc/parisc-linux-${OKV}${PATCH_LEVEL}-grsecurity-${GRSEC_V}.patch"
...
src_unpack() {
	...
	cat ${DISTDIR}/parisc-linux-${OKV}${PATCH_LEVEL}-grsecurity-${GRSEC_V}.patch | patch -p 1 || die Unable to patch the kernel
