...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ppc-sources-benh/ppc-sources-benh-2.4.22-r6.ebuild,v 1.1 2004/04/15 11:07:14 plasmaroo Exp $
...
EXTRAVERSION="-${PN/-*/}"
EXTRAVERSION="${EXTRAVERSION}-${PR/6/2}"
KV="${OKV}${EXTRAVERSION}"
...
SRC_URI="mirror://kernel/linux/kernel/v2.4/linux-${OKV}.tar.bz2
	 mirror://kernel/linux/kernel/people/benh/patch-${OKV}-${MY_R/6/2}.bz2"
...
src_unpack() {
	...
	cd ${PF}
	epatch ${WORKDIR}/patch-${OKV}-${MY_R/6/2} || die "patch failed"
	...
	EXTRAVERSION="-ben${PR/r6/2}-${PR}" && kernel_universal_unpack
}
