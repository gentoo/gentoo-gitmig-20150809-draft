...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/openmosix-sources-2.4.20-r1.ebuild,v 1.5 2003/03/24 23:34:01 drobbins Exp $
...
# INCLUDED:
#   2.4.20, plus:
#   2.4.20  openmosix-2.4.20-1
#   2.4.20  evms-1.2.1 (evms-linux-2.4.20-common-files, evms-1.2.1-linux-2.4.patch, linux-2.4.20.VFS-lock.patch)
