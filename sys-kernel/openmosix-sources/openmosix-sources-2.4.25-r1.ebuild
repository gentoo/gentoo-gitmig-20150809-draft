...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/openmosix-sources-2.4.25-r1.ebuild,v 1.1 2004/03/07 14:38:04 plasmaroo Exp $
...
# INCLUDED:
#   2.4.25, plus:
#   2.4.25  openmosix-2.4.25-20040229 by tab
...
src_unpack() {
	...
	cd linux-${KV}
	bzcat ${DISTDIR}/patch-2.4.25-om-20040229.bz2 | patch -p1 || die "-openmosix patch failed"
