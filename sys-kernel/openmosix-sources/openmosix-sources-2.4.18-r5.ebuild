...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/openmosix-sources-2.4.18-r5.ebuild,v 1.4 2002/12/18 00:12:48 lostlogic Exp $
#OKV=original kernel version, KV=patched kernel version.  They can be the same.

#we use this next variable to avoid duplicating stuff on cvs
GFILESDIR=${PORTDIR}/sys-kernel/linux-sources/files
OKV=2.4.18
KV=2.4.18-openmosix-r5
S=${WORKDIR}/linux-${KV}
ETYPE="sources"
...
# INCLUDED:
#   2.4.18, plus:
#   2.4.18  openmosix-2.4.18-4
#   2.4.18  evms-1.1.0 (evms-linux-2.4.18-common-files, evms-1.1.0-linux-2.4.patch, linux-2.4.18.VFS-lock.patch) 
