...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openmosix-sources/openmosix-sources-2.4.19-r7.ebuild,v 1.4 2002/12/18 00:12:48 lostlogic Exp $
...
# INCLUDED:
#   2.4.19, plus:
#   2.4.19  openmosix-2.4.19-6
#   2.4.19  evms-1.2.0 (evms-linux-2.4.19-common-files, evms-1.2.0-linux-2.4.patch, linux-2.4.19.VFS-lock.patch)
#   for gcc3 there is a patch applied that helps you compiling this kernel using gcc3.
