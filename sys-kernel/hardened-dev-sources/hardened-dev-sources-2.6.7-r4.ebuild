...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-dev-sources/hardened-dev-sources-2.6.7-r4.ebuild,v 1.1 2004/07/24 13:12:10 tseng Exp $
...
UNIPATCH_LIST="${DISTDIR}/hardened-patches-${KV_MAJOR}.${KV_MINOR}-${HGPV}.tar.bz2
	...
	${FILESDIR}/hardened-dev-sources-2.6.7.CAN-2004-0596.patch"
