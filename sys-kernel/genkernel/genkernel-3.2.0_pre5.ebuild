...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.2.0_pre5.ebuild,v 1.1 2005/06/15 18:52:20 plasmaroo Exp $
...
src_install() {
	...
	use livecd && cp ${DISTDIR}/dmraid-${VERSION_DMRAID}.tar.bz2 ${DISTDIR}/LVM2.${VERSION_LVM2}.tgz ${DISTDIR}/device-mapper.${VERSION_DMAP}.tgz ${DISTDIR}/unionfs-${VERSION_UNIONFS}.tar.gz ${D}/usr/share/genkernel/pkg
}
