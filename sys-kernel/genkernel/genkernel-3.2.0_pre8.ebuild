...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.2.0_pre8.ebuild,v 1.1 2005/06/17 19:36:51 wolf31o2 Exp $
...
src_unpack() {
	unpack ${P}.tar.bz2
#	epatch ${FILESDIR}/${P}-arch.diff
#	sed -i 's/prepare0/prepare/' ${S}/gen_determineargs.sh
}
