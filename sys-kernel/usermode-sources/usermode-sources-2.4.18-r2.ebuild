...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/usermode-sources/usermode-sources-2.4.18-r2.ebuild,v 1.5 2002/12/18 00:12:48 lostlogic Exp $
...
#
# 2002-07-23/UBa
#	i decided to "upgrade" this ebuild to uml-patch-2.4.37 because this
#	is the one i successfully use on debian these days.
#
UML_PATCH="uml-patch-${PV}-37"
S=${WORKDIR}/linux-${KV}
