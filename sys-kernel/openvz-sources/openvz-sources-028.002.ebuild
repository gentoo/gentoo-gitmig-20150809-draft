...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/openvz-sources/openvz-sources-028.002.ebuild,v 1.3 2006/11/07 16:52:37 phreak Exp $
...
SRC_URI="${KERNEL_URI} ${ARCH_URI}
	mirror://openvz/kernel/devel/${OVZ_KERNEL}.${OVZ_REV}/patches/patch-ovz${OVZ_KERNEL}-combined.gz"
...
UNIPATCH_LIST="${DISTDIR}/patch-ovz${OVZ_KERNEL}-combined.gz"
# Next release should look like this:
