...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/mips-prepatch-sources/mips-prepatch-sources-2.4.24_pre2-r1.ebuild,v 1.1 2004/01/08 15:39:27 plasmaroo Exp $


# Version Data
OKV=${PV/_/-}
CVSDATE="20031226"
EXTRAVERSION="$(echo "${OKV}" | cut -d- -f2)-mipscvs-${CVSDATE}-${PR}"
KV="${OKV}-${CVSDATE}"
...
src_unpack() {
	...
	# Add security patches [ RTC is already fixed ]
	einfo ">>> Adding security patches ..."
