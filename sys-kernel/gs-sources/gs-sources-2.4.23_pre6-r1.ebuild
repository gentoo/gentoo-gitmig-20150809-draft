...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/gs-sources/gs-sources-2.4.23_pre6-r1.ebuild,v 1.2 2004/01/06 19:32:38 plasmaroo Exp $
...
OKV=2.4.22
EXTRAVERSION=_pre6-gss-r1
KV=2.4.23_pre6-gss-r1
S=${WORKDIR}/linux-${KV}
