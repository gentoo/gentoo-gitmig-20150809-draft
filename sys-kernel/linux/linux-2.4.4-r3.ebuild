...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux/linux-2.4.4-r3.ebuild,v 1.1 2001/04/30 16:29:06 pete Exp $
...
then
    ...
    echo '*** If you dont use LVM, remove lvm from your USE variable.'
    echo '*** If you DO use LVM, dont use this kernel package.'
