...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux/linux-2.4.1_pre7.ebuild,v 1.1 2001/01/16 23:40:32 achim Exp $
...
http://www.kernel.org/pub/linux/kernel/testing/patch-2.4.1-pre7.bz2
...
src_unpack() {
    ...
    bzip2 -dc ${DISTDIR}/patch-2.4.1-pre7.bz2 | patch -p1
