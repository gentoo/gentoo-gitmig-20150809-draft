...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/hardened-sources-2.6.13-r1.ebuild,v 1.1 2005/10/17 16:25:19 johnm Exp $

ETYPE="sources"
inherit kernel-2
detect_version

GPV=${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-6
