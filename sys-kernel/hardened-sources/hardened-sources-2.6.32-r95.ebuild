...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/hardened-sources-2.6.32-r95.ebuild,v 1.3 2012/07/08 13:09:49 blueness Exp $
...
HGPV="${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-97"
...
pkg_postinst() {
	...
	local GRADM_COMPAT="sys-apps/gradm-2.9.0*"
