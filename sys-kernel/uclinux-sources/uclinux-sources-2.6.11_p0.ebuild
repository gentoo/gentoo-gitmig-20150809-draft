...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/uclinux-sources/uclinux-sources-2.6.11_p0.ebuild,v 1.3 2005/04/20 00:25:22 r3pek Exp $
...
SRC_URI="mirror://kernel/linux/kernel/v${KV_MAJOR}.${KV_MINOR}/linux-${OKV}.tar.bz2
		 ...
		 mirror://gentoo/uclinux-2.6-patches.tar.bz2"

UNIPATCH_LIST="${DISTDIR}/${PATCH_FILE}
			   ${DISTDIR}/uclinux-2.6-patches.tar.bz2"
