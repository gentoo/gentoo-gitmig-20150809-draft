...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/ppc-sources-dev/ppc-sources-dev-2.4.24-r4.ebuild,v 1.1 2004/04/17 13:14:42 plasmaroo Exp $
...
SRC_URI="mirror://kernel/linux/kernel/v2.4/linux-${OKV}.tar.bz2
	 mirror://gentoo/patch-${KV/r4/r1}.patch.bz2"
...
src_unpack() {
	...
	mv linux-${OKV} ${PF}
	cd ${PF}
	bzcat ${DISTDIR}/patch-${KV/r4/r1}.patch.bz2 | patch -p1 || die "patch failed"
