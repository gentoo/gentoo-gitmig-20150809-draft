...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-sources/linux-sources-2.4.2.7.ebuild,v 1.1 2001/03/08 17:41:54 achim Exp $
...
src_unpack() {
    ...
    try gzip -dc ${DISTDIR}/linux-2.4.2-reiserfs-20010301-full.patch.gz | patch -N -p1
