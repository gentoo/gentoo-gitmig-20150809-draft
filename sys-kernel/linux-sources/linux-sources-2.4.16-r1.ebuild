...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-sources/linux-sources-2.4.16-r1.ebuild,v 1.1 2001/12/15 03:25:26 drobbins Exp $
...
src_unpack() {
	...
	cp ${FILESDIR}/sysctl.h ${S}/include/linux
