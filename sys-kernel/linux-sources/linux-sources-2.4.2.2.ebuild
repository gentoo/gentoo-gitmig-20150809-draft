...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/linux-sources/linux-sources-2.4.2.2.ebuild,v 1.1 2001/03/02 00:38:42 achim Exp $
...
SRC_URI="http://www.kernel.org/pub/linux/kernel/v2.4/linux-${OKV}.tar.bz2
	 ...
	 ftp://ftp.reiserfs.com/pub/reiserfs-for-2.4/linux-2.4.2-pre4-reiserfs-20010221.patch.gz
...
src_unpack() {
    ...
    try gzip -dc ${DISTDIR}/linux-2.4.2-pre4-reiserfs-20010221.patch.gz | patch -N -p1
