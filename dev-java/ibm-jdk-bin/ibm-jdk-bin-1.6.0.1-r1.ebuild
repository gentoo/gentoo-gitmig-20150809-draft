...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ibm-jdk-bin/ibm-jdk-bin-1.6.0.1-r1.ebuild,v 1.1 2008/06/14 12:21:28 serkan Exp $
...
src_install() {
	...
	if use amd64; then
		dosym /opt/${P}/jre/lib/amd64/compressedrefs/jclSC160/vm.jar /opt/${P}/jre/lib/
	fi
