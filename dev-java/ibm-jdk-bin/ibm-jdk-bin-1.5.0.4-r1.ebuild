...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ibm-jdk-bin/ibm-jdk-bin-1.5.0.4-r1.ebuild,v 1.2 2007/07/11 19:58:37 mr_bones_ Exp $
...
pkg_postinst() {
	...
	elog ""
	elog "Starting with 1.5.0.4-r1 the src.jar is installed to the standard"
