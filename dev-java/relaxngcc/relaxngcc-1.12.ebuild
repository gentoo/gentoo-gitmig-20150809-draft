...
# $Header: /var/cvsroot/gentoo-x86/dev-java/relaxngcc/relaxngcc-1.12.ebuild,v 1.1 2007/05/01 19:19:56 nelchael Exp $
...
src_unpack() {
	...
	cp "${FILESDIR}/MANIFEST.MF-${PV}" "${S}/MANIFEST.MF" -i || die "cp failed"
