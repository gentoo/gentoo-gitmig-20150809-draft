...
# $Header: /var/cvsroot/gentoo-x86/dev-java/jdbc-jaybird/jdbc-jaybird-2.0.1-r1.ebuild,v 1.2 2007/01/05 00:35:58 wltjr Exp $
...
src_install() {
	...
	if use jni; then
		cd "${S}/output/native"
		sodest="/usr/lib/"
		java-pkg_doso libjaybird2.so || die \
			"java-pkg_doso ${sodest}libjaybird2.so failed"
	fi
