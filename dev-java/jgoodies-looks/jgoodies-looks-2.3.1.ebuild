...
# $Header: /var/cvsroot/gentoo-x86/dev-java/jgoodies-looks/jgoodies-looks-2.3.1.ebuild,v 1.3 2010/06/01 07:59:23 phajdan.jr Exp $
...
#	epatch "${FILESDIR}/${P}-configureEditor.patch"
