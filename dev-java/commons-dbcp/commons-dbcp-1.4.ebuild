...
# $Header: /var/cvsroot/gentoo-x86/dev-java/commons-dbcp/commons-dbcp-1.4.ebuild,v 1.3 2010/12/22 11:47:07 hwoarang Exp $
...
java_prepare() {
	...
	echo "jta-spec.jar=$(java-pkg_getjars jta)" >> build.properties
	echo "jta-impl.jar=$(java-pkg_getjars jta)" >> build.properties
}
