...
# $Header: /var/cvsroot/gentoo-x86/dev-java/gjdoc/gjdoc-0.7.5.ebuild,v 1.2 2005/09/27 10:07:40 betelgeuse Exp $
...
src_compile() {
	...
	local myc="--with-antlr-jar=$(java-pkg_jar-from antlr) --disable-native"
