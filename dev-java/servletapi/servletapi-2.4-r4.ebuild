...
# $Header: /var/cvsroot/gentoo-x86/dev-java/servletapi/servletapi-2.4-r4.ebuild,v 1.3 2006/10/05 17:14:27 gustavoz Exp $

inherit eutils java-pkg-2 java-ant-2

DESCRIPTION="Servlet API 2.4 from jakarta.apache.org"
HOMEPAGE="http://jakarta.apache.org/"
SRC_URI="mirror://apache/jakarta/tomcat-5/v5.5.17/src/apache-tomcat-5.5.17-src.tar.gz"
...
S="${WORKDIR}/apache-tomcat-5.5.17-src/servletapi"
