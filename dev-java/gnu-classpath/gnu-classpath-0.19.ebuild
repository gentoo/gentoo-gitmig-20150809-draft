...
# $Header: /var/cvsroot/gentoo-x86/dev-java/gnu-classpath/gnu-classpath-0.19.ebuild,v 1.2 2005/11/14 20:50:07 betelgeuse Exp $
...
# dssi patch fails with the stable patch
DEPEND="app-arch/zip
		dev-java/jikes
