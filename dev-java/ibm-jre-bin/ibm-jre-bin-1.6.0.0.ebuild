...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ibm-jre-bin/ibm-jre-bin-1.6.0.0.ebuild,v 1.3 2007/12/24 20:05:26 nixnut Exp $
...
QA_TEXTRELS_amd64="opt/${P}/lib/amd64/libjclscar_24.so
opt/${P}/lib/amd64/libj9jit24.so"

QA_EXECSTACK_amd64="opt/${P}/bin/classic/libjvm.so
opt/${P}/lib/amd64/j9vm/libjvm.so
opt/${P}/lib/amd64/libj9jvmti24.so
opt/${P}/lib/amd64/libj9hookable24.so
opt/${P}/lib/amd64/libj9vm24.so
opt/${P}/lib/amd64/libjclscar_24.so
opt/${P}/lib/amd64/libj9thr24.so
opt/${P}/lib/amd64/libj9dmp24.so
opt/${P}/lib/amd64/libj9prt24.so
opt/${P}/lib/amd64/libj9jit24.so
opt/${P}/lib/amd64/libiverel24.so
opt/${P}/lib/amd64/libj9trc24.so
opt/${P}/lib/amd64/libj9dbg24.so
opt/${P}/lib/amd64/libj9shr24.so
opt/${P}/lib/amd64/libj9gc24.so
opt/${P}/lib/amd64/libj9bcv24.so
opt/${P}/lib/amd64/classic/libjvm.so"
