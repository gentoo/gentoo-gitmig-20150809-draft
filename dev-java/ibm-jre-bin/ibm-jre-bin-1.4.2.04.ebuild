...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ibm-jre-bin/ibm-jre-bin-1.4.2.04.ebuild,v 1.3 2006/07/03 13:23:32 betelgeuse Exp $

inherit java eutils

if use x86 ; then
	JRE_DIST="IBMJava2-JRE-142.tgz"
	JRE_DIST_GENTOO="IBMJava2-JRE-142-SR4.tgz"
elif use amd64 ; then
	JRE_DIST="IBMJava2-JRE-AMD64-142.x86_64.tgz"
	JRE_DIST_GENTOO="IBMJava2-JRE-AMD64-142.x86_64-SR4.tgz"
elif use ppc ; then
	JRE_DIST="IBMJava2-JRE-142.ppc.tgz"
	JRE_DIST_GENTOO="IBMJava2-JRE-142.ppc-SR4.tgz"
elif use ppc64 ; then
	JRE_DIST="IBMJava2-JRE-142.ppc64.tgz"
	JRE_DIST_GENTOO="IBMJava2-JRE-142.ppc64-SR4.tgz"
fi

DESCRIPTION="IBM Java Development Kit"
HOMEPAGE="http://www-106.ibm.com/developerworks/java/jdk/"
SRC_URI="x86? ( IBMJava2-JRE-142-SR4.tgz )
		 amd64? ( IBMJava2-JRE-AMD64-142.x86_64-SR4.tgz )
		 ppc? ( IBMJava2-JRE-142.ppc-SR4.tgz )
		 ppc64? ( IBMJava2-JRE-142.ppc64-SR4.tgz )"
