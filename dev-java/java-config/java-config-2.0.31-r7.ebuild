...
# $Header: /var/cvsroot/gentoo-x86/dev-java/java-config/java-config-2.0.31-r7.ebuild,v 1.1 2007/04/15 20:31:41 betelgeuse Exp $
...
src_install() {
	...
	dosym /usr/bin/run-java-tool /usr/bin/keytool
