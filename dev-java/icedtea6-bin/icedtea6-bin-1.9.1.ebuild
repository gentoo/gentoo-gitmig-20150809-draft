...
# $Header: /var/cvsroot/gentoo-x86/dev-java/icedtea6-bin/icedtea6-bin-1.9.1.ebuild,v 1.4 2010/11/07 22:08:20 ssuominen Exp $
...
RDEPEND=">=sys-devel/gcc-4.3
	...
	|| ( >=media-libs/jpeg-8 >=media-libs/libjpeg-turbo-1.0.90 )
