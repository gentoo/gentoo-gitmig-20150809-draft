...
# $Header: /var/cvsroot/gentoo-x86/dev-java/ant-optional/ant-optional-1.6.2-r1.ebuild,v 1.6 2004/07/31 21:21:10 karltk Exp $
...
DEPEND="=dev-java/ant-${PVR}
	...
	|| ( >=dev-java/jython-2.1 >=dev-java/jython-bin-2.1 )
...
src_compile() {
	...
	packages="ant,antlr,bcel,bsh,commons-beanutils,commons-net,commons-logging,jdepend,jsch,junit,jython-bin,log4j,oro,regexp-bin,rhino,xalan,xerces-2"
