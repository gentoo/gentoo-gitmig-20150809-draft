...
# $Header: /var/cvsroot/gentoo-x86/dev-java/java-gnome/java-gnome-2.12.2.ebuild,v 1.2 2005/12/30 02:55:05 compnerd Exp $
...
DEPEND="~dev-java/glib-java-0.2.2
		~dev-java/cairo-java-1.0.2
		~dev-java/libgtk-java-2.8.2
