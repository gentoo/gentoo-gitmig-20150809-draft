...
# $Header: /var/cvsroot/gentoo-x86/dev-java/kaffe/kaffe-1.1.7_rc1.ebuild,v 1.2 2006/07/02 20:00:06 betelgeuse Exp $

inherit base eutils java flag-o-matic

MY_P=${P/_/-}
DESCRIPTION="A cleanroom, open source Java VM and class libraries"
#SRC_URI="http://www.kaffe.org/ftp/pub/kaffe/v1.1.x-development/${MY_P}.tar.gz"
SRC_URI="http://www.kaffe.org/~robilad/${P/_/-}.tar.gz"
