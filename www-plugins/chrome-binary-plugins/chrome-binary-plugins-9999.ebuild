...
# $Header: /var/cvsroot/gentoo-x86/www-plugins/chrome-binary-plugins/chrome-binary-plugins-9999.ebuild,v 1.4 2013/01/31 09:21:52 zx2c4 Exp $

EAPI=4

DESCRIPTION="Binary plugins -- the native Chrome Flash plugin and PDF plugin -- from Google Chrome for use in Chromium."
