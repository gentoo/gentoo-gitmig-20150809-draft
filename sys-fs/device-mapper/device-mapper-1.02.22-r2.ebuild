...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/device-mapper/device-mapper-1.02.22-r2.ebuild,v 1.1 2007/10/04 14:15:38 cardoe Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}"/device-mapper.rc-r1 device-mapper || die
