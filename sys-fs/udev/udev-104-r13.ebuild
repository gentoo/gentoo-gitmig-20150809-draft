...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-104-r13.ebuild,v 1.2 2007/07/27 15:17:25 gustavoz Exp $
...
src_install() {
	...
	newins "${FILESDIR}"/udev-start-104-r13.sh udev-start.sh
	newins "${FILESDIR}"/udev-stop-104-r13.sh udev-stop.sh
