...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-113-r1.ebuild,v 1.3 2007/11/10 10:23:17 zzam Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-113-r1-rules.diff
	...
	MD5=${MD5/  -/}
	if [ "${MD5}" != "289e10d87dd153b0082d126c5e129f21" ]
	then
		echo
