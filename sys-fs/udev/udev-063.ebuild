...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-063.ebuild,v 1.1 2005/07/15 00:29:50 gregkh Exp $
...
src_compile() {
	local myconf=
	local extras="extras/scsi_id extras/volume_id extras/ata_id extras/run_directory extras/usb_id"
