...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-115-r6.ebuild,v 1.3 2008/06/15 05:54:32 zmedico Exp $

inherit eutils flag-o-matic multilib toolchain-funcs versionator

PATCH="${P}-update-20070924.diff"
...
src_unpack() {
	...
	rm etc/udev/gentoo/40-audio.rules
