...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-118-r1.ebuild,v 1.2 2008/06/15 05:54:32 zmedico Exp $
...
src_unpack() {
	...
	MD5=${MD5/  -/}
	if [[ ${MD5} != a71a3459f46eb61b209a73fc0c6a299f ]]
	then
		echo
...
src_install() {
	...
	newins "${FILESDIR}"/udev-start-118-r1.sh udev-start.sh
