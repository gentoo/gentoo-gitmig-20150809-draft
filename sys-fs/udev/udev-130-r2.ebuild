...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udev/udev-130-r2.ebuild,v 1.1 2008/10/28 21:59:05 zzam Exp $
...
src_install() {
	...
	# TODO: Add message that user REALLY, REALLY
	# needs to add this to sysinit runlevel
	# Bug #240984
