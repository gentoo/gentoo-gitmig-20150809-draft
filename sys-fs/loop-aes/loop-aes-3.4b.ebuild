...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/loop-aes/loop-aes-3.4b.ebuild,v 1.2 2010/10/24 20:38:15 c1pher Exp $
...
src_install() {
	...
	dobin loop-aes-keygen || die
	doman loop-aes-keygen.1 || die
}
