...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/cryptsetup-luks/cryptsetup-luks-1.0.4-r3.ebuild,v 1.2 2007/06/19 13:13:35 gustavoz Exp $
...
src_install() {
	...
	newins "${FILESDIR}"/1.0.4-dm-crypt-start.sh dm-crypt-start.sh || die
