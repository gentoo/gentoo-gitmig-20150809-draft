...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/vhba/vhba-1.2.1_p682.ebuild,v 1.1 2010/08/11 14:58:48 pva Exp $
...
src_prepare() {
	epatch \
		"${FILESDIR}/1.2.1-parallel_build.patch" \
		"${FILESDIR}/1.2.1-kerneldir.patch"
}
