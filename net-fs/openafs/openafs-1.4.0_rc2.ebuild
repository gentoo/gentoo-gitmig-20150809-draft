...
# $Header: /var/cvsroot/gentoo-x86/net-fs/openafs/openafs-1.4.0_rc2.ebuild,v 1.1 2005/09/02 00:48:27 stefaan Exp $
...
src_install() {
	...
	newconfd ${CONFDIR}/afs-client
	newconfd ${CONFDIR}/afs-server
	newinitd ${SCRIPTDIR}/afs-client
	newinitd ${SCRIPTDIR}/afs-server
