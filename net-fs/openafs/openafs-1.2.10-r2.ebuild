...
# $Header: /var/cvsroot/gentoo-x86/net-fs/openafs/openafs-1.2.10-r2.ebuild,v 1.10 2005/05/19 20:41:31 rphillips Exp $
...
src_compile() {
	...
	make CC="$(gcc-getCC)" MT_CC="$(gcc-getCC) -fPIC" || die make
}
