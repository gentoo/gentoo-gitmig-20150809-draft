...
# $Header: /var/cvsroot/gentoo-x86/net-fs/openafs-kernel/openafs-kernel-1.4.7_pre2-r1.ebuild,v 1.1 2008/04/04 12:17:27 stefaan Exp $
...
src_unpack() {
	...
	# patch mistake in plain _pre2
	epatch "${FILESDIR}"/STABLE14-linux-flush-unlock-20080402
	epatch "${FILESDIR}"/STABLE14-linux-flush-compare-20080402
