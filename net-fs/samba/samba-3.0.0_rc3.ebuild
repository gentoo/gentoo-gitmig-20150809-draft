...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba/samba-3.0.0_rc3.ebuild,v 1.1 2003/09/11 03:35:18 woodchip Exp $
...
SRC_URI="mirror://samba/rc/${PN}${_CVS}.tar.bz2
	mirror://sourceforge/openantivirus/${PN}-vscan-${VSCAN_VER}.tar.bz2"
