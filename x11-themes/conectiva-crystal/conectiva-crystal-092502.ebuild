...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/conectiva-crystal/conectiva-crystal-092502.ebuild,v 1.1 2002/10/01 18:43:09 satai Exp $
...
src_compile() {
	...
	cd ${S}
	sed "s/Name=Conectiva Crystal 0.6/Name=Conectiva Crystal Snapshot ${PV}/" index.desktop > index.temp
