...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/bmpx-themes/bmpx-themes-0.0.3.ebuild,v 1.1 2006/05/16 18:10:56 chutzpah Exp $
...
src_install () {
	dodir /usr/share/bmpx/skins
	cp -pPR * ${D}/usr/share/bmpx/skins/
	chown -R root:0 ${D}/usr/share/bmpx/skins/
	chmod -R o-w ${D}/usr/share/bmpx/skins/
}
