...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/gtk-engines/gtk-engines-2.2.0.ebuild,v 1.1 2003/06/19 09:42:04 liquidx Exp $
...
HOMEPAGE=""
SRC_URI="mirror://gnome/sources/${GTK_PN}/${GTK1_VER}/${PN}-${GTK1_VER}.tar.gz
	mirror://gnome/sources/${GTK_PN}/${PVP[0]}.${PVP[1]}/${PN}-${GTK2_VER}.tar.gz"
