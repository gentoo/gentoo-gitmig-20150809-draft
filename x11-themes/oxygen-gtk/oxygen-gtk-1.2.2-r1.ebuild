...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/oxygen-gtk/oxygen-gtk-1.2.2-r1.ebuild,v 1.1 2012/04/12 08:49:33 johu Exp $
...
PATCHES=(
	"${FILESDIR}/${PN}-1.2.2-fix-filezilla-crash.patch"
)
