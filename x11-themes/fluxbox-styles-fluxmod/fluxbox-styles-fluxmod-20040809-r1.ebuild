...
# $Header: /var/cvsroot/gentoo-x86/x11-themes/fluxbox-styles-fluxmod/fluxbox-styles-fluxmod-20040809-r1.ebuild,v 1.1 2004/09/15 14:28:37 ciaranm Exp $
...
src_install() {
	cd ${S}
	for d in styles ; do
		insinto /usr/share/fluxbox/fluxmod/${d}
		cp -R ${d}/* ${D}/usr/share/fluxbox/fluxmod/${d}/
	done
