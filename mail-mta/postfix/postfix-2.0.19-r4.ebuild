...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/postfix/postfix-2.0.19-r4.ebuild,v 1.2 2004/07/16 10:15:53 kloeri Exp $
...
pkg_postinst() {
	...
	einfo "for some postfix configuration files is fairly important for the"
