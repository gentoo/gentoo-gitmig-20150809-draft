...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/postfix/postfix-2.1.4.ebuild,v 1.3 2004/09/28 18:15:56 langthang Exp $

inherit eutils ssl-cert

VDA_P="${PN}-2.1.4-trash"
TLS_P="pfixtls-0.8.18-2.1.3-0.9.7d"
IPV6="1.25"
IPV6_P="ipv6-${IPV6}-pf-2.1.4"
