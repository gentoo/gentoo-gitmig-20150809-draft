...
# $Header: /var/cvsroot/gentoo-x86/app-emacs/mmm-mode/mmm-mode-0.4.8-r1.ebuild,v 1.1 2006/03/13 21:18:22 mkennedy Exp $
...
src_compile() {
	./configure --host=${CHOST} \
		...
		--with-emacs \
		--with-listdir=/usr/share/emacs/site-lisp/mmm-mode \
