...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/mutter/mutter-3.0.2.1.ebuild,v 1.1 2011/09/30 16:35:42 nirbheek Exp $
...
SRC_URI="${SRC_URI}
	mirror://gentoo/${PN}-3.0.2-patches.tar.xz"
...
src_prepare() {
	...
	epatch "${WORKDIR}/${PN}-3.0.2-frame-region-cairo-region.patch"
	epatch "${WORKDIR}/${PN}-3.0.2-argb-windows-shadow.patch"
	# The third is from comment 33 in the gnome bug and unbreaks XShape handling
	epatch "${WORKDIR}/${PN}-3.0.2-fix-xshape.patch"
