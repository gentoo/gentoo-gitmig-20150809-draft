...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/icewm/icewm-1.0.9.2-r4.ebuild,v 1.1 2002/05/26 21:17:43 mkennedy Exp $
...
src_unpack(){
	unpack ${A}
	cd ${S}
	patch -p1 <${FILESDIR}/icewm-1.0.9.2-gcc31-gentoo.patch || die
