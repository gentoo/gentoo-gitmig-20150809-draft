...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/fluxbox/fluxbox-1.0_rc3_p4944.ebuild,v 1.2 2007/07/12 03:41:53 mr_bones_ Exp $
...
src_unpack() {
	...
	if [[ "${PR}" == "r0" ]] ; then
		suffix="svn-4944-gentoo"
	else
		suffix="svn-4944-gentoo-${PR}"
	fi
	sed -i \
