...
# $Header: /var/cvsroot/gentoo-x86/net-dns/bind/bind-9.3.0_rc2.ebuild,v 1.3 2005/01/01 16:19:26 weeve Exp $
...
MY_P="${P/_/}"
S=${WORKDIR}/${MY_P}
SRC_URI="ftp://ftp.isc.org/isc/bind9/${MY_P}/${MY_P}.tar.gz"
