...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-acl-compat/cl-acl-compat-1.2.35.20040924-r1.ebuild,v 1.1 2005/02/10 09:18:29 mkennedy Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/${PV}-sbcl-unicode-gentoo.patch || die
}
