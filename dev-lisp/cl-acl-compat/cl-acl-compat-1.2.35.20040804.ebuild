...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/cl-acl-compat/cl-acl-compat-1.2.35.20040804.ebuild,v 1.2 2005/02/10 09:18:29 mkennedy Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/${PV}-sbcl-package-locks-gentoo.patch
}
