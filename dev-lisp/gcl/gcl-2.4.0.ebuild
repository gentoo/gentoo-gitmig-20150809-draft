...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/gcl/gcl-2.4.0.ebuild,v 1.4 2002/04/29 19:49:34 verwilst Exp $
...
src_install() {
    ...
    try make install prefix=${D}/usr MANDIR=${D}/usr/share/man INFO_DIR=${D}/usr/info
