...
# $Header: /var/cvsroot/gentoo-x86/www-apache/mod_mono/mod_mono-1.0.1.ebuild,v 1.1 2004/09/22 01:05:51 latexer Exp $
...
KEYWORDS="~x86 ~ppc"
IUSE=""
DEPEND=">=dev-dotnet/mono-1.0.1
	dev-libs/apr
	=net-www/apache-2*
	>=dev-dotnet/xsp-1.0.1"
