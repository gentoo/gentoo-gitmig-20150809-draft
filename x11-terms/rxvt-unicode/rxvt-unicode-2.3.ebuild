...
# $Header: /var/cvsroot/gentoo-x86/x11-terms/rxvt-unicode/rxvt-unicode-2.3.ebuild,v 1.1 2004/03/15 17:24:55 latexer Exp $
...
src_unpack() {
	unpack ${A}
	EPATCH_SINGLE_MSG="Patching to fix font segfault" \
		epatch ${FILESDIR}/${P}-font-fix.diff
}
src_compile() {
