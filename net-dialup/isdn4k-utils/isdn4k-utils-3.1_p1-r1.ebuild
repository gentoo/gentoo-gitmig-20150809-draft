...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/isdn4k-utils/isdn4k-utils-3.1_p1-r1.ebuild,v 1.1 2000/08/26 20:41:56 achim Exp $
...
src_compile() {                           
  cd ${S}
  sed -e "s:CONFIG_KERNELDIR=.*:CONFIG_KERNELDIR='${WORKDIR}/../../linux-UP-2\.2\.17_pre13-r6/work/linux':" ${O}/files/${P}.config > .config
  make subconfig
  make
}
