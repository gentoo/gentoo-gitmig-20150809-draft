...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/ppp/ppp-2.4.3-r16.ebuild,v 1.9 2006/09/23 14:59:29 dertobi123 Exp $
...
src_unpack() {
	...
	epatch "${WORKDIR}/patch/winbind-drop-privs.patch"
