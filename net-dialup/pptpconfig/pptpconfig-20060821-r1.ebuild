...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/pptpconfig/pptpconfig-20060821-r1.ebuild,v 1.1 2006/11/14 20:19:40 mrness Exp $
...
src_install() {
	...
	dosed "s:/usr/lib/php-pcntl/bin/php:${PHPCLI}:" /usr/bin/pptpconfig.php
}
