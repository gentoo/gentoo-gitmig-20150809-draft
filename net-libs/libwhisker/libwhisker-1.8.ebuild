...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libwhisker/libwhisker-1.8.ebuild,v 1.1 2003/10/06 10:43:08 mcummings Exp $

DESCRIPTION="Perl module geared to HTTP testing."
HOMEPAGE="http://www.wiretrip.net/rfp/"
SRC_URI="http://www.wiretrip.net/rfp/bins/libwhisker/${PN}-current.tar.gz"
LICENSE="GPL-2"
SLOT="0"
