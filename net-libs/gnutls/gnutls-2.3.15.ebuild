...
# $Header: /var/cvsroot/gentoo-x86/net-libs/gnutls/gnutls-2.3.15.ebuild,v 1.1 2008/06/19 09:11:03 dragonheart Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-qa_gnutls_session_is_psk.patch
