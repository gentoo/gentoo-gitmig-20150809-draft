...
# $Header: /var/cvsroot/gentoo-x86/net-libs/aqbanking/aqbanking-1.9.4_beta.ebuild,v 1.1 2006/01/27 23:08:05 hanno Exp $
...
DEPEND=">=sys-libs/gwenhywfar-1.99.5
	>=app-misc/ktoblzcheck-1.9
	ofx? ( >=dev-libs/libofx-0.8 )
	geldkarte? ( >=sys-libs/libchipcard-1.9.20_beta )
	chipcard? ( >=sys-libs/libchipcard-1.9.20_beta )"
