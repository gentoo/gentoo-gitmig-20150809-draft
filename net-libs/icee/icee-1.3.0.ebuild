...
# $Header: /var/cvsroot/gentoo-x86/net-libs/icee/icee-1.3.0.ebuild,v 1.1 2009/01/07 15:24:59 b33fc0d3 Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/icee-1.3.0-makefile.patch"
	epatch "${FILESDIR}/icee-1.3.0-makefile-2.patch"
	epatch "${FILESDIR}/icee-1.3.0-gcc4.3-fix.patch"
	epatch "${FILESDIR}/icee-1.3.0-maverick-fix.patch"
