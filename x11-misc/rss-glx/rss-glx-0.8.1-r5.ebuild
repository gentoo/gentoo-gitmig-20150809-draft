...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/rss-glx/rss-glx-0.8.1-r5.ebuild,v 1.2 2009/02/24 01:48:54 dirtyepic Exp $
...
RDEPEND="${RDEPEND}
	...
	kde? ( || ( =kde-base/kdeartwork-kscreensaver-3* =kde-base/kdeartwork-3* ) )
