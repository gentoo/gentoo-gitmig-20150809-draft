...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/rss-glx/rss-glx-0.8.1-r3.ebuild,v 1.4 2007/01/03 13:32:24 kloeri Exp $
...
pkg_postinst() {
	local XSCREENSAVER_CONF="${ROOT}/usr/lib/X11/app-defaults/XScreenSaver"
