...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/shutter/shutter-0.88.1.ebuild,v 1.1 2011/12/04 12:54:00 hwoarang Exp $
...
src_prepare() {
	use webphoto || epatch "${FILESDIR}"/disable_webphoto-0.87.1.patch
	use drawing || epatch "${FILESDIR}"/disable-goocanvas-0.87.1.patch
