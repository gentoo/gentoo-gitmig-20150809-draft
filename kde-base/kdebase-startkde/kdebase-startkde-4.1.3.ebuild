...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-startkde/kdebase-startkde-4.1.3.ebuild,v 1.1 2008/11/09 01:56:12 scarabeus Exp $
...
src_configure() {
	# Patch the startkde script to setup the environment for KDE 4.1
