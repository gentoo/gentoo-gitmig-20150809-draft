...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdemultimedia-meta/kdemultimedia-meta-3.5.3.ebuild,v 1.1 2006/06/01 17:54:58 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="arts? ( $(deprange $PV $MAXKDEVER kde-base/artsplugin-akode)
		...
		xine? ( $(deprange 3.5.2 $MAXKDEVER kde-base/artsplugin-xine) )
	...
	$(deprange 3.5.2 $MAXKDEVER kde-base/kmid)
...
#$(deprange 3.5.0 $MAXKDEVER kde-base/artsplugin-mpg123)
