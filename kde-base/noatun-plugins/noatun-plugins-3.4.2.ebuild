...
# $Header: /var/cvsroot/gentoo-x86/kde-base/noatun-plugins/noatun-plugins-3.4.2.ebuild,v 1.2 2005/07/29 10:34:32 danarmak Exp $
KMNAME=kdeaddons
MAXKDEVER=$PV
...
myconf="$(use_with berkdb berkeley-db) $(use_with sdl) --with-db-lib=db_cxx-4.2 --with-extra-includes=/usr/include/db4.2"
