...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-4.6.1-r2.ebuild,v 1.1 2011/03/27 14:08:13 dilfridge Exp $
...
#	"${FILESDIR}/${PN}-4.5.74-klauncher_mac.patch" - FIXME read above
	...
	"${FILESDIR}/${PN}-4.6.1-sslproxy.patch"
	"${FILESDIR}/${PN}-4.6.1-cve20111168.patch"
)
