...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-3.3.1-r2.ebuild,v 1.3 2004/12/18 22:15:11 corsair Exp $
...
src_unpack() {
	kde_src_unpack
	epatch ${FILESDIR}/post-3.3.1-kdelibs-kio.diff
	epatch ${FILESDIR}/post-3.3.1-kdelibs-khtml.diff
	epatch ${FILESDIR}/post-3.3.1-kdelibs-htmlframes2.patch
}
