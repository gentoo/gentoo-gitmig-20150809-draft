...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-3.0.1.20020604.ebuild,v 1.2 2002/07/11 06:30:26 drobbins Exp $

inherit kde-patch kde kde.org
#don't inherit kde-patch kde-base or kde-dist! it calls need-kde which adds kdelibs to depend!
