...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-3.5.6-r6.ebuild,v 1.1 2007/04/25 08:48:16 carlo Exp $
...
SRC_URI="mirror://kde/stable/${PV}/src/${P}.tar.bz2
	mirror://gentoo/kdelibs-3.5-patchset-07.tar.bz2
...
src_unpack() {
	...
	if use utempter ; then
		epatch "${WORKDIR}/patches/kdelibs-3.5_libutempter.patch" || die "Failed to apply patch for utempter support."
	fi
