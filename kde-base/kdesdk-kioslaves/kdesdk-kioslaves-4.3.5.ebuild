...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdesdk-kioslaves/kdesdk-kioslaves-4.3.5.ebuild,v 1.3 2010/02/25 12:46:53 ssuominen Exp $
...
RDEPEND="${DEPEND}
	!kdeprefix? (
		subversion? ( !<dev-util/kdesvn-1.5.1:4 )
	)
"
