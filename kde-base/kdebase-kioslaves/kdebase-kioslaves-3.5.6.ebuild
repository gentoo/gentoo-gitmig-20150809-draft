...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-kioslaves/kdebase-kioslaves-3.5.6.ebuild,v 1.1 2007/01/16 19:59:59 flameeyes Exp $
...
PATCHES="${FILESDIR}/${P}-fstab.patch"
