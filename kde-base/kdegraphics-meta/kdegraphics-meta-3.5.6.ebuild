...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdegraphics-meta/kdegraphics-meta-3.5.6.ebuild,v 1.1 2007/01/16 20:06:32 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="gphoto2? ( $(deprange $PV $MAXKDEVER kde-base/kamera) )
	...
	scanner? ( $(deprange $PV $MAXKDEVER kde-base/kooka)
	    $(deprange 3.5.5 $MAXKDEVER kde-base/libkscan) )
