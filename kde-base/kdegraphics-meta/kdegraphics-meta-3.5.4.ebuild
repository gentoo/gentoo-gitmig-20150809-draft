...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdegraphics-meta/kdegraphics-meta-3.5.4.ebuild,v 1.1 2006/07/25 04:35:35 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="gphoto2? ( $(deprange $PV $MAXKDEVER kde-base/kamera) )
	...
	scanner? ( $(deprange $PV $MAXKDEVER kde-base/kooka)
	    $(deprange 3.5.3 $MAXKDEVER kde-base/libkscan) )
