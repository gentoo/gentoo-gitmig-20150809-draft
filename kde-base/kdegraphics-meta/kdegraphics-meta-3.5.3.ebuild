...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdegraphics-meta/kdegraphics-meta-3.5.3.ebuild,v 1.1 2006/06/01 17:47:26 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="gphoto2? ( $(deprange $PV $MAXKDEVER kde-base/kamera) )
	$(deprange 3.5.2 $MAXKDEVER kde-base/kcoloredit)
