...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase/kdebase-3.5.8-r2.ebuild,v 1.1 2007/12/01 17:29:55 philantrop Exp $
...
PATCHES="${FILESDIR}/ksmserver-3.5.8-gdm_interop_197133.patch
		${FILESDIR}/kdm-3.5.8-login.diff"
