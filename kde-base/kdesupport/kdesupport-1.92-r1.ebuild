...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdesupport/kdesupport-1.92-r1.ebuild,v 1.2 2000/08/16 04:38:06 drobbins Exp $

P=kdesupport-1.92
A=${P}.tar.bz2
S=${WORKDIR}/${P}
DESCRIPTION="KDE 2Beta - Support"
SRC_URI="ftp://ftp.kde.org/pub/kde/unstable/distribution/2.0Beta3/tar/src/"${A}
HOMEPAGE="http://www.kde.org/"

src_compile() {
    ./configure --prefix=/opt/kde --host=${CHOST} --enable-threads \
