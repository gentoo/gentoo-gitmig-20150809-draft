...
# $Header: /var/cvsroot/gentoo-x86/kde-base/quanta/quanta-3.5.8-r1.ebuild,v 1.1 2008/01/06 14:31:53 philantrop Exp $
KMNAME=kdewebdev
MAXKDEVER=$PV
...
PATCHES="${FILESDIR}/${P}-left-over-tab-fix.diff"
