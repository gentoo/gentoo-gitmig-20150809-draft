...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdm/kdm-3.4.3-r2.ebuild,v 1.3 2006/06/15 06:46:44 corsair Exp $
...
PATCHES="${PATCHES} $FILESDIR/post-3.5.0-kdebase-kdm.diff"
