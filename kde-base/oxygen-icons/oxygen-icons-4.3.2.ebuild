...
# $Header: /var/cvsroot/gentoo-x86/kde-base/oxygen-icons/oxygen-icons-4.3.2.ebuild,v 1.1 2009/10/06 20:35:10 alexxy Exp $
...
RDEPEND="
	!kdeprefix? (
		...
		!~kde-base/kmail-4.3.1[-kdeprefix]
	)
	kdeprefix? (
		...
		!~kde-base/kmail-4.3.1:${SLOT}[kdeprefix]
	)
"
