...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-meta/kdebase-meta-3.5.5.ebuild,v 1.1 2006/10/03 09:52:46 flameeyes Exp $
MAXKDEVER=$PV
...
$(deprange 3.5.4 $MAXKDEVER kde-base/kcheckpass)
$(deprange 3.5.4 $MAXKDEVER kde-base/kcminit)
$(deprange $PV $MAXKDEVER kde-base/kcontrol)
$(deprange 3.5.4 $MAXKDEVER kde-base/kdcop)
$(deprange 3.5.4 $MAXKDEVER kde-base/kdebugdialog)
...
$(deprange 3.5.4 $MAXKDEVER kde-base/kreadconfig)
...
$(deprange 3.5.4 $MAXKDEVER kde-base/kstart)
