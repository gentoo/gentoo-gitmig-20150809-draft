...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdeadmin-meta/kdeadmin-meta-3.5.5.ebuild,v 1.1 2006/10/03 09:41:35 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="$(deprange $PV $MAXKDEVER kde-base/kcron)
	...
	$(deprange 3.5.4 $MAXKDEVER kde-base/secpolicy)"
