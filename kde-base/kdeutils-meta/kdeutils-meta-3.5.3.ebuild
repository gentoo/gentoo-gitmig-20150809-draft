...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdeutils-meta/kdeutils-meta-3.5.3.ebuild,v 1.1 2006/06/01 18:13:35 flameeyes Exp $
MAXKDEVER=$PV
...
RDEPEND="
	...
	$(deprange 3.5.2 $MAXKDEVER kde-base/kcharselect)
	lirc? ( $(deprange $PV $MAXKDEVER kde-base/kdelirc) )
	$(deprange 3.5.2 $MAXKDEVER kde-base/kdf)
	...
	$(deprange 3.5.2 $MAXKDEVER kde-base/kjots)
	...
	$(deprange 3.5.2 $MAXKDEVER kde-base/ktimer)
