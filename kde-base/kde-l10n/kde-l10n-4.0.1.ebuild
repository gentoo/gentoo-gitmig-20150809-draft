...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-l10n/kde-l10n-4.0.1.ebuild,v 1.1 2008/02/07 00:11:25 philantrop Exp $
...
LANGS="ar be bg ca cs csb da de el en_GB eo es et eu fi fr fy ga gl hi hu it ja
kk km ko lv mk nb nds ne nl nn pa pl pt pt_BR ru se sl sv th tr uk wa zh_CN zh_TW"
