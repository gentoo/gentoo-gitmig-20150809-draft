...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-i18n/kde-i18n-3.3.1.ebuild,v 1.11 2005/02/08 17:10:07 greg_g Exp $
...
SRC_URI="linguas_ar? ( mirror://kde/stable/${MY_PV}/src/kde-i18n/kde-i18n-ar-${PV}.tar.bz2 )
	...
	linguas_eo? ( mirror://kde/stable/${MY_PV}/src/kde-i18n/kde-i18n-eo-${PV}.tar.bz2 )
	...
	linguas_pa? ( mirror://kde/stable/${MY_PV}/src/kde-i18n/kde-i18n-pa-${PV}.tar.bz2 )
	...
	linguas_sr? ( mirror://kde/stable/${MY_PV}/src/kde-i18n/kde-i18n-sr@Latn-${PV}.tar.bz2 )
	...
	linguas_tg? ( mirror://kde/stable/${MY_PV}/src/kde-i18n/kde-i18n-tg-${PV}.tar.bz2 )
