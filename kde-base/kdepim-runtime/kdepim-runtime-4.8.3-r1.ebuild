...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdepim-runtime/kdepim-runtime-4.8.3-r1.ebuild,v 1.1 2012/05/14 08:25:35 johu Exp $
...
PATCHES=( "${FILESDIR}/${P}-revert-dav.patch" )
