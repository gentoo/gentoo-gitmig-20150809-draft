...
# $Header: /var/cvsroot/gentoo-x86/kde-base/arts/arts-1.2.2.ebuild,v 1.15 2005/01/15 12:54:34 danarmak Exp $
...
SRC_URI="mirror://kde/stable/${PV/1.2.2/3.2.2}/src/${PN}-${PV}.tar.bz2"
...
LDPATH=${PREFIX}/lib
CONFIG_PROTECT=${PREFIX}/share/config" > ${D}/etc/env.d/48kdepaths-3.2.2 # number goes down with version upgrade

	echo "KDEDIR=$PREFIX" > ${D}/etc/env.d/57kdedir-3.2.2 # number goes up with version upgrade
