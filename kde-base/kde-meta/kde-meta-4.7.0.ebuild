...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kde-meta/kde-meta-4.7.0.ebuild,v 1.1 2011/07/27 14:04:39 alexxy Exp $
...
IUSE="accessibility nls oldpim sdk semantic-desktop"
...
RDEPEND="
	...
	semantic-desktop? (
		!oldpim? ( $(add_kdebase_dep kdepim-meta) )
		oldpim? ( $(add_kdebase_dep kdepim-meta "" 4.4.11.1) )
	)
"
