...
# $Header: /var/cvsroot/gentoo-x86/net-firewall/shorewall6/shorewall6-4.2.11-r1.ebuild,v 1.5 2010/04/15 15:48:06 ranger Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}"/${PN}.initd2 ${PN} || die "doinitd failed"
