...
# $Header: /var/cvsroot/gentoo-x86/media-sound/xmms-aalsa/xmms-aalsa-0.5.4.ebuild,v 1.1 2001/01/16 06:43:50 drobbins Exp $
...
DEPEND=">=sys-libs/glibc-2.1.3 >=media-sound/xmms-1.2.3 >=media-libs/alsalib-0.5.9"
