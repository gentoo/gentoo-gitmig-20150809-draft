...
# $Header: /var/cvsroot/gentoo-x86/media-sound/freqtweak/freqtweak-0.5.0.ebuild,v 1.4 2004/02/10 11:08:13 eradicator Exp $
...
pkg_setup() {
	if wx-config --cppflags | grep gtk2u >& /dev/null; then
		einfo "${PF} will not build if wxGTK was compiled"
