...
# $Header: /var/cvsroot/gentoo-x86/media-sound/qmpdclient/qmpdclient-1.1.3.ebuild,v 1.2 2010/10/14 22:59:04 hwoarang Exp $
...
src_prepare() {
	...
	# Fix package version
	sed -i -e "/^VERSION/s:= .*:= ${PV}:" ${PN}.pro || die "failed to fix package version"
	# nostrip fix
