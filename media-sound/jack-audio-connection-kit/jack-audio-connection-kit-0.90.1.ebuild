...
# $Header: /var/cvsroot/gentoo-x86/media-sound/jack-audio-connection-kit/jack-audio-connection-kit-0.90.1.ebuild,v 1.8 2004/07/09 09:51:09 eradicator Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-doc-option.patch || \
		die "Configure doc-option patch failed"
