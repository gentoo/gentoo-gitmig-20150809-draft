...
# $Header: /var/cvsroot/gentoo-x86/media-sound/pulseaudio/pulseaudio-0.9.5-r5.ebuild,v 1.1 2007/05/29 11:17:31 flameeyes Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-CVE-2007-1804.patch"
