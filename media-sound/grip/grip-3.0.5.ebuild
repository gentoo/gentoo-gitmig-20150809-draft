...
# $Header: /var/cvsroot/gentoo-x86/media-sound/grip/grip-3.0.5.ebuild,v 1.1 2003/01/22 02:37:04 agenkin Exp $
...
src_compile() {
	local myconf
	# Compilation fails with --disable-nls for 3.0.5.
	# <agenkin@gentoo.org> Jan 21, 2003
