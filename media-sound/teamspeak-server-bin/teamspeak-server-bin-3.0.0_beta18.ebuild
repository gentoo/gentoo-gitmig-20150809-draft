...
# $Header: /var/cvsroot/gentoo-x86/media-sound/teamspeak-server-bin/teamspeak-server-bin-3.0.0_beta18.ebuild,v 1.1 2010/02/08 13:59:47 trapni Exp $
...
SRC_URI="
	amd64? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-18/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-18/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )
"
