...
SRC_URI="
	amd64? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-23/teamspeak3-server_linux-amd64-${PV/_/-}.tar.gz )
	x86? ( http://ftp.4players.de/pub/hosted/ts3/releases/beta-23/teamspeak3-server_linux-x86-${PV/_/-}.tar.gz )
"
