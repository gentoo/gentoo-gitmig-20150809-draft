...
# $Header: /var/cvsroot/gentoo-x86/media-sound/amarok/amarok-1.4.2-r1.ebuild,v 1.1 2006/08/31 09:17:00 flameeyes Exp $
...
PATCHES="${FILESDIR}/${P}-20restarts.patch
	${FILESDIR}/${P}-audiocd-freeze.patch
	${FILESDIR}/${P}-collection-sqlite.patch
	${FILESDIR}/${P}-libmtp.patch"
