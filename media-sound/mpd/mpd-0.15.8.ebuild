...
# $Header: /var/cvsroot/gentoo-x86/media-sound/mpd/mpd-0.15.8.ebuild,v 1.11 2011/07/17 16:08:37 angelos Exp $
...
fluidsynth profile +id3tag ipv6 jack lame lastfmradio mms libsamplerate +mad
...
src_configure() {
	...
	econf \
		...
		$(use_enable lastfmradio lastfm) $(use_enable mms) \
