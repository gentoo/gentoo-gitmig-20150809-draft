...
# $Header: /var/cvsroot/gentoo-x86/media-sound/mbrola/mbrola-3.0.1h-r1.ebuild,v 1.9 2004/03/17 03:50:47 eradicator Exp $
...
DEPEND=">=media-accessibility/festival-1.4.2
	app-arch/unzip"
