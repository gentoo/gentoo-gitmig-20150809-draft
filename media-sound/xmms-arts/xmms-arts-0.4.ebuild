...
# $Header: /var/cvsroot/gentoo-x86/media-sound/xmms-arts/xmms-arts-0.4.ebuild,v 1.3 2001/01/16 15:18:38 achim Exp $
...
src_unpack() {
	...
	sed -e "s:artsc-config:/opt/kde2/bin/artsc-config:" Makefile.orig > Makefile.am
	autoconf
}
