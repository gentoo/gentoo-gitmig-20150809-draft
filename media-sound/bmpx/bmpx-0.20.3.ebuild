...
# $Header: /var/cvsroot/gentoo-x86/media-sound/bmpx/bmpx-0.20.3.ebuild,v 1.1 2006/07/25 14:29:12 chutzpah Exp $

inherit fdo-mime

DESCRIPTION="Next generation Beep Media Player"
HOMEPAGE="http://www.beep-media-player.org"
SRC_URI="http://files.beep-media-player.org/releases/0.20/${P}.tar.bz2
