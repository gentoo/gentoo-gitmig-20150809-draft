...
# $Header: /var/cvsroot/gentoo-x86/media-sound/bmpx/bmpx-0.40.7.ebuild,v 1.1 2007/09/16 15:21:25 drac Exp $
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="debug doc hal modplug sid startup-notification"
...
pkg_postinst() {
	einfo
	elog "You have to install gst-plugins you want yourself, they are"
	elog "optional runtime depends. You most likely want at least"
	elog "gst-plugins-mad for mp3 support and gst-plugins-alsa for"
	elog "audio backend."
	einfo
