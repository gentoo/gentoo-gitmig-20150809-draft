...
# $Header: /var/cvsroot/gentoo-x86/games-action/chickens/chickens-0.2.0.ebuild,v 1.1 2004/07/10 07:27:09 mr_bones_ Exp $
...
src_unpack() {
	...
	sed -i \
		...
		-e "s:\"dat/:\"${GAMES_DATADIR}/${PN}/dat/:" main.cpp \
