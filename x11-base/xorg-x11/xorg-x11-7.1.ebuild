...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-x11/xorg-x11-7.1.ebuild,v 1.1 2006/05/28 16:46:31 joshuabaergen Exp $
...
RDEPEND="${RDEPEND}
	...
	>=x11-apps/xinit-1.0.2
	>=x11-apps/xmodmap-1.0.1
