...
src_unpack() {
	...
	unpack sis_drv_src_${SISDRV_VER}.tar.gz
	ln -s ${S}/programs/Xserver/hw/xfree86/vbe/vbe.h \
	...
	cd ${WORKDIR}
	unpack XFree86-4.3.0-drivers-via-${VIADRV_VER}.tar.bz2
	cd ${S}
	eend 0

	ebegin "Adding Synaptics touchpad driver"
	cd ${WORKDIR}
	unpack synaptics-${SYNDRV_VER}.tar.gz
	cd ${S}
	eend 0
