...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xfree/xfree-4.2.1-r4.ebuild,v 1.2 2004/02/17 22:51:27 spyderous Exp $
...
X_PATCHES="http://ftp.xfree86.org/pub/XFree86/${PV}/patches/${BASE_PV}-${PV}.diff.gz
	...
	http://dev.gentoo,org/~seemant/extras/XFree86-${PV}-patches-${PATCH_VER}.tar.bz2"
