...
BASE_PV="${PV}"
MY_SV="Free86-${BASE_PV}"
# XFree86-4.3.99.6.tar.bz2


S="${WORKDIR}/xc"
#SRC_PATH0="ftp://ftp.fit.vutbr.cz/pub/XFree86/develsnaps"
...
SRC_URI="${SRC_PATH0}/X${MY_SV}.tar.bz2
			mirror://gentoo/eurofonts-X11.tar.bz2
			mirror://gentoo/xfsft-encodings.tar.bz2
			${X_DRIVERS}"
#			${X_PATCHES}"

# cyfred: These appeard to be integrated already.
...
src_unpack() {
	...
	unpack X${MY_SV}.tar.bz2
	#unpack XFree86-4.3.0-patches-${PATCH_VER}.tar.bz2

	# cyfred::
	# Apply patch to create xc/exports/lib
	# Apply patch to redirect libXau.a locations
	cd ${S}
	epatch ${FILESDIR}/${PV}/exports-lib.patch
	cd ${S}/programs/Xserver/
	epatch ${FILESDIR}/${PV}/AuthLib.patch
	...
	epatch ${FILESDIR}/${PV}/acecad.patch
