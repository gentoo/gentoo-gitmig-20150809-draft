...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.3.0.0-r6.ebuild,v 1.14 2009/08/14 09:11:25 remi Exp $
...
PDEPEND="
	xorg? (
		...
		video_cards_intel? ( >=x11-drivers/xf86-video-intel-1.6.0 )
