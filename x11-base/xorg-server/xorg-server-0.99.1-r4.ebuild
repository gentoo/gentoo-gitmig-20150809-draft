...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-0.99.1-r4.ebuild,v 1.1 2005/08/21 02:39:07 spyderous Exp $
...
SRC_URI="${SRC_URI}
	http://xorg.freedesktop.org/extras/${MESA_P}.tar.gz
