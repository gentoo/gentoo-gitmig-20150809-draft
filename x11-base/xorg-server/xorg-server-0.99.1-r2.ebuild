...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-0.99.1-r2.ebuild,v 1.3 2005/08/12 17:12:12 spyderous Exp $
...
SRC_URI="${SRC_URI}
	...
	http://dev.gentoo.org/~spyderous/xorg-x11/xorg-server-0.99.1-update-to-CVS-HEAD-20050811.patch.gz"
