...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.7.3.901-r1.ebuild,v 1.3 2009/12/26 16:01:58 scarabeus Exp $
...
UPSTREAMED_PATCHES=(
	...
	"${FILESDIR}/${PV}-0001-dix-if-owner-events-is-true-for-passive-grabs-add-th.patch"
	)
