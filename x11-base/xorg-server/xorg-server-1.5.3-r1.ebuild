...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.5.3-r1.ebuild,v 1.2 2009/01/25 17:57:29 remi Exp $
...
SRC_URI="${SRC_URI}
	...
	mirror://gentoo/${P}-gentoo-patches-03.tar.bz2"
