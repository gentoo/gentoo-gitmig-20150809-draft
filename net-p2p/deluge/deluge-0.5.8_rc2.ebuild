...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/deluge/deluge-0.5.8_rc2.ebuild,v 1.3 2007/12/28 18:13:06 mr_bones_ Exp $
...
SRC_URI="http://download.deluge-torrent.org/tarball/${MY_PV}/${MY_P}.tar.gz"

S="${WORKDIR}/${PN}-torrent-${MY_PV}"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86 ~x86-fbsd"
IUSE="browser libnotify"
