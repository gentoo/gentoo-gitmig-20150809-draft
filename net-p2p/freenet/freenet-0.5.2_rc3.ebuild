...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/freenet/freenet-0.5.2_rc3.ebuild,v 1.1 2003/07/10 18:28:21 lostlogic Exp $

DESCRIPTION="large-scale peer-to-peer network that creates a massive virtual information store open to anyone"
SRC_URI="mirror://sourceforge/freenet/${P/_/-}.tar.gz"
