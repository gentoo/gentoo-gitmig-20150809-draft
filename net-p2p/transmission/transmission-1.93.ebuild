...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/transmission/transmission-1.93.ebuild,v 1.1 2010/05/18 09:26:34 pva Exp $
...
src_configure() {
	...
	if use gtk; then
		myconf="$(use_enable libnotify)
			$(use_enable sound libcanberra)
