...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/transmission/transmission-2.21.ebuild,v 1.1 2011/02/12 01:47:49 pva Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}"/${PN}-daemon.initd.6 ${PN}-daemon || die
	newconfd "${FILESDIR}"/${PN}-daemon.confd.3 ${PN}-daemon || die
