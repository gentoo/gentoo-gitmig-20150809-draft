...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/mldonkey/mldonkey-2.02-r2.ebuild,v 1.1 2003/01/26 15:40:47 hannes Exp $
...
SRC_URI="http://savannah.nongnu.org/download/${PN}/stable/${P}-${N}.sources.tar.gz
	mldonkeypango? ( ftp://ftp.berlios.de/pub/${PN}/pango/patches-against-CVS${PV}-${N}/pango-${PANGO_VERSION}.tar.gz  )"
