...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/linuxdcpp/linuxdcpp-9999.ebuild,v 1.1 2007/01/17 13:38:15 armin76 Exp $
...
src_compile() {
	...
	scons ${myconf} ${MAKEOPTS} CFLAGS="${CFLAGS}" PREFIX=/usr || die "scons failed"
}
