...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/bitcoind/bitcoind-0.5.3_rc2.ebuild,v 1.1 2012/02/16 04:06:28 blueness Exp $
...
SRC_URI="http://gitorious.org/bitcoin/bitcoind-stable/archive-tarball/v${PV/_/} -> bitcoin-v${PV}.tgz
	bip17? ( http://luke.dashjr.org/programs/bitcoin/files/bip17/bip17_v0.5.2.patch )
...
src_prepare() {
	cd src || die
	use bip17 && epatch "${DISTDIR}/bip17_v0.5.2.patch"
