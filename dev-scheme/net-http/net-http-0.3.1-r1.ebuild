...
# $Header: /var/cvsroot/gentoo-x86/dev-scheme/net-http/net-http-0.3.1-r1.ebuild,v 1.1 2010/09/24 13:17:14 jlec Exp $
...
src_install() {
	local GUILE_DIR="${EPREFIX}/usr/share/guile/site"
	insinto ${GUILE_DIR}
	doins -r "${S}"/net || die
	dodoc "${S}"/README || die
}
