...
# $Header: /var/cvsroot/gentoo-x86/sci-geosciences/josm/josm-1.5_p493.ebuild,v 1.3 2008/02/29 20:40:41 carlo Exp $
...
SRC_URI="http://josm.openstreetmap.de/download/${MY_P}.jar
	linguas_de? ( mirror://gentoo/lang-de-20071207.jar )
...
src_install() {
	...
	use linguas_de && newins "${DISTDIR}/lang-de-20071207.jar" lang-de.jar
