...
# $Header: /var/cvsroot/gentoo-x86/app-text/pdftk/pdftk-0.93.ebuild,v 1.1 2004/03/14 18:49:33 usata Exp $
...
pkg_setup() {
	if [ -z "$(which gcj 2>/dev/null)" ]; then
		...
		eerror "Re-emerge sys-devel/gcc with \"java\" enabled, and without \"nogcj\"."
		die "gcj not found."
	fi
}
