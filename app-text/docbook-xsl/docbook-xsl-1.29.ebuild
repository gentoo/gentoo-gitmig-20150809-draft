...
# $Header: /var/cvsroot/gentoo-x86/app-text/docbook-xsl/docbook-xsl-1.29.ebuild,v 1.1 2001/03/17 19:56:32 achim Exp $
...
src_install() {
   ...
   DEST="/usr/share/sgml/docbook/xsl/1.29"
   dodir ${DEST}
   ...
   do
    ...
    do
      mv ${i} ${i}.orig
      sed -e "s:/share/doctypes/docbook/xml/:/usr/share/sgml/docbook/xml/4.1.2/:" ${i}.orig > ${i}
      rm ${i}.orig
    done
    prepalldocs
    cd ${S}
