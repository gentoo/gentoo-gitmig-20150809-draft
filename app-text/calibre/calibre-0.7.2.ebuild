...
# $Header: /var/cvsroot/gentoo-x86/app-text/calibre/calibre-0.7.2.ebuild,v 1.1 2010/06/16 02:13:59 zmedico Exp $
...
src_prepare() {
	...
	# Sometimes upstream forgets to update the version string.
	sed -e "s:^__version__   =.*:__version__   = '$PV':" \
		-i src/calibre/constants.py || die "sed'ing in the IMAGE path failed"
