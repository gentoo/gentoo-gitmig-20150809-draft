...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/nagios-core/nagios-core-1.1-r5.ebuild,v 1.7 2004/06/24 22:08:14 agriffis Exp $
...
pkg_config() {
	if ! use noweb; then
		if use apache2; then
			...
			einfo
			einfo "Remember to edit /etc/conf.d/apache2 and add \"-D NAGIOS\""
			einfo
		else
