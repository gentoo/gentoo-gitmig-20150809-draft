...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/nagios-core/nagios-core-2.0b_p1.ebuild,v 1.1 2005/01/28 04:52:09 dragonheart Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/${PV}-submit_check_result_via_nsca.patch || die "patch failed"
