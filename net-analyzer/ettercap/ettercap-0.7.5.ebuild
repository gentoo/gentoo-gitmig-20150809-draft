...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/ettercap/ettercap-0.7.5.ebuild,v 1.2 2012/10/11 14:36:13 nativemad Exp $
...
SRC_URI="mirror://github/Ettercap/${PN}/${P}.tar.gz"
