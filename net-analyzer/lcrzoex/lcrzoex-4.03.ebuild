...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/lcrzoex/lcrzoex-4.03.ebuild,v 1.1 2002/01/24 20:01:58 woodchip Exp $
...
src_unpack() {
	...
	sed -e "s:^GCCOPT=.*:GCCOPT=${CFLAGS}:" Makefile.orig > Makefile
}
