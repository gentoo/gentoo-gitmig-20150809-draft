...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/net-snmp/net-snmp-5.2.1.ebuild,v 1.15 2005/05/17 14:51:35 ka0ttic Exp $
...
RDEPEND="${DEPEND}
	perl? ( X? ( dev-perl/perl-tk ) !minimal? ( dev-perl/TermReadKey ) )
