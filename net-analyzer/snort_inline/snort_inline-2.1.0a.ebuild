...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/snort_inline/snort_inline-2.1.0a.ebuild,v 1.4 2004/07/01 20:19:11 squinky86 Exp $
...
src_unpack() {
	...
	sed "s:var RULE_PATH ../rules:var RULE_PATH /etc/snort-inline:" < etc/snort.conf > etc/snort.conf.distrib
}
