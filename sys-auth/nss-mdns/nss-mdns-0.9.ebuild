...
# $Header: /var/cvsroot/gentoo-x86/sys-auth/nss-mdns/nss-mdns-0.9.ebuild,v 1.1 2007/01/02 19:30:34 compnerd Exp $
...
src_compile() {
	econf --enable-legacy --enable-search-domains $(use_enable avahi) || die "configure failed"
