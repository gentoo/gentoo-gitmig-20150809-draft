...
# $Header: /var/cvsroot/gentoo-x86/dev-python/setuptools/setuptools-0.6.12.ebuild,v 1.3 2010/06/14 08:23:21 phajdan.jr Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/distribute-${PV}-disable_versioned_easy_install.patch"
	epatch "${FILESDIR}/distribute-${PV}-fix_deprecation_warnings.patch"
}
