...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pygtk/pygtk-2.24.0.ebuild,v 1.1 2011/04/02 17:47:17 pacho Exp $
...
RDEPEND=">=dev-libs/glib-2.8:2
	...
	dev-python/numpy
	glade? ( >=gnome-base/libglade-2.5:2.0 )
	test? ( >=gnome-base/libglade-2.5:2.0 )
"
DEPEND="${RDEPEND}
	doc? (
		dev-libs/libxslt
...
src_configure() {
	...
	if use test; then
		! use glade && einfo "Enabling glade support as it's needed for running tests."
		myconf="--with-glade"
	fi
