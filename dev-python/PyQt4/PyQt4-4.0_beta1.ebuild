...
# $Header: /var/cvsroot/gentoo-x86/dev-python/PyQt4/PyQt4-4.0_beta1.ebuild,v 1.1 2006/05/05 17:07:56 caleb Exp $

inherit distutils

MY_P="PyQt4-gpl-${PV/_beta/beta}"
S="${WORKDIR}/${MY_P}"
