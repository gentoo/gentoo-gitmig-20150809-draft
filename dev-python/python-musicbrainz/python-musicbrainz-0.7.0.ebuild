...
# $Header: /var/cvsroot/gentoo-x86/dev-python/python-musicbrainz/python-musicbrainz-0.7.0.ebuild,v 1.1 2009/07/17 10:19:21 ssuominen Exp $
...
RDEPEND="=media-libs/musicbrainz-2*
	>=dev-lang/python-2.5
