...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pybluez/pybluez-0.16.ebuild,v 1.1 2009/03/01 09:58:38 dev-zero Exp $
...
DEPEND="|| ( >=net-wireless/bluez-libs-2.10 net-wireless/bluez )"
RDEPEND="${DEPEND}"
