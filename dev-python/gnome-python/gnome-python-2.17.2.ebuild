...
# $Header: /var/cvsroot/gentoo-x86/dev-python/gnome-python/gnome-python-2.17.2.ebuild,v 1.1 2007/02/15 20:07:19 dev-zero Exp $
...
pkg_postrm() {
	python_version
	python_mod_cleanup /usr/lib/python${PYVER}/site-packages/gtk-2.0
}
