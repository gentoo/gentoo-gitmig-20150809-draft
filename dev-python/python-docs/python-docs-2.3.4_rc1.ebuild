...
# $Header: /var/cvsroot/gentoo-x86/dev-python/python-docs/python-docs-2.3.4_rc1.ebuild,v 1.4 2004/05/15 21:11:31 kumba Exp $
...
LICENSE="PSF-2.2"
SLOT="2.3"
KEYWORDS="~x86 ~alpha ~sparc ~ppc ~mips"
IUSE=""
