...
# $Header: /var/cvsroot/gentoo-x86/dev-python/python-ldap/python-ldap-2.4.10.ebuild,v 1.5 2012/11/07 04:22:42 jer Exp $
...
HOMEPAGE="http://python-ldap.sourceforge.net/ http://www.python-ldap.org/"
