...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/nvidia-cg-toolkit/nvidia-cg-toolkit-1.4.0.4.ebuild,v 1.1 2005/12/26 17:57:11 vanquirius Exp $

inherit versionator

MY_P="Cg-$(replace_version_separator 3 '-')"
DESCRIPTION="nvidia's c graphics compiler toolkit"
HOMEPAGE="http://developer.nvidia.com/object/cg_toolkit.html"
SRC_URI="x86? ( http://download.nvidia.com/developer/cg/Cg_$(get_version_component_range 1-2)/${MY_P}_x86.tar.gz )
	amd64? ( http://download.nvidia.com/developer/cg/Cg_$(get_version_component_range 1-2)/${MY_P}_x86_64.tar.gz )"
