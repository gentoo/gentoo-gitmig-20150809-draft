...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp/gimp-1.1.28.ebuild,v 1.1 2000/10/28 15:47:20 achim Exp $
...
src_install() {                               
  cd ${S}
  try make prefix=${D}/usr/X11R6 sysconfdir=${D}/etc install
  preplib /usr/X11R6
