...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp/gimp-2.2.11-r1.ebuild,v 1.7 2006/07/06 16:30:57 wolf31o2 Exp $
...
P_HELP="gimp-help-2-0.10"
S_HELP="$WORKDIR/${P_HELP}"
SRC_URI="mirror://gimp/v2.2/${P}.tar.bz2
	doc? ( mirror://gimp/help/${P_HELP}.tar.gz )"
