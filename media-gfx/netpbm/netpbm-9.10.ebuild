...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/netpbm/netpbm-9.10.ebuild,v 1.2 2001/02/21 07:06:52 pete Exp $
...
src_install () {
    ...
    dodoc COPYRIGHT.PATENT GNUmakefile GPL_LICENSE.txt HISTORY
