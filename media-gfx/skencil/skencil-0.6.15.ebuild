...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/skencil/skencil-0.6.15.ebuild,v 1.1 2003/12/11 21:36:18 hanno Exp $

IUSE="nls"
S=${WORKDIR}/sketch
DESCRIPTION="Interactive X11 vector drawing program"
SRC_URI="mirror://sourceforge/sketch/sketch-${PV}.tar.gz"
