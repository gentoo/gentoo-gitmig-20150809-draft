...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gmic/gmic-1.5.0.6.ebuild,v 1.1 2011/11/07 05:57:36 radhermit Exp $
...
src_prepare() {
	EPATCH_OPTS="-l" epatch "${FILESDIR}"/${PN}-1.5.0.4-makefile.patch
