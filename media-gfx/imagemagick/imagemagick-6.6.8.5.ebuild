...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-6.6.8.5.ebuild,v 1.1 2011/03/22 15:11:39 ssuominen Exp $
...
LICENSE="imagemagick"
SLOT="0"
KEYWORDS="~amd64 ~mips ~x86 ~ppc-aix ~x86-fbsd ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
