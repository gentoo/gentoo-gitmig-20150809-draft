...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-5.5.7.11.ebuild,v 1.4 2003/12/03 15:53:31 agriffis Exp $
...
src_install() {
	...
	dosym /usr/lib/libMagick-5.5.7-Q16.so.0.0.0 /usr/lib/libMagick.so.5
}
