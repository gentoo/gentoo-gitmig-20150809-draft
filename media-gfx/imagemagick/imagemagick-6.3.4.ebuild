...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-6.3.4.ebuild,v 1.4 2008/12/29 05:15:22 robbat2 Exp $
...
SRC_URI="mirror://imagemagick/${MY_P}-4.tar.bz2
		 mirror://imagemagick/legacy/${MY_P}-4.tar.bz2"
