...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/pdf2svg/pdf2svg-0.2.2.ebuild,v 1.2 2014/03/13 05:45:44 ssuominen Exp $
...
DOCS="AUTHORS ChangeLog" # README.md doesn't have anything useful for usage
