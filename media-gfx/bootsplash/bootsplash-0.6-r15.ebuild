...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/bootsplash/bootsplash-0.6-r15.ebuild,v 1.2 2004/04/25 22:34:05 mholzer Exp $
...
src_install() {
	...
	if [ ! -e ${ROOT}/etc/bootsplash/default ]; then
		use livecd \
			&& dosym ./livecd-2004.1 /etc/bootsplash/default \
