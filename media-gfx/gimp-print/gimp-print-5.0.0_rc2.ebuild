...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp-print/gimp-print-5.0.0_rc2.ebuild,v 1.1 2006/01/24 19:16:36 genstef Exp $
...
pkg_setup() {
	if built_with_use media-gfx/gimp gimpprint; then
