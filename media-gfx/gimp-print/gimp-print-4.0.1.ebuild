...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp-print/gimp-print-4.0.1.ebuild,v 1.1 2000/11/05 09:39:16 achim Exp $

A=print-4.0.1.tar.gz
S=${WORKDIR}/print-4.0.1
