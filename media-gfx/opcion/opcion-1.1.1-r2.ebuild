...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/opcion/opcion-1.1.1-r2.ebuild,v 1.2 2008/10/23 05:38:11 darkside Exp $
...
src_install() {
	...
	newins FontViewer/resources/icons/IconSmall.png ${PN}-icon.png
	make_desktop_entry ${PN} opcion ${PN}-icon.png
}
