...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/blender/blender-2.14.ebuild,v 1.1 2001/07/26 05:54:55 drobbins Exp $
...
src_install () {
	...
	dodir /usr/X11R6/bin
	dosym /opt/blender-${PV}/blender /usr/X11R6/bin/blender
}
