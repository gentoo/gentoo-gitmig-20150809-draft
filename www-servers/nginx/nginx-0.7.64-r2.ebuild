...
# $Header: /var/cvsroot/gentoo-x86/www-servers/nginx/nginx-0.7.64-r2.ebuild,v 1.1 2010/01/03 19:51:40 djc Exp $
...
IUSE="addition debug fastcgi flv imap pcre perl pop random-index smtp ssl static-gzip status sub webdav zlib"
