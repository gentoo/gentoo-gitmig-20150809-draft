...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt/qt-4.2.0_pre1.ebuild,v 1.3 2006/07/09 06:04:31 flameeyes Exp $
...
SRC_URI="ftp://ftp.trolltech.com/pub/qt/source/qt-x11-${SRCTYPE}-${PV/_pre/-tp}.tar.gz"
S=${WORKDIR}/qt-x11-${SRCTYPE}-${PV/_pre/-tp}
