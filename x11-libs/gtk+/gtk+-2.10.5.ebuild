...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/gtk+/gtk+-2.10.5.ebuild,v 1.1 2006/10/02 16:54:26 leio Exp $
...
src_unpack() {
	...
	# Fix typo in 2.10.5 that leads to build failure
	epatch "${FILESDIR}"/${P}-buildfile_typo.patch
