...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/gtk+/gtk+-2.0.7-r1.ebuild,v 1.6 2003/02/13 16:56:21 vapier Exp $
...
src_unpack() {
	unpack ${A}
	# fix a typo in gdk-pixbuf source
	patch -d ${S} -p1 < ${FILESDIR}/gentoo-${P}-gdk-pixbuf.patch
}
