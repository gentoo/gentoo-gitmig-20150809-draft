...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/wxGTK/wxGTK-2.6.1-r1.ebuild,v 1.1 2006/01/26 20:34:24 vanquirius Exp $
...
src_unpack() {
	unpack ${A}
	# bug 105189 - upstream in 2.6.2
	epatch "${FILESDIR}"/${P}-windowcpp.diff
}
