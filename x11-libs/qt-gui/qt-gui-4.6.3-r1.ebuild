...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-gui/qt-gui-4.6.3-r1.ebuild,v 1.4 2010/11/10 21:28:14 hwoarang Exp $
...
IUSE="+accessibility cups dbus +glib mng nas nis raster tiff trace qt3support xinerama"
...
pkg_setup() {
	echo
	elog "Qt's GTK style was moved to x11-themes/qgtkstyle to fix bug #336801"
	echo
