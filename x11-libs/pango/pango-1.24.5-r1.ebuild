...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/pango/pango-1.24.5-r1.ebuild,v 1.11 2009/11/28 14:48:11 remi Exp $
...
pkg_setup() {
	G2CONF="${G2CONF} $(use_with deprecated x)"
}
