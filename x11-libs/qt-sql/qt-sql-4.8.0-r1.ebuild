...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-sql/qt-sql-4.8.0-r1.ebuild,v 1.1 2012/02/23 23:49:46 pesa Exp $
...
pkg_setup() {
	...
	if ! { use firebird || use freetds || use mysql || use odbc || use postgres || use sqlite; }; then
		ewarn "You need to enable at least one SQL driver. Enable at least one"
		ewarn "of these USE flags: \"firebird freetds mysql odbc postgres sqlite\"."
