...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-Package-Constants/perl-Package-Constants-0.02.ebuild,v 1.13 2010/07/14 06:39:25 tove Exp $
...
RDEPEND="|| ( ~dev-lang/perl-5.12.1 ~dev-lang/perl-5.10.1 ~perl-core/Package-Constants-${PV} )"
