...
# $Header: /var/cvsroot/gentoo-x86/virtual/jpeg/jpeg-0.ebuild,v 1.6 2012/04/26 13:05:01 ssuominen Exp $
...
RDEPEND="!prefix? ( media-libs/libjpeg-turbo:0[static-libs?] )
	prefix? ( || ( media-libs/libjpeg-turbo:0[static-libs?] media-libs/jpeg:0[static-libs?] ) )"
DEPEND=""
