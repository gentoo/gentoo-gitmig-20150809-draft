...
# $Header: /var/cvsroot/gentoo-x86/virtual/perl-digest-base/perl-digest-base-1.160.0.ebuild,v 1.1 2011/05/18 16:14:17 tove Exp $
...
DEPEND=""
RDEPEND="|| ( ~dev-lang/perl-5.14.0 ~dev-lang/perl-5.12.3 ~dev-lang/perl-5.12.2 ~dev-lang/perl-5.10.1 ~perl-core/digest-base-${PV} )"
