...
# $Header: /var/cvsroot/gentoo-x86/net-mail/dovecot/dovecot-1.1.8.ebuild,v 1.1 2009/01/13 18:01:25 wschlich Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-5417c01fff5b.patch
	epatch "${FILESDIR}"/${P}-b42c06ef8213.patch
}
