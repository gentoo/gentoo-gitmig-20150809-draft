...
# $Header: /var/cvsroot/gentoo-x86/net-mail/dovecot/dovecot-1.1.7.ebuild,v 1.1 2008/11/25 17:38:57 wschlich Exp $
...
pkg_preinst() {
	if [[ -e "${ROOT}"/etc/dovecot/dovecot.conf ]]; then
		chmod 0600 "${ROOT}"/etc/dovecot/dovecot.conf # bug #245316
	fi
}
