...
# $Header: /var/cvsroot/gentoo-x86/net-mail/uw-imap/uw-imap-2002a.ebuild,v 1.2 2003/01/02 10:29:03 pvdabeel Exp $

S=${WORKDIR}/imap-2002a

DESCRIPTION="UW server daemons for IMAP and POP network mail protocols."
SRC_URI="ftp://ftp.cac.washington.edu/imap/imap-2002a.tar.Z"
