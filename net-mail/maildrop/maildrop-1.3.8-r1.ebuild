...
# $Header: /var/cvsroot/gentoo-x86/net-mail/maildrop/maildrop-1.3.8-r1.ebuild,v 1.1 2002/05/02 18:49:15 woodchip Exp $
...
src_compile() {
	export CFLAGS="${CFLAGS/-fomit-frame-pointer -ffast-math/}"
	./configure \
		--prefix=/usr \
		--with-devel \
		--enable-userdb \
