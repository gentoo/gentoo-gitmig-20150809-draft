...
# $Header: /var/cvsroot/gentoo-x86/net-mail/pine/pine-4.56.ebuild,v 1.4 2003/07/11 21:13:16 raker Exp $
...
SRC_URI="ftp://ftp.cac.washington.edu/pine/${PN}${PV}.tar.bz2
	mirror://gentoo//${P}-chappa-20030609.patch.bz2"
...
src_unpack() {
	...
	epatch ${DISTDIR}/${P}-chappa-20030609.patch.bz2 || die
