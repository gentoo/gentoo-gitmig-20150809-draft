...
# $Header: /var/cvsroot/gentoo-x86/net-mail/pine/pine-4.50-r2.ebuild,v 1.3 2002/12/09 04:33:14 manson Exp $
...
src_unpack() {
	...
	# -r2 removes the problematic multibyte-char patch parts
	patch -d ${S} -p1 < ${FILESDIR}/4.50-gentoo-r2.diff \
		|| die "patch failed"
