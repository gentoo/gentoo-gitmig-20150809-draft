...
# $Header: /var/cvsroot/gentoo-x86/net-mail/cyrus-imapd/cyrus-imapd-2.1.10.ebuild,v 1.2 2002/12/09 04:33:13 manson Exp $
...
src_unpack() {
	...
	# Quiet down warnings when compiling with SSL enabled
