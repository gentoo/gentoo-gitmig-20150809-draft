...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/drbd/drbd-0.7.8.ebuild,v 1.6 2005/01/27 15:23:59 xmerlin Exp $
...
src_compile() {
	...
	einfo ""
	einfo "Please use vanilla kernel =< 2.6.10 with drbd 0.7.8"
	einfo ""
