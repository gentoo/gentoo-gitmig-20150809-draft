...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/openmpi/openmpi-1.2.9-r1.ebuild,v 1.1 2009/08/18 00:32:27 jsbronder Exp $
...
src_compile() {
	...
	if use fortran; then
		if [[ "${FORTRANC}" = "g77" ]]; then
			...
			myconf="${myconf} --with-wrapper-fflags=-I/usr/include --with-wrapper-fcflags=-I/usr/include"
