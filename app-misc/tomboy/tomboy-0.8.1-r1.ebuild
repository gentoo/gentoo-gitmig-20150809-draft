...
# $Header: /var/cvsroot/gentoo-x86/app-misc/tomboy/tomboy-0.8.1-r1.ebuild,v 1.6 2008/02/01 18:55:23 dertobi123 Exp $
...
src_unpack() {
	...
	# Security Fix (Bug #189249)
	epatch "${FILESDIR}/${PN}-0.8.1-insecure-ldpath.patch"
}
