...
# $Header: /var/cvsroot/gentoo-x86/app-misc/jpilot/jpilot-0.99.2.ebuild,v 1.1 2002/02/12 21:20:16 blocke Exp $

SYNCMAL="0.62.2"
MALSYNC="2.0.7"
A="${P}.tar.gz jpilot-syncmal_${SYNCMAL}.tar.gz malsync_${MALSYNC}.src.tar.gz"
S=${WORKDIR}/${P}
