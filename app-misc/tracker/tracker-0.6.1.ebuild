...
# $Header: /var/cvsroot/gentoo-x86/app-misc/tracker/tracker-0.6.1.ebuild,v 1.1 2007/08/11 20:30:05 compnerd Exp $
...
src_compile() {
	local myconf="--enable-external-sqlite --enable-external-qdbm"
