...
# $Header: /var/cvsroot/gentoo-x86/sys-block/gparted/gparted-0.9.1.ebuild,v 1.1 2011/10/01 16:09:20 ssuominen Exp $
...
src_install() {
	...
	if use kde; then
		cp "${D}"/usr/share/applications/gparted{,-kde}.desktop
