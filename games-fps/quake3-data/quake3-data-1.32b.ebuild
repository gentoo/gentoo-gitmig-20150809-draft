...
# $Header: /var/cvsroot/gentoo-x86/games-fps/quake3-data/quake3-data-1.32b.ebuild,v 1.1 2005/10/25 00:44:36 vapier Exp $
...
pkg_setup() {
	games_pkg_setup
	cdrom_get_cds Quake3/baseq3/pak0.pk3
}
...
src_install() {
	...
	doins "${CDROM_ROOT}"/Quake3/baseq3/pak0.pk3 || die "cdrom pak0"
	eend 0
