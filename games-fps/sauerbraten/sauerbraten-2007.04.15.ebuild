...
# $Header: /var/cvsroot/gentoo-x86/games-fps/sauerbraten/sauerbraten-2007.04.15.ebuild,v 1.1 2007/04/16 08:17:28 mr_bones_ Exp $

inherit eutils multilib games

DESCRIPTION="free multiplayer/singleplayer first person shooter (major redesign of the Cube FPS)"
HOMEPAGE="http://sauerbraten.org/"
SRC_URI="mirror://sourceforge/sauerbraten/sauerbraten_${PV//./_}_spring_edition_linux.tar.bz2"
