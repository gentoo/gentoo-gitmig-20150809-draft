...
# $Header: /var/cvsroot/gentoo-x86/games-fps/urbanterror/urbanterror-4.2.015.ebuild,v 1.2 2013/12/22 20:03:48 pacho Exp $
...
src_unpack() {
	...
	cp -dRpf "${WORKDIR}"/UrbanTerror-4.2.014-to-4.2.015/* "${S_DATA}"/ || die
}
