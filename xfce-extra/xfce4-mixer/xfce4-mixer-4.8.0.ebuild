...
# $Header: /var/cvsroot/gentoo-x86/xfce-extra/xfce4-mixer/xfce4-mixer-4.8.0.ebuild,v 1.2 2011/02/28 20:14:23 ssuominen Exp $
...
SRC_URI="mirror://xfce/src/apps/${PN}/4.8/${P}.tar.bz2
	http://dev.gentoo.org/~ssuominen/${P}-LINGUAS.tar.bz2"
