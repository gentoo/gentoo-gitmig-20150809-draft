...
# $Header: /var/cvsroot/gentoo-x86/xfce-extra/xfce4-power-manager/xfce4-power-manager-1.2.0-r1.ebuild,v 1.3 2012/11/15 19:33:05 nativemad Exp $
...
pkg_setup() {
	PATCHES=( "${FILESDIR}"/${P}-prevent_crash_with_locale-en_GB.patch )
