...
# $Header: /var/cvsroot/gentoo-x86/app-i18n/man-pages-cs/man-pages-cs-0.16-r1.ebuild,v 1.1 2006/06/17 15:21:45 usata Exp $
...
src_install() {
	...
	# - sys-apps/shadow +nls
	rm -f ${D}/usr/share/man/cs/man1/{chfn,chsh,newgrp,su,passwd,groups}.1
