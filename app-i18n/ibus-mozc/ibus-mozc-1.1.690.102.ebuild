...
# $Header: /var/cvsroot/gentoo-x86/app-i18n/ibus-mozc/ibus-mozc-1.1.690.102.ebuild,v 1.1 2011/05/17 13:36:40 matsuu Exp $
...
src_compile() {
	...
	# use qt4 && use zinnia && mytarget="${mytarget} gui/gui.gyp:mozc_tool"
