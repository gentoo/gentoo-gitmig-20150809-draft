...
# $Header: /var/cvsroot/gentoo-x86/app-i18n/im-ja/im-ja-0.8.ebuild,v 1.5 2004/02/29 16:55:52 aliz Exp $

inherit base gnome2

DESCRIPTION="A Japanese input module for GTK2"
HOMEPAGE="http://im-ja.sourceforge.net/"
SRC_URI="http://im-ja.sourceforge.net/${P/_p/-}.tar.gz
	http://im-ja.sourceforge.net/old/${P/_p/-}.tar.gz"
