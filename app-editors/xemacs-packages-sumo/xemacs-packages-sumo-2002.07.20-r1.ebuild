...
# $Header: /var/cvsroot/gentoo-x86/app-editors/xemacs-packages-sumo/xemacs-packages-sumo-2002.07.20-r1.ebuild,v 1.3 2002/10/17 13:17:10 vapier Exp $
...
DEPEND="sys-apps/tar sys-apps/gzip sys-apps/bzip2"
RDEPEND=""
S="${WORKDIR}"
