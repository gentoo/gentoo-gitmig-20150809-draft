...
# $Header: /var/cvsroot/gentoo-x86/app-editors/quanta/quanta-2.0.1.ebuild,v 1.1 2001/12/13 22:18:54 verwilst Exp $ 
...
src_install() {
	...
	cp -a ${WORKDIR}/${x}/*.docrc ${WORKDIR}/${x}/${x} ${D}/usr/share/apps/quanta/doc/
    done
