...
# $Header: /var/cvsroot/gentoo-x86/app-editors/gedit/gedit-2.20.4-r1.ebuild,v 1.4 2008/03/14 15:26:28 armin76 Exp $
...
src_unpack() {
	...
	# fix parallel make install, bug #205038
	epatch "${FILESDIR}"/${PN}-2.20.4-parallel-install.patch
