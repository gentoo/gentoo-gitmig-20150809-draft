...
# $Header: /var/cvsroot/gentoo-x86/media-libs/openvrml/openvrml-0.11.2.ebuild,v 1.3 2002/05/14 18:31:20 g2boojum Exp $

S=${WORKDIR}/${P}
DESCRIPTION="VRML97 library"
SRC_URI="http://unc.dl.sourceforge.net/sourceforge/openvrml/${P}.tar.gz"
