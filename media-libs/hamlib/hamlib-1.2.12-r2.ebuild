...
# $Header: /var/cvsroot/gentoo-x86/media-libs/hamlib/hamlib-1.2.12-r2.ebuild,v 1.2 2010/12/22 18:47:32 tomjbe Exp $
...
pkg_postrm()  {
	python_mod_cleanup $(python_get_sitedir)/Hamlib.py
}
