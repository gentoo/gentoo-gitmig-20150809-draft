...
# $Header: /var/cvsroot/gentoo-x86/media-libs/fontconfig/fontconfig-2.2.0-r1.ebuild,v 1.1 2003/04/27 11:53:28 azarah Exp $
...
src_unpack() {
	...
	# Blacklist some fonts taht breaks fontconfig
	epatch ${PPREFIX}-2.2-blacklist.patch
	# Add more font family's
	epatch ${PPREFIX}-2.2-defaultconfig.patch
