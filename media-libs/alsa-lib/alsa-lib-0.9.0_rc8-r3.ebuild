...
# $Header: /var/cvsroot/gentoo-x86/media-libs/alsa-lib/alsa-lib-0.9.0_rc8-r3.ebuild,v 1.4 2003/09/06 23:59:48 msterret Exp $
...
SRC_URI="ftp://ftp.alsa-project.org/pub/lib/${P/_rc/rc}c.tar.bz2"
S=${WORKDIR}/${P/_rc/rc}c
