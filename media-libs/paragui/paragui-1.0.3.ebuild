...
# $Header: /var/cvsroot/gentoo-x86/media-libs/paragui/paragui-1.0.3.ebuild,v 1.1 2003/01/14 16:40:03 drobbins Exp $
...
DEPEND=">=media-libs/libsdl-1.2.4 >=media-libs/sdl-image-1.2.1-r1 dev-libs/expat"
