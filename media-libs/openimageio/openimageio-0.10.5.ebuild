...
# $Header: /var/cvsroot/gentoo-x86/media-libs/openimageio/openimageio-0.10.5.ebuild,v 1.1 2012/02/22 18:47:37 ssuominen Exp $
...
src_prepare() {
	epatch \
		...
		"${FILESDIR}"/${PN}-0.10.2-multilib.patch
