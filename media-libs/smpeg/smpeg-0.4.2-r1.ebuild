...
# $Header: /var/cvsroot/gentoo-x86/media-libs/smpeg/smpeg-0.4.2-r1.ebuild,v 1.4 2001/05/09 10:21:22 achim Exp $
...
src_compile() {
    ...
    try ./configure --prefix=/usr --mandir=/usr/share/man --host=${CHOST} ${myconf} --disable-sdltest
    try make
