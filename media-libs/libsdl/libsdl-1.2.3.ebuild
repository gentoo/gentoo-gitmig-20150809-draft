...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libsdl/libsdl-1.2.3.ebuild,v 1.2 2001/11/17 11:28:28 danarmak Exp $
...
src_compile() {
  ...
  try ./configure --host=${CHOST} --enable-input-events --prefix=/usr --mandir=/usr/share/man ${myconf}
