...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libsdl/libsdl-1.2.3-r1.ebuild,v 1.7 2002/10/05 05:39:15 drobbins Exp $

IUSE="arts alsa xv opengl fbcon aalib nas esd X svga ggi directfb"
