...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libvorbis/libvorbis-1.0_beta4.ebuild,v 1.1 2001/04/23 01:00:39 pete Exp $


A=libvorbis-1.0beta4.tar.gz
S=${WORKDIR}/libvorbis-1.0beta4
DESCRIPTION="the Ogg Vorbis sound file format library"
SRC_URI="http://www.vorbis.com/files/beta4/unix/${A}"
HOMEPAGE="http://www.xiph.org/ogg/vorbis/index.html"

DEPEND=">=media-libs/libogg-1.0_beta4"
