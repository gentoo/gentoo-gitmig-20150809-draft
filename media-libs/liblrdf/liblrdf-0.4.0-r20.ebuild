...
# $Header: /var/cvsroot/gentoo-x86/media-libs/liblrdf/liblrdf-0.4.0-r20.ebuild,v 1.1 2011/07/29 06:47:40 ssuominen Exp $
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-{dontbuild-tests,raptor2}.patch
	eautoreconf
}
