...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libmediainfo/libmediainfo-0.7.54.ebuild,v 1.1 2012/03/16 07:07:26 radhermit Exp $
...
RDEPEND="sys-libs/zlib
	...
	>=media-libs/libzen-0.4.25[static-libs=]
	curl? ( net-misc/curl )
