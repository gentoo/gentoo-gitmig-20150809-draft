...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libmediainfo/libmediainfo-0.7.53.ebuild,v 1.1 2012/02/04 23:25:35 radhermit Exp $
...
RDEPEND="sys-libs/zlib
	...
	>=media-libs/libzen-0.4.24[static-libs=]
	curl? ( net-misc/curl )
