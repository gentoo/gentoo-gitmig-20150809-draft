...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libmediainfo/libmediainfo-0.7.58.ebuild,v 1.3 2012/06/15 09:34:26 radhermit Exp $
...
RDEPEND="sys-libs/zlib
	dev-libs/tinyxml2
	>=media-libs/libzen-0.4.27[static-libs=]
	curl? ( net-misc/curl )
