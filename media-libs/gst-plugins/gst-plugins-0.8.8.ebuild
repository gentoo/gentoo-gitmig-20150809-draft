...
# $Header: /var/cvsroot/gentoo-x86/media-libs/gst-plugins/gst-plugins-0.8.8.ebuild,v 1.12 2006/02/27 14:14:04 zaheerm Exp $
...
RDEPEND="|| ( =media-libs/gstreamer-0.8.9 =media-libs/gstreamer-0.8.10
	=media-libs/gstreamer-0.8.11 =media-libs/gstreamer-0.8.12)
	>=gnome-base/gconf-2"
