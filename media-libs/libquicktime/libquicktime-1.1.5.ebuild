...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libquicktime/libquicktime-1.1.5.ebuild,v 1.10 2011/03/23 08:19:35 radhermit Exp $
...
src_unpack() {
	...
	elibtoolize # .so versioning for gfbsd
}
