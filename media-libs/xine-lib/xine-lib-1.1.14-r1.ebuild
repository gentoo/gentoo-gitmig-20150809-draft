...
# $Header: /var/cvsroot/gentoo-x86/media-libs/xine-lib/xine-lib-1.1.14-r1.ebuild,v 1.1 2008/08/06 23:38:30 yngwin Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "$FILESDIR"/${P}-metadata-bugfix.patch
}
