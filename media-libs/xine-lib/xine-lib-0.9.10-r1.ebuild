...
# $Header: /var/cvsroot/gentoo-x86/media-libs/xine-lib/xine-lib-0.9.10-r1.ebuild,v 1.8 2002/10/05 05:39:15 drobbins Exp $ 

IUSE="arts esd avi nls dvd X oggvorbis aalib alsa"
...
src_unpack() {
	...
	patch -p0 < ${FILESDIR}/xineconfig.patch || die
