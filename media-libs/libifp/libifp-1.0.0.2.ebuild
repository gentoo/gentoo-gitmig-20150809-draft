...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libifp/libifp-1.0.0.2.ebuild,v 1.12 2009/10/07 16:12:45 ssuominen Exp $
...
pkg_postinst() {
	elog "Install media-sound/libifp-module for kernel module."
}
