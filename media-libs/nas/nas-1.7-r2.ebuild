...
# $Header: /var/cvsroot/gentoo-x86/media-libs/nas/nas-1.7-r2.ebuild,v 1.1 2007/03/09 03:08:07 beandog Exp $
...
src_install () {
	...
	use doc && dodoc doc/*.ps doc/protocol.txt doc/pdf/*.pdf doc/actions
