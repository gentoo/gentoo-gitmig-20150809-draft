...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/pidgin-facebookchat/pidgin-facebookchat-1.60.ebuild,v 1.1 2009/07/17 10:08:04 voyageur Exp $
...
src_compile() {
	...
	FACEBOOK_SOURCES="libfacebook.c fb_blist.c fb_connection.c fb_conversation.c fb_friendlist.c fb_info.c fb_managefriends.c fb_messages.c fb_notifications.c fb_search.c fb_util.c"
