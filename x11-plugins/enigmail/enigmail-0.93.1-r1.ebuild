...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/enigmail/enigmail-0.93.1-r1.ebuild,v 1.1 2005/12/24 02:50:41 anarchy Exp $
...
DEPEND=">=mail-client/mozilla-thunderbird-1.5_rc2"
RDEPEND="${DEPEND}
	>=app-crypt/gnupg-1.4
