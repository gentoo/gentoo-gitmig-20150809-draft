...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/gkrellm-gamma/gkrellm-gamma-2.03-r1.ebuild,v 1.1 2007/03/09 17:12:12 lack Exp $
...
src_unpack() {
	...
	sed -i -e '/^LIBS/aLIBS += -L/usr/X11R6/lib -lXxf86vm' Makefile || die "sed 2/2 failed"
}
