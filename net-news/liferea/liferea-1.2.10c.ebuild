...
# $Header: /var/cvsroot/gentoo-x86/net-news/liferea/liferea-1.2.10c.ebuild,v 1.1 2007/04/15 19:56:03 dang Exp $
...
src_unpack() {
	unpack ${A}
	# XXX DFG Why can't the directory names be consistent?
	mv "${PN}-1.2.10" ${S} || die
