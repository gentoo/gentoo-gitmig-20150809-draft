...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/python/python-2.1.ebuild,v 1.1 2001/06/20 00:55:30 achim Exp $

S=${WORKDIR}/Python-${PV}
S2=${WORKDIR}/python-fchksum-1.1
DESCRIPTION="A really great language"
SRC_URI="http://www.python.org/ftp/python/2.1/Python-${PV}.tgz 
