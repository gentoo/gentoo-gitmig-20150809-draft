...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/python/python-2.2-r5.ebuild,v 1.2 2002/03/30 17:00:38 drobbins Exp $
...
src_install() {
	...
	# set up a generic site-packages directory and symlink to it to allow
	# user-installed modules to follow along to upgraded python versions
	dodir /usr/lib/python/
	cd ${D}/usr/lib/python2.2
	mv site-packages ../python/
	ln -s ../python/site-packages site-packages
}
