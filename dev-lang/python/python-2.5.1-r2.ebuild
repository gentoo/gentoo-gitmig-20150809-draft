...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/python/python-2.5.1-r2.ebuild,v 1.5 2007/05/14 21:03:52 gustavoz Exp $
...
LICENSE="PSF-2.2"
SLOT="2.5"
KEYWORDS="~alpha ~hppa ~ia64 ~mips ~ppc64 ~sparc ~sparc-fbsd ~x86 ~x86-fbsd"
