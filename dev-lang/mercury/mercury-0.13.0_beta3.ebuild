...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/mercury/mercury-0.13.0_beta3.ebuild,v 1.1 2006/04/20 10:10:11 keri Exp $

inherit eutils versionator

MY_PV=$(get_version_component_range 1-3 $PV)-beta
MY_P=${PN}-compiler-${MY_PV}-2006-04-19
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P/beta3/beta}-portage.patch
	epatch "${FILESDIR}"/${P/beta3/beta}-CFLAGS.patch
	epatch "${FILESDIR}"/${P/beta3/beta}-docs.patch
}
