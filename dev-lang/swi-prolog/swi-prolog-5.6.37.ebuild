...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/swi-prolog/swi-prolog-5.6.37.ebuild,v 1.1 2007/07/14 21:55:38 keri Exp $
...
src_unpack() {
	...
	epatch "${WORKDIR}"/${PV}/3020-clib-install-event.patch
