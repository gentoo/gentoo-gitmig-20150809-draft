...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/v8/v8-3.2.8.2.ebuild,v 1.2 2011/04/19 10:15:44 phajdan.jr Exp $
...
src_compile() {
	...
	local myconf="library=shared soname=on sample=shell visibility=default importenv=\"LINKFLAGS\""
