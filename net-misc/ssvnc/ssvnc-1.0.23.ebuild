...
# $Header: /var/cvsroot/gentoo-x86/net-misc/ssvnc/ssvnc-1.0.23.ebuild,v 1.1 2009/06/21 21:59:54 vapier Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}"/${PN}-1.0.22-build.patch
	epatch "${FILESDIR}"/${PN}-1.0.22-optional-java.patch
	sed -i \
