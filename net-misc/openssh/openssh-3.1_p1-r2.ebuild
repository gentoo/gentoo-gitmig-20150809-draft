...
# $Header: /var/cvsroot/gentoo-x86/net-misc/openssh/openssh-3.1_p1-r2.ebuild,v 1.1 2002/04/04 05:05:35 drobbins Exp $
...
RDEPEND="virtual/glibc pam? ( >=sys-libs/pam-0.73 >=sys-apps/shadow-4.0.2-r2 ) >=dev-libs/openssl-0.9.6c sys-libs/zlib "
