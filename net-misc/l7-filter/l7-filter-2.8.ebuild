...
# $Header: /var/cvsroot/gentoo-x86/net-misc/l7-filter/l7-filter-2.8.ebuild,v 1.1 2006/12/22 10:58:46 dragonheart Exp $
...
which_patch() {
	...
	then
		PATCH=kernel-2.6.18-2.6.19-layer7-2.8.patch
	...
	then
		PATCH=kernel-2.4-layer7-2.8.patch
	else
