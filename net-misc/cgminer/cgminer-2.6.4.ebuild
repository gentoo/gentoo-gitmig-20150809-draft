...
# $Header: /var/cvsroot/gentoo-x86/net-misc/cgminer/cgminer-2.6.4.ebuild,v 1.1 2012/08/22 02:19:27 blueness Exp $
...
SRC_URI="http://ck.kolivas.org/apps/${PN}/2.6/${PN}-${MY_PV}.tar.bz2"
