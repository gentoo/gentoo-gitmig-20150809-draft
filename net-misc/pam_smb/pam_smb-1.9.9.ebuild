...
# $Header: /var/cvsroot/gentoo-x86/net-misc/pam_smb/pam_smb-1.9.9.ebuild,v 1.1 2002/10/25 15:54:31 woodchip Exp $
...
src_install() {
	...
	dodoc faq/pam_smb_faq.sgml faq/additions.txt
	docinto pam.d ; dodoc pam_smb.conf*
