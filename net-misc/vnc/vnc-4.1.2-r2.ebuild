...
# $Header: /var/cvsroot/gentoo-x86/net-misc/vnc/vnc-4.1.2-r2.ebuild,v 1.5 2007/05/07 17:22:11 dertobi123 Exp $

WANT_AUTOCONF="latest"
WANT_AUTOMAKE="latest"
inherit eutils toolchain-funcs multilib autotools

XSERVER_VERSION="1.2.0"
PATCH_VER=0.1
...
SRC_URI="http://ltsp.mirrors.tds.net/pub/ltsp/tarballs/${MY_P}.tar.gz
	...
	http://dev.gentooexperimental.org/~armin76/dist/${PF}-patches-${PATCH_VER}.tar.bz2
