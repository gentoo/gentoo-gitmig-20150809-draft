...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk/asterisk-1.8.4.4-r1.ebuild,v 1.1 2011/07/04 14:59:44 chainsaw Exp $
...
SRC_URI="http://downloads.asterisk.org/pub/telephony/asterisk/${MY_P}.tar.gz
	 mirror://gentoo/gentoo-asterisk-patchset-0.5.tar.bz2"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
