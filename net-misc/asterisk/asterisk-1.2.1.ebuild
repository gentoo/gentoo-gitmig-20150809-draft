...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk/asterisk-1.2.1.ebuild,v 1.3 2006/01/23 15:12:58 stkn Exp $
...
pkg_postinst() {
	...
	#
	# Upgrade 1.2.x warning...
	#
	eerror "                      Asterisk UPGRADE Warning"
	eerror ""
	eerror "!!! Read ${ROOT}usr/share/doc/${PF}/UPGRADE.txt.gz before continuing !!!"
	eerror ""
	eerror "                      Asterisk UPGRADE Warning"
}
