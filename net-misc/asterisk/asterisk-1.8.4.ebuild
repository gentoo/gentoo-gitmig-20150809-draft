...
# $Header: /var/cvsroot/gentoo-x86/net-misc/asterisk/asterisk-1.8.4.ebuild,v 1.2 2011/05/25 01:59:50 flameeyes Exp $
...
SRC_URI="http://downloads.asterisk.org/pub/telephony/asterisk/${MY_P}.tar.gz
	 mirror://gentoo/gentoo-asterisk-patchset-0.4.tar.bz2"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
