...
# $Header: /var/cvsroot/gentoo-x86/net-im/silc-client/silc-client-1.0.4.1.ebuild,v 1.1 2007/03/20 18:01:16 armin76 Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-1.0.3-docdir.patch"
}
