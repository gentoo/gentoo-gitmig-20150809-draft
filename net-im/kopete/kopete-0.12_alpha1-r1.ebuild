...
# $Header: /var/cvsroot/gentoo-x86/net-im/kopete/kopete-0.12_alpha1-r1.ebuild,v 1.1 2006/03/05 22:00:38 flameeyes Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-3.5.x-msn-filetransfer.patch"
	rm -f ${S}/configure
}
