...
# $Header: /var/cvsroot/gentoo-x86/net-im/bitlbee/bitlbee-0.90-r1.ebuild,v 1.3 2004/08/08 18:34:35 weeve Exp $

inherit eutils gcc

DESCRIPTION="irc to IM gateway that support multiple IM protocols"
HOMEPAGE="http://www.bitlbee.org/"
YAHOO_PATCH="yahoo-fix-200406.diff"
SRC_URI="http://get.bitlbee.org/src/${P}.tar.gz
	 http://get.bitlbee.org/patches/${YAHOO_PATCH}"
...
src_unpack() {
	...
	# Yahoo authentication patch
	cd ${S} && epatch ${DISTDIR}/${YAHOO_PATCH}
}
