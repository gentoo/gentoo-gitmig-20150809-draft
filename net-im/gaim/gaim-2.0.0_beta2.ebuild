...
# $Header: /var/cvsroot/gentoo-x86/net-im/gaim/gaim-2.0.0_beta2.ebuild,v 1.2 2006/01/30 17:46:36 dertobi123 Exp $
...
src_compile() {
	...
	use silc && myconf="${myconf} --with-slic-includes=$(get_includedir)/silc-toolkit --with-silc-libs=$(get_libdir)/silc-toolkit"
