...
# $Header: /var/cvsroot/gentoo-x86/net-im/gaim/gaim-2.0.0_beta2-r2.ebuild,v 1.2 2006/06/24 15:34:36 mcummings Exp $
...
src_compile() {
	...
	use silc && myconf="${myconf} --with-silc-includes=$(get_includedir)/silc-toolkit --with-silc-libs=$(get_libdir)/silc-toolkit"
