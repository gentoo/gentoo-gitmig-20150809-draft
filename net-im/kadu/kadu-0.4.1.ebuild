...
# $Header: /var/cvsroot/gentoo-x86/net-im/kadu/kadu-0.4.1.ebuild,v 1.9 2007/07/12 05:34:48 mr_bones_ Exp $
...
SRC_URI="http://kadu.net/download/stable/${P}.tar.bz2
	...
	tk? ( http://scripts.one.pl/tcl4kadu/files/snapshots/tcl_scripting-${VTCL}.tar.gz )
	extraicons? (
