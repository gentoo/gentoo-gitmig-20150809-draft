...
# $Header: /var/cvsroot/gentoo-x86/net-im/psi/psi-0.13_rc4.ebuild,v 1.1 2009/07/21 14:47:25 pva Exp $
...
SRC_URI="mirror://sourceforge/${PN}/${MY_P}.tar.bz2
	...
	extras? ( mirror://gentoo/${PN}-extra-patches-r750.tar.bz2
		mirror://gentoo/${PN}-extra-iconsets-r750.tar.bz2 )"
