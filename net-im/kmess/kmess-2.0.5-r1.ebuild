...
# $Header: /var/cvsroot/gentoo-x86/net-im/kmess/kmess-2.0.5-r1.ebuild,v 1.2 2011/01/16 12:26:06 phajdan.jr Exp $
...
SRC_URI="mirror://sourceforge/${P}/${MY_P}.tar.bz2"
...
PATCHES=(
	"${FILESDIR}"/${PV}-msn_login_url_fix.patch
)
src_configure() {
