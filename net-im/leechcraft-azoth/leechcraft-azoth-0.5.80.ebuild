...
# $Header: /var/cvsroot/gentoo-x86/net-im/leechcraft-azoth/leechcraft-azoth-0.5.80.ebuild,v 1.1 2012/08/13 14:01:21 maksbotan Exp $
...
DEPEND="~net-misc/leechcraft-core-${PV}
		...
		xoox? ( =net-libs/qxmpp-0.6*[extras] media-libs/speex )
