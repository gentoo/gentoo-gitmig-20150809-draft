...
# $Header: /var/cvsroot/gentoo-x86/net-im/msn-transport/msn-transport-20040531-r1.ebuild,v 1.9 2007/04/28 17:36:54 swegener Exp $
...
src_install() {
		...
		newinitd ${FILESDIR}/msn-transport.init-r2 msn-transport
