...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-skinsoppalusikka/vdr-skinsoppalusikka-0.0.5.ebuild,v 1.2 2006/03/20 19:02:54 hd_brummy Exp $
...
PATCHES="${FILESDIR}/${PN}-amd64.diff"
