...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-0.10-r5.ebuild,v 1.4 2011/01/31 18:22:43 pacho Exp $
...
IUSE="aac a52 alsa dv dvb dvd esd ffmpeg flac lame mp3 mpeg musepack mythtv ogg oss pulseaudio taglib theora v4l v4l2 vorbis wavpack X xv"
