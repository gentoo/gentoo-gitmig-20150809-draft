...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-0.10-r4.ebuild,v 1.10 2011/03/31 07:52:44 ssuominen Exp $
...
IUSE="a52 alsa dvb dvd esd ffmpeg flac lame mad mpeg mythtv ogg oss pulseaudio taglib theora v4l2 vorbis X xv"
