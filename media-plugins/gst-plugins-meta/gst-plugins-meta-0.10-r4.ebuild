...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-0.10-r4.ebuild,v 1.1 2010/02/02 13:56:21 dang Exp $
...
LICENSE="GPL-2"
SLOT="0.10"
KEYWORDS="~amd64 ~ppc ~ppc64 ~sh ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~x86-solaris"
