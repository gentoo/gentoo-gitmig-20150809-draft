...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/audacious-plugins/audacious-plugins-2.2_alpha2.ebuild,v 1.1 2009/10/04 21:50:34 chainsaw Exp $
...
IUSE="adplug alsa bs2b cdda esd flac ffmpeg gnome icecast ipv6 jack lirc mp3 mtp
nls oss projectm scrobbler sdl sid sndfile sse2 timidity tta vorbis wavpack"

RDEPEND="app-arch/unzip
	>=dev-libs/dbus-glib-0.60
	dev-libs/libxml2
	>=media-sound/audacious-2.2_alpha2
