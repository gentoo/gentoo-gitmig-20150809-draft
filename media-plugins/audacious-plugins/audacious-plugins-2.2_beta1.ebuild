...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/audacious-plugins/audacious-plugins-2.2_beta1.ebuild,v 1.1 2009/10/20 21:39:46 chainsaw Exp $
...
IUSE="aac adplug alsa bs2b cdda esd flac ffmpeg gnome icecast ipv6 jack lirc mp3
mtp nls oss projectm scrobbler sdl sid sndfile sse2 timidity tta vorbis wavpack"

RDEPEND="app-arch/unzip
	>=dev-libs/dbus-glib-0.60
	dev-libs/libxml2
	>=media-sound/audacious-2.2_beta1
