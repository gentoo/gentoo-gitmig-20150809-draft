...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-admin/vdr-admin-0.4.0.ebuild,v 1.5 2009/06/07 13:53:26 hd_brummy Exp $
...
pkg_postinst() {
	...
	elog "Find examples in /usr/share/doc/${PF}"
}
