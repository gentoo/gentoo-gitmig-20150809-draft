...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/kipi-plugins/kipi-plugins-1.2.0-r2.ebuild,v 1.1 2010/07/09 23:14:42 reavertm Exp $
...
PATCHES=( "${FILESDIR}/${P}-jpeg.patch.bz2" "${FILESDIR}/${P}-expoblending.patch" )
