...
# $Header: /var/cvsroot/gentoo-x86/net-voip/ekiga/ekiga-3.2.6.ebuild,v 1.4 2010/05/01 00:54:12 reavertm Exp $
...
RDEPEND=">=dev-libs/glib-2.8.0:2
	dev-libs/libsigc++:2
	dev-libs/libxml2:2
	>=net-libs/opal-3.6.6[audio,sip,video,debug=,h323?]
	>=net-libs/ptlib-2.6.5[stun,video,wav,debug=]
