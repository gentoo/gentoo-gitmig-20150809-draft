...
# $Header: /var/cvsroot/gentoo-x86/net-irc/xchat/xchat-1.8.9-r3.ebuild,v 1.8 2002/10/05 05:39:22 drobbins Exp $

IUSE="ssl nls mmx gnome ipv6 python kde x86 gtk perl"
