...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/openssl/openssl-0.9.7j.ebuild,v 1.11 2006/06/30 04:19:32 weeve Exp $
...
src_unpack() {
	...
	for a in $( grep -n -e "^\"linux-" Configure ); do
		...
		"s:-fomit-frame-pointer::" -e "s:-mcpu=[-a-z0-9]+::" -e "s:-m486::" -e
		"s:-mv8::")
