...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/openssl/openssl-0.9.7e.ebuild,v 1.3 2004/12/14 06:44:54 eradicator Exp $
...
src_compile() {
	...
	# force sparcv8 on sparc32 profile
		...
		./Configure linux-sparcv8 --prefix=/usr --openssldir=/etc/ssl \
			shared threads || die
	elif [ "$PROFILE_ARCH" = "sparc64-multilib" -a "${CHOST}" = "sparc64-unknown-linux-gnu" ]; then
