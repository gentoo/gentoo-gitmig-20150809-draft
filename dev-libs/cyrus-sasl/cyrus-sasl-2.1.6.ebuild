...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/cyrus-sasl/cyrus-sasl-2.1.6.ebuild,v 1.3 2002/08/14 11:52:27 murphy Exp $
...
src_unpack() {
	unpack ${A}
	cd ${WORKDIR}
	patch -p0 < ${FILESDIR}/cyrus-sasl-2.1.6-iovec.diff
}
