...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libisoburn/libisoburn-0.3.4_p0.ebuild,v 1.1 2009/03/01 21:06:00 loki_val Exp $
...
RDEPEND=">=dev-libs/libburn-0.6.2
	>=dev-libs/libisofs-0.6.14"
DEPEND="${RDEPEND}
	dev-util/pkgconfig"
