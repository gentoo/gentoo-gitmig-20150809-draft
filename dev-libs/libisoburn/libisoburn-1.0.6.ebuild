...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libisoburn/libisoburn-1.0.6.ebuild,v 1.1 2011/04/11 19:22:01 billie Exp $
...
RDEPEND=">=dev-libs/libburn-1.0.6
	>=dev-libs/libisofs-1.0.6
	acl? ( virtual/acl )
