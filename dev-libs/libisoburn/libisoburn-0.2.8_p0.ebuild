...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libisoburn/libisoburn-0.2.8_p0.ebuild,v 1.1 2008/10/19 12:18:58 loki_val Exp $
...
RDEPEND=">=dev-libs/libburn-0.5.4
	>=dev-libs/libisofs-0.6.10"
DEPEND="${RDEPEND}
	dev-util/pkgconfig"
