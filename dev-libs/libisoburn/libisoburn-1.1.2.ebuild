...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libisoburn/libisoburn-1.1.2.ebuild,v 1.1 2011/07/11 17:53:45 billie Exp $
...
RDEPEND=">=dev-libs/libburn-1.1.0
	>=dev-libs/libisofs-1.1.2
	acl? ( virtual/acl )
