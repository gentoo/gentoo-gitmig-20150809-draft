...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/uclibc/uclibc-0.9.26-r2.ebuild,v 1.8 2004/07/14 15:16:16 agriffis Exp $
...
IUSE="build hardened ipv6" # nls is not supported yet
