...
# $Header: /var/cvsroot/gentoo-x86/dev-perl/ExtUtils-MakeMaker/ExtUtils-MakeMaker-6.11.ebuild,v 1.2 2003/07/28 15:44:01 mcummings Exp $
...
src_compile() {
	perl Makefile.PL INSTALLDIRS=vendor ${myconf} DESTDIR=${D}/ || die
}
