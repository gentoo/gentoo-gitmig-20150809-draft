...
# $Header: /var/cvsroot/gentoo-x86/eclass/vim-plugin.eclass,v 1.2 2003/08/03 21:06:55 agriffis Exp $
#
...
update_vim_afterscripts() {
	...
	find /usr/share/vim/vimfiles/after -type d -name \*.vim.d | \
	while read d; do
	...
	find /usr/share/vim/vimfiles/after -type f -name \*.vim | \
	while read f; do
