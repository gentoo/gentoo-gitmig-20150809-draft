...
# $Header: /var/cvsroot/gentoo-x86/eclass/kde-dist.eclass,v 1.19 2002/09/07 20:46:11 danarmak Exp $
...
[ "$PV" == "3.1_alpha1" -o "$PV" == "3.1_beta1" -o "$PV" == "5" ] || ( myconf="$myconf --enable-final" && debug-print "added enable-final" )
