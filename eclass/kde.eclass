...
# $Header: /var/cvsroot/gentoo-x86/eclass/kde.eclass,v 1.17 2001/12/08 15:36:55 danarmak Exp $
...
kde_src_compile() {
	...
	case $1 in
		myconf)
			...
			myconf="--host=${CHOST} --with-x --enable-mitshm --with-xinerama --prefix=/usr --with-qt-dir=${QTDIR} --enable-final"
