...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/pam/pam-0.75-r1.ebuild,v 1.1 2001/08/16 04:23:03 chadh Exp $
...
src_install() {
 ...
 dodir /etc/pam.d
 cd ${FILESDIR}/pam.d
 /bin/install -D -m 644 `find . -type f -maxdepth 1` ${D}/etc/pam.d
}
