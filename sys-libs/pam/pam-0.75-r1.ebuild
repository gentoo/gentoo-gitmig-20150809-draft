...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/pam/pam-0.75-r1.ebuild,v 1.2 2001/08/22 21:06:57 drobbins Exp $
...
DEPEND=">=sys-libs/cracklib-2.7-r2 >=sys-libs/pwdb-0.61-r3 berkdb? ( ~sys-libs/db-1.85 )"
