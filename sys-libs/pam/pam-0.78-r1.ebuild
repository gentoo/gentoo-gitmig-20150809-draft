...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/pam/pam-0.78-r1.ebuild,v 1.6 2005/06/30 10:29:47 flameeyes Exp $
...
src_compile() {
	...
	if [[ ${ARCH} = "alpha" ]] ; then
		if [[ -n $(strings -a /usr/lib/libglib.a | grep -i 'Compaq Computer Corp.') ]] ; then
