...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/glibc-2.2.4.ebuild,v 1.3 2001/09/15 19:26:59 woodchip Exp $
...
DEPEND=">=sys-devel/gcc-2.95.3-r2 ~sys-kernel/linux-headers-2.4.6 nls? ( sys-devel/gettext ) gd? ( media-libs/libgd )"
