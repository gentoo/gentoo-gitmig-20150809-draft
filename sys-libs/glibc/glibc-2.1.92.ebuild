...
SRC_URI="ftp://sourceware.cygnus.com/pub/glibc/releases/glibc-2.1.92.tar.bz2
	 ftp://sourceware.cygnus.com/pub/glibc/releases/glibc-linuxthreads-2.1.92.tar.gz"
...
src_unpack() {
    unpack glibc-2.1.92.tar.bz2
    cd ${S}
    unpack glibc-linuxthreads-2.1.92.tar.gz
