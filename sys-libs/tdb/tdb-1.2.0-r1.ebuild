...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/tdb/tdb-1.2.0-r1.ebuild,v 1.1 2010/01/11 20:43:02 flameeyes Exp $
...
src_install() {
	...
	dolib.a sharedbuild/lib/libtdb.a || die
	# you need to install all the files, not just the .so one
	dolib.so sharedbuild/lib/libtdb.so* || die
