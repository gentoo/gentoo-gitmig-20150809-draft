...
# $Header: /var/cvsroot/gentoo-x86/net-www/gnash/gnash-0.7_alpha20060331-r1.ebuild,v 1.1 2006/04/03 23:10:56 genstef Exp $

inherit cvs nsplugins kde-functions
...
src_compile() {
	...
	sed -i s:/usr/local/bin/gnash:/usr/bin/gnash: plugin/plugin.cpp
