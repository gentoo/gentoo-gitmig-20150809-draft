...
# $Header: /var/cvsroot/gentoo-x86/net-www/galeon/galeon-0.12.6.ebuild,v 1.2 2001/11/05 01:58:12 azarah Exp $
...
# Added imlib to DEPEND, since older versions caused galeon build to break
DEPEND=">=dev-libs/libxml-1.8.16
        >=dev-util/intltool-0.11
	>=media-libs/imlib-1.9.11
