...
# $Header: /var/cvsroot/gentoo-x86/net-www/galeon/galeon-1.3.15-r1.ebuild,v 1.2 2004/06/25 00:52:50 agriffis Exp $
...
src_unpack() {
	unpack ${A}
	epatch ${FILESDIR}/galeon-1.3.15-gcc34.gz
	epatch ${FILESDIR}/${P}-mozilla17-support.patch.gz
}
