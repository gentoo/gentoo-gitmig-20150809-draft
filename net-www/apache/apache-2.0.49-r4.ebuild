...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-2.0.49-r4.ebuild,v 1.11 2004/07/08 16:22:26 zul Exp $
...
DEPEND="dev-util/yacc
	...
	selinux? (sec-policy/seelinux-apache)"
...
src_unpack() {
	...
	unpack ${A} || die
	cd ${S} || die
	epatch ${WORKDIR}/00_gentoo_apache_dos.patch || die
