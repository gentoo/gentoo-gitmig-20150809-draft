...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-2.0.50-r1.ebuild,v 1.2 2004/09/08 14:08:05 gustavoz Exp $
...
LICENSE="Apache-2.0"
SLOT="2"
KEYWORDS="~x86 ~ppc sparc ~mips ~alpha ~arm ~hppa ~ppc64"
...
src_unpack() {
	...
	epatch ${FILESDIR}/patches/${PVR}/*.patch || die
