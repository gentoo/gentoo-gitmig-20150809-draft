...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-2.0.54-r2.ebuild,v 1.4 2005/05/12 15:46:22 mholzer Exp $
...
SRC_URI="mirror://apache/httpd/httpd-${PV}.tar.bz2
	http://dev.gentoo.org/~beu/dist/apache-patches/apache-patches-${PVR}.tar.bz2
	http://dev.gentoo.org/~beu/dist/apache-patches/apache-conf-${PVR}.tar.bz2"
...
APACHE_PATCHDIR=${WORKDIR}/apache-patches-${PVR}
APACHE_CONFDIR=${WORKDIR}/apache-conf-${PVR}
