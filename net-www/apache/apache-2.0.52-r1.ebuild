...
# $Header: /var/cvsroot/gentoo-x86/net-www/apache/apache-2.0.52-r1.ebuild,v 1.2 2004/11/05 17:21:12 gustavoz Exp $
...
src_unpack() {
	...
	# which muppet decided that epatch would default to applying compressed
	# patches?
