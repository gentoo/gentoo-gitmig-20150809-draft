...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla/mozilla-1.4.1.ebuild,v 1.5 2004/01/30 08:13:43 mr_bones_ Exp $
...
SRC_URI="ftp://ftp.mozilla.org/pub/mozilla.org/mozilla/releases/${PN}${MY_PV2}/src/${PN}-${MY_PV2}.tar.bz2
