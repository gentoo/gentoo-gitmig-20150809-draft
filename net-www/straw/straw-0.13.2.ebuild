...
# $Header: /var/cvsroot/gentoo-x86/net-www/straw/straw-0.13.2.ebuild,v 1.2 2003/02/13 15:44:21 vapier Exp $
...
src_unpack() {
	...
	# fix Makefile image creation problem
	epatch ${FILESDIR}/${P}-Makefile-dir.patch
}
