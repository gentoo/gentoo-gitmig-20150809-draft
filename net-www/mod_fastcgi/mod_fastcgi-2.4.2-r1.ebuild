...
# $Header: /var/cvsroot/gentoo-x86/net-www/mod_fastcgi/mod_fastcgi-2.4.2-r1.ebuild,v 1.1 2005/01/30 08:13:09 hollow Exp $
...
APACHE1_MOD_FILE="${S}/${PN}.so"
APACHE2_MOD_FILE="${S}/${PN}.so"
