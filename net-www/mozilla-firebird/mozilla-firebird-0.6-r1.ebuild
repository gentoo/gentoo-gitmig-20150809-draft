...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla-firebird/mozilla-firebird-0.6-r1.ebuild,v 1.1 2003/06/03 06:51:48 brad Exp $
...
src_install() {
   ...
   src_mv_plugins /usr/lib/${PN}/plugins
...
pkg_preinst() {
   ...
   pkg_mv_plugins /usr/lib/${PN}/plugins
}
