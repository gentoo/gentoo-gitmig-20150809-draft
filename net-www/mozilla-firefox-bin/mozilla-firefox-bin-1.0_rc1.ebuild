...
# $Header: /var/cvsroot/gentoo-x86/net-www/mozilla-firefox-bin/mozilla-firefox-bin-1.0_rc1.ebuild,v 1.1 2004/10/29 05:59:57 brad Exp $
...
SRC_URI="http://ftp.mozilla.org/pub/mozilla.org/firefox/releases/${MY_PV}/firefox-${MY_PV}.en-US.linux-i686.tar.gz"
