...
# $Header: /var/cvsroot/gentoo-x86/net-www/epiphany/epiphany-1.2.6-r1.ebuild,v 1.1 2004/08/17 16:39:09 stuart Exp $
...
src_unpack () {
	unpack ${A}
	cd ${S}
	epatch ${FILESDIR}/epiphany-1.2.6-moz-1.7.2.patch
}
