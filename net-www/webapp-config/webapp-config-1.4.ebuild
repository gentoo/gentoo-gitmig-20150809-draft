...
# $Header: /var/cvsroot/gentoo-x86/net-www/webapp-config/webapp-config-1.4.ebuild,v 1.1 2004/04/23 21:59:51 stuart Exp $

DESCRIPTION="Gentoo's installer for web-based applications"
HOMEPAGE="http://www.gentoo.org/"
SRC_URI="mirror://gentoo/webapp-config/${P}.tar.bz2"
LICENSE="GPL-2"
SLOT=0
