...
# $Header: /var/cvsroot/gentoo-x86/net-www/tinyproxy/tinyproxy-1.6.1.ebuild,v 1.1 2003/09/06 04:39:49 vapier Exp $
...
src_install() {
	sed -i 's:mkdir $(datadir)/tinyproxy:mkdir -p $(DESTDIR)$(datadir)/tinyproxy:' Makefile
