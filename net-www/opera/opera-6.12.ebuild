...
# $Header: /var/cvsroot/gentoo-x86/net-www/opera/opera-6.12.ebuild,v 1.5 2004/01/11 13:48:42 lanius Exp $
#
...
NV=6.12-20030305.${OPERA_VERSION}.i386
SRC_URI="http://www.panix.com/opera/files/linux/612/final/en/i386/${URL_DIR}/opera-${NV}.tar.gz"
S=${WORKDIR}/opera-${NV}
