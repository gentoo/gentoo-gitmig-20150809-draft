...
# $Header: /var/cvsroot/gentoo-x86/net-www/opera/opera-7.22.ebuild,v 1.2 2003/11/20 13:08:19 lanius Exp $
...
RDEPEND="virtual/x11
	...
	media-libs/libexif
	|| ( x11-libs/lesstif =x11-libs/openmotif-2.1* )"

KEYWORDS="x86 ppc sparc"
SLOT="0"

OPERAVER="7.22-20031103"
OPERATYPE="1-static-qt"

SRC_URI="x86? ( ftp://ftp.opera.com/pub/opera/linux/722/final/en/i386/static/${PN}-${OPERAVER}.${OPERATYPE}.i386-en.tar.bz2 )
	ppc? ( ftp://ftp.opera.com/pub/opera/linux/722/final/en/ppc/static/${PN}-${OPERAVER}.${OPERATYPE}.ppc-en.tar.bz2 )
	sparc? ( ftp://ftp.opera.com/pub/opera/linux/722/final/en/sparc/static/${PN}-${OPERAVER}.${OPERATYPE}.sparc-en.tar.bz2 )"
