...
# $Header: /var/cvsroot/gentoo-x86/net-www/ochusha/ochusha-0.4.9.1.ebuild,v 1.1 2004/01/12 17:05:07 usata Exp $

IUSE=""

DESCRIPTION="Ochusha - 2ch viewer for GTK+"
HOMEPAGE="http://ochusha.sourceforge.jp/"
SRC_URI="mirror://sourceforge.jp/${PN}/7558/${P}.tar.bz2
