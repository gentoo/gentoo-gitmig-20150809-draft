...
# $Header: /var/cvsroot/gentoo-x86/net-www/ochusha/ochusha-0.4.10.ebuild,v 1.1 2004/01/21 17:26:43 usata Exp $

IUSE=""

DESCRIPTION="Ochusha - 2ch viewer for GTK+"
HOMEPAGE="http://ochusha.sourceforge.jp/"
SRC_URI="mirror://sourceforge.jp/${PN}/7769/${P}.tar.bz2
