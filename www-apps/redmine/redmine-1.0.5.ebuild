...
# $Header: /var/cvsroot/gentoo-x86/www-apps/redmine/redmine-1.0.5.ebuild,v 1.1 2010/12/25 02:53:46 matsuu Exp $
...
all_ruby_prepare() {
	...
	echo "CONFIG_PROTECT_MASK=\"${REDMINE_DIR}/config/locales\"" >> "${T}/50${PN}"
}
