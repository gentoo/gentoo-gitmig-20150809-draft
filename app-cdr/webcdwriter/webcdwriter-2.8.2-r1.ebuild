...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/webcdwriter/webcdwriter-2.8.2-r1.ebuild,v 1.1 2011/09/08 11:59:40 fordfrog Exp $
...
src_compile() {
	...
	local java_conf="$(java-pkg_javac-args) -classpath $(java-pkg_getjars netx)"
