...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/k9copy/k9copy-1.2.2.ebuild,v 1.3 2008/01/09 15:13:33 keytoaster Exp $
...
PATCHES="${FILESDIR}/k9copy-1.2.2-desktop-entry.diff"
