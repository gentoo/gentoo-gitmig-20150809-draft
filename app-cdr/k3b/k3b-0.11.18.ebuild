...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/k3b/k3b-0.11.18.ebuild,v 1.2 2005/01/01 12:15:05 eradicator Exp $
...
src_unpack() {
	kde_src_unpack
	epatch ${FILESDIR}/${P/8/7}-noarts.patch || die "patch failed"
}
