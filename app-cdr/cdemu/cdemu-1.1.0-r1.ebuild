...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdemu/cdemu-1.1.0-r1.ebuild,v 1.1 2009/03/12 07:49:14 dev-zero Exp $
...
pkg_postinst() {
	python_version
	python_mod_optimize /usr/$(get_libdir)/${PYVER}/site-packages/cdemu
	python_need_rebuild
}
