...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/brasero/brasero-2.30.3.ebuild,v 1.3 2011/01/19 21:33:10 hwoarang Exp $
...
src_prepare() {
	gnome2_src_prepare
	# Fix tests, bgo#622394
	echo libbrasero-burn/brasero-data-session.c >> po/POTFILES.in
}
