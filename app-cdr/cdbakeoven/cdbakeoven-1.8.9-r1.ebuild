...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdbakeoven/cdbakeoven-1.8.9-r1.ebuild,v 1.1 2002/09/03 00:04:26 mkennedy Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	patch -p0 <${FILESDIR}/cdbakeoven-1.8.9-gcc3-gentoo.patch
}
