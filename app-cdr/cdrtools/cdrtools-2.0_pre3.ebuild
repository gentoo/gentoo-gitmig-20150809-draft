...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools/cdrtools-2.0_pre3.ebuild,v 1.3 2002/12/25 23:14:32 mholzer Exp $
...
#MY_P=${PN}-${PV%.*}a${PV##*.}
MY_P=${P/_/}
SRC_URI="ftp://ftp.berlios.de/pub/cdrecord/alpha/OLD/2.0aX/${MY_P}.tar.bz2"
S=${WORKDIR}/${PN}-2.0
