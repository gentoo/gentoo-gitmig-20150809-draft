...
# $Header: /var/cvsroot/gentoo-x86/app-cdr/cdrtools/cdrtools-2.0_pre3.ebuild,v 1.2 2002/12/18 01:44:01 mkeadle Exp $
...
#MY_P=${PN}-${PV%.*}a${PV##*.}
MY_P=${P/_/}
SRC_URI="ftp://ftp.berlios.de/pub/cdrecord/alpha/${MY_P}.tar.bz2"
#S=${WORKDIR}/${PN}-1.11
S=${WORKDIR}/${PN}-2.0
