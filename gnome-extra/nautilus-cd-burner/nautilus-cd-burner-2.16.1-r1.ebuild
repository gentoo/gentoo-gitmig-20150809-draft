...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/nautilus-cd-burner/nautilus-cd-burner-2.16.1-r1.ebuild,v 1.1 2006/10/30 19:31:44 allanonjl Exp $
...
src_unpack() {
	...
	# fix for #152798
	epatch "${FILESDIR}"/${P}-make_iso_c.patch
}
