...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/sensors-applet/sensors-applet-1.7.2.ebuild,v 1.1 2006/07/06 03:45:43 dang Exp $
...
pkg_setup() {
	G2CONF="$(use_with nvidia) $(use_with lm_sensors libsensors) $(use_enable libnotify)"
}
