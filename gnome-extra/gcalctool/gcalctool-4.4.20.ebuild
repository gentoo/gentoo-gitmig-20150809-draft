...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gcalctool/gcalctool-4.4.20.ebuild,v 1.3 2004/12/15 13:09:00 gustavoz Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/${P}-remove_disable_deprecated.patch
