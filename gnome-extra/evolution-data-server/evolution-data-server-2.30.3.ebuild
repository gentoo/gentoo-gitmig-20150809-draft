...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/evolution-data-server/evolution-data-server-2.30.3.ebuild,v 1.9 2011/03/23 10:22:24 nirbheek Exp $
...
RDEPEND=">=dev-libs/glib-2.16.1:2
	>=x11-libs/gtk+-2.18:2
