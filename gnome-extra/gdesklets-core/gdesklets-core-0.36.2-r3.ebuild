...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gdesklets-core/gdesklets-core-0.36.2-r3.ebuild,v 1.2 2010/07/31 17:26:37 phajdan.jr Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-getid-fix.patch"
	epatch "${FILESDIR}/${P}-ConfigWidget-dupe-fix.patch"
	gnome2_src_prepare
...
src_install() {
	...
	doins "contrib/gdesklets.desktop"
