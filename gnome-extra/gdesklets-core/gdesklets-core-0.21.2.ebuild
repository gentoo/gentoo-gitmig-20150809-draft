...
# $Header: /var/cvsroot/gentoo-x86/gnome-extra/gdesklets-core/gdesklets-core-0.21.2.ebuild,v 1.4 2003/09/24 19:50:51 todd Exp $
...
src_unpack( ) {
	...
	unpack ${A}
	cd ${S}
	# patch to prevent building the FontSelector (it's broken)
	# sensor included here, because we'll use the one
	# from x11-plugins/
	sed -i -e "/SUBDIRS/s/FontSelector//" Sensors/Makefile.in
