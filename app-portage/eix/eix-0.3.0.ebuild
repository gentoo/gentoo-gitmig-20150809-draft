...
# $Header: /var/cvsroot/gentoo-x86/app-portage/eix/eix-0.3.0.ebuild,v 1.1 2005/08/27 22:32:26 hollow Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/0.3.0-if-else-fi.patch || die "epatch failed"
}
