...
# $Header: /var/cvsroot/gentoo-x86/app-portage/eix/eix-0.22.7.ebuild,v 1.2 2011/02/16 19:16:06 darkside Exp $
...
src_install() {
	default_src_install
	use doc && cd -- "${ED}" && docompress -x "usr/share/doc/${PF}/"*.html
}
