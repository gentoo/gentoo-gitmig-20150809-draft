...
# $Header: /var/cvsroot/gentoo-x86/app-portage/basc/basc-1.5.6.ebuild,v 1.1 2005/01/12 17:43:23 pvdabeel Exp $
...
src_install() {
	...
	chown -R root:stats ${D}/etc/basc
	chmod -R ug+rw ${D}/etc/basc
