...
# $Header: /var/cvsroot/gentoo-x86/app-portage/elogviewer/elogviewer-0.5.1-r2.ebuild,v 1.4 2007/09/16 16:00:49 angelos Exp $
...
src_unpack() {
	unpack ${A}
	cd "${WORKDIR}"
	epatch "${FILESDIR}/${P}-filename-read.patch"
}
