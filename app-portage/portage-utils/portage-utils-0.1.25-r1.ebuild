...
# $Header: /var/cvsroot/gentoo-x86/app-portage/portage-utils/portage-utils-0.1.25-r1.ebuild,v 1.1 2007/04/10 00:29:46 solar Exp $
...
src_unpack() {
	unpack "${A}"
	cd "${S}" || die
	epatch "${FILESDIR}"/fix-bug-168442.patch
}
