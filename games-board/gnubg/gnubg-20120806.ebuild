...
# $Header: /var/cvsroot/gentoo-x86/games-board/gnubg/gnubg-20120806.ebuild,v 1.3 2012/11/15 10:28:48 blueness Exp $
...
src_install() {
	...
	dosym /usr/share/fonts/ttf-bitstream-vera "${GAMES_DATADIR}"/${PN}/fonts/ttf-bitstream-vera
