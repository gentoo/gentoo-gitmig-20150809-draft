...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/xfce4-extras/xfce4-extras-4.1.99.3-r1.ebuild,v 1.5 2005/01/10 18:15:41 bcowan Exp $

DESCRIPTION="Xfce 4 extras ebuild"
LICENSE="GPL-2 BSD LGPL-2"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~sparc ~x86"

XRDEPEND=">=xfce-base/xfce4-${PV}-r1
