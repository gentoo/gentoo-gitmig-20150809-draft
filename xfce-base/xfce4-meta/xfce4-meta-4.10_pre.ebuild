...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/xfce4-meta/xfce4-meta-4.10_pre.ebuild,v 1.1 2012/04/07 19:44:12 ssuominen Exp $
...
RDEPEND="x11-themes/gtk-engines-xfce:0
	>=xfce-base/xfce4-panel-4.9
	>=xfce-base/xfwm4-4.9
	>=xfce-base/xfce4-appfinder-4.9
	>=xfce-base/xfdesktop-4.9
	>=xfce-base/xfce4-settings-4.9
	x11-themes/hicolor-icon-theme
	!minimal? ( media-fonts/dejavu
		virtual/freedesktop-icon-theme )
	session? ( >=xfce-base/xfce4-session-4.9 )
