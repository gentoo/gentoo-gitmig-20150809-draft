...
# $Header: /var/cvsroot/gentoo-x86/xfce-base/xfce4-session/xfce4-session-4.8.3-r1.ebuild,v 1.1 2012/02/24 11:41:33 ssuominen Exp $
...
pkg_setup() {
	PATCHES=( "${FILESDIR}"/${P}-respect-save-settings-logout-plugin.patch )
