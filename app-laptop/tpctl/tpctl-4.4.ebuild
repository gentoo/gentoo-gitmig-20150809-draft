...
# $Header: /var/cvsroot/gentoo-x86/app-laptop/tpctl/tpctl-4.4.ebuild,v 1.2 2004/06/24 22:00:48 agriffis Exp $
...
DEPEND="$DEPEND >=app-laptop/thinkpad-4.3 ncurses? ( sys-libs/ncurses )"
RDEPEND="$RDEPEND >=app-laptop/thinkpad-4.3 ncurses? ( sys-libs/ncurses ) perl? ( dev-lang/perl )"
