...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/win4lin/win4lin-4.0.22.ebuild,v 1.1 2003/06/03 22:29:28 bass Exp $
...
src_install() {
	...
	cp ${FILESDIR}/win4lin.initd ${D}/opt/win4lin/win4lin.initd
