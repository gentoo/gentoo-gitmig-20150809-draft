...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/emul-linux-x86-java/emul-linux-x86-java-1.6.0.01.ebuild,v 1.1 2007/06/02 16:59:30 betelgeuse Exp $
...
At="jdk-${MY_PV}-dlj-linux-i586.sh"
