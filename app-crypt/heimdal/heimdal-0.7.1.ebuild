...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/heimdal/heimdal-0.7.1.ebuild,v 1.1 2005/09/15 21:16:29 stefaan Exp $

inherit libtool eutils virtualx toolchain-funcs

PATCHVER=0.2
PATCH_P=${PN}-0.7-gentoo-patches-${PATCHVER}
...
src_unpack() {
	...
	EPATCH_SUFFIX="patch" EPATCH_EXCLUDE="011_all_heimdal-kdc_fix.patch" \
