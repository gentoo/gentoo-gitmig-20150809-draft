...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/mit-krb5/mit-krb5-1.3.5-r1.ebuild,v 1.2 2005/01/01 12:35:15 eradicator Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-1.3.4-tempfile.patch.bz2
}
