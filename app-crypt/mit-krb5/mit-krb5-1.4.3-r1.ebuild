...
# $Header: /var/cvsroot/gentoo-x86/app-crypt/mit-krb5/mit-krb5-1.4.3-r1.ebuild,v 1.10 2006/06/25 11:35:21 dertobi123 Exp $
...
src_install() {
	...
	newins ${FILESDIR}/kdc.conf kdc.conf.example
}
