...
# $Header: /var/cvsroot/gentoo-x86/kde-apps/kdenetwork/kdenetwork-2.0.ebuild,v 1.2 2000/11/07 10:21:03 achim Exp $

A=${P}.tar.bz2
S=${WORKDIR}/${P}
DESCRIPTION="KDE 2.0 - Network"
