...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/zentest/zentest-4.4.2.ebuild,v 1.2 2010/12/27 21:06:08 grobian Exp $
...
KEYWORDS="~alpha ~amd64 ~hppa ~ia64 ~ppc ~ppc64 ~sparc ~x86 ~amd64-linux ~ia64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~x64-solaris ~x86-solaris"
SLOT="0"
IUSE=""
