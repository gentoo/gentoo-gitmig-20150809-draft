...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/ruby-activeldap/ruby-activeldap-1.2.1-r2.ebuild,v 1.1 2010/05/23 19:57:47 graaff Exp $
...
all_ruby_prepare() {
	...
	sed -i -e "s/= 2.3.5/~>2.3.5/" lib/active_ldap.rb || die
}
