...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/gherkin/gherkin-2.3.6.ebuild,v 1.1 2011/04/20 05:27:07 graaff Exp $
...
LICENSE="MIT"
SRC_URI="https://github.com/aslakhellesoy/gherkin/tarball/v${PV} -> ${P}.tgz"
...
S="${WORKDIR}/aslakhellesoy-gherkin-*"

ruby_add_bdepend "
	dev-ruby/rake-compiler
	test? (
		>=dev-ruby/awesome_print-0.3
