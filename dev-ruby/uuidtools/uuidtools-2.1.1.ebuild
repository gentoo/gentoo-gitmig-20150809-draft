...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/uuidtools/uuidtools-2.1.1.ebuild,v 1.1 2009/10/14 13:00:32 flameeyes Exp $
...
src_test() {
	for ruby in $USE_RUBY; do
		...
		$ruby $(type -p rake) spec:normal || die "testsuite failed ($ruby)"
	done
}
