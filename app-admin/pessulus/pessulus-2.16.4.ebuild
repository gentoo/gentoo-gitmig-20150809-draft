...
# $Header: /var/cvsroot/gentoo-x86/app-admin/pessulus/pessulus-2.16.4.ebuild,v 1.5 2008/04/19 15:20:05 corsair Exp $
...
pkg_postrm() {
	python_version
	python_mod_cleanup /usr/$(get_libdir)/python${PYVER}/site-packages/Pessulus
}
