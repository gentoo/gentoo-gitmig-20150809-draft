...
# $Header: /var/cvsroot/gentoo-x86/app-admin/webapp-config/webapp-config-1.50.7.ebuild,v 1.5 2006/01/12 21:18:32 corsair Exp $
...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~alpha ~hppa ~ppc64 ~sparc ~x86"
IUSE=""
S=${WORKDIR}/${PF}
