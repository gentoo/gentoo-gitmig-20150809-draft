...
# $Header: /var/cvsroot/gentoo-x86/app-admin/gentoolkit/gentoolkit-0.1.17-r6.ebuild,v 1.1 2003/01/03 20:51:49 mholzer Exp $
...
pkg_postinst() {
	...
	ewarn "emerge-webrsync -v displays the wget status"
}
