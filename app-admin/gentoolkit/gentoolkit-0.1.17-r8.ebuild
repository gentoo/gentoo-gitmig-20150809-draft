...
# $Header: /var/cvsroot/gentoo-x86/app-admin/gentoolkit/gentoolkit-0.1.17-r8.ebuild,v 1.1 2003/01/07 16:46:38 mholzer Exp $
...
pkg_postinst() {
	...
	einfo ""
	einfo "if you use mkebuild, please remove ~/.mkebuild to update your settings"
