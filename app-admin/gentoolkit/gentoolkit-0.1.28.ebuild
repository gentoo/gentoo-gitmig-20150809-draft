...
# $Header: /var/cvsroot/gentoo-x86/app-admin/gentoolkit/gentoolkit-0.1.28.ebuild,v 1.3 2003/07/01 16:38:39 mholzer Exp $
...
src_install() {
	...
	dobin ${FILESDIR}/scripts/revdep-rebuild-1
