...
# $Header: /var/cvsroot/gentoo-x86/app-admin/fam-oss/fam-oss-2.6.10.ebuild,v 1.2 2003/06/25 17:30:54 darkspecter Exp $
...
# Now in dnotify patch.  Should fix the sigqueue overflow problems
#	cd ${S}/fam
