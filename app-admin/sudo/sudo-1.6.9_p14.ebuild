...
# $Header: /var/cvsroot/gentoo-x86/app-admin/sudo/sudo-1.6.9_p14.ebuild,v 1.2 2008/03/08 22:48:08 dirtyepic Exp $
...
LICENSE="Sudo"
SLOT="0"
KEYWORDS="~alpha ~arm ~hppa ~ia64 ~m68k ~ppc ~ppc64 ~s390 ~sh ~sparc ~sparc-fbsd ~x86 ~x86-fbsd"
