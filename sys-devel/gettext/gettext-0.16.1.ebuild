...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gettext/gettext-0.16.1.ebuild,v 1.14 2007/08/04 16:03:00 grobian Exp $
...
src_install() {
	...
	if use !elibc_glibc ; then
		...
		dodir /$(get_libdir)
		mv "${D}"/usr/$(get_libdir)/libintl*$(get_libname)* "${D}"/$(get_libdir)/
