...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/spython/spython-2.0-r9.ebuild,v 1.4 2002/07/11 06:30:56 drobbins Exp $
...
DEPEND=">=sys-devel/autoconf-2.13 >=sys-libs/zlib-1.1.4 readline? ( >=sys-libs/readline-4.1 >=sys-libs/ncurses-5.2 )"
