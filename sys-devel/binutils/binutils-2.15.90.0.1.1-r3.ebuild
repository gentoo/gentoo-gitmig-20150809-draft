...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/binutils-2.15.90.0.1.1-r3.ebuild,v 1.18 2004/11/07 09:14:33 mr_bones_ Exp $
...
SRC_URI="mirror://kernel/linux/devel/binutils/${P}.tar.bz2
	...
	http://dev.gentoo.org/~lv/${PN}-2.15.90.0.1-patches-${PATCHVER}.tar.bz2"
