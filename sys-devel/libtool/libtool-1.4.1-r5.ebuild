...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/libtool/libtool-1.4.1-r5.ebuild,v 1.1 2002/04/07 21:36:56 azarah Exp $
...
src_install() { 
	...
	patch -p0 <${FILESDIR}/${PV}/${P}-portage.patch-v2 || die
}
