...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/libtool/libtool-1.4.1-r7.ebuild,v 1.1 2002/05/26 17:59:59 azarah Exp $
...
src_install() { 
	...
	patch -p0 <${FILESDIR}/${PV}/${P}-portage.patch-v4 || die
}
