...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/autoconf/autoconf-2.59-r4.ebuild,v 1.6 2004/07/15 03:07:10 agriffis Exp $
...
src_install() {
	...
	# to use.
	exeinto /usr/lib/${PN}
	newexe ${FILESDIR}/ac-wrapper-4.pl ac-wrapper.pl
