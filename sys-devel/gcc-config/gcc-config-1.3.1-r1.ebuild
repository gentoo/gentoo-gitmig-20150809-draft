...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc-config/gcc-config-1.3.1-r1.ebuild,v 1.1 2003/04/06 22:18:42 zwelch Exp $
...
src_install() {
	...
	${CC:-gcc} -O2 -Wall -o ${WORKDIR}/wrapper ${FILESDIR}/wrapper.c
