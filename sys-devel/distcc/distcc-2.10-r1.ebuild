...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/distcc/distcc-2.10-r1.ebuild,v 1.1 2003/08/13 22:13:59 lisa Exp $
...
pkg_postinst() {
	...
	echo ""
	einfo "As of this release (2.10), you can specify where you want state"
	einfo "files to go (these are for monitoring).  You can specify this setting"
	einfo "in /etc/make.conf by setting DISTCC_DIR to somewhere portage can write to"
	einfo "such as /tmp, also, change it in /etc/conf.d/distccd."
	echo ""
