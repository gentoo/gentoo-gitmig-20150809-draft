...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/gcc-4.4.3.ebuild,v 1.4 2010/04/24 18:19:00 halcy0n Exp $
...
pkg_setup() {
	...
	if use graphite ; then
		...
		ewarn "Any bugs resulting in the use of Graphite will not be fixed"
	fi
}
