...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc/gcc-3.3.3_pre20040408-r1.ebuild,v 1.7 2004/07/02 09:32:03 eradicator Exp $
...
src_unpack() {
	...
	then
		# Make gcc's version info specific to Gentoo
	 	version_patch ${FILESDIR}/3.3.3/gcc333_pre${SNAPSHOT//-}-gentoo-branding.patch \
...
pkg_postinst() {
	...
	ewarn "This version of gcc may miscompile certain type-punned "
	ewarn "expressions. Expect problems if you ignore this warning"
	ewarn
	ewarn
	ewarn
}
