...
# $Header: /var/cvsroot/gentoo-x86/dev-util/subversion/subversion-1.1.4-r1.ebuild,v 1.4 2005/04/11 11:17:33 seemant Exp $
...
IUSE="ssl apache2 berkdb python emacs perl java nls webdav"
RESTRICT="maketest"
...
pkg_setup() {
	...
	if ! use webdav; then
		...
		ewarn "ability to decide whether you want the \`svn\` client to"
