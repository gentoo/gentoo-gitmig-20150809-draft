...
# $Header: /var/cvsroot/gentoo-x86/dev-util/subversion/subversion-0.9_pre1.ebuild,v 1.3 2002/07/11 06:30:25 drobbins Exp $
...
SRC_URI="http://www.sleepycat.com/update/4.0.14/db-4.0.14.tar.gz
	...
	http://www.gbevin.com/gentoo/apr-subversion-200202081402.tar.bz2
	http://www.gbevin.com/gentoo/apr-util-subversion-200202081402.tar.bz2
	http://www.gbevin.com/gentoo/httpd-subversion-200202081616.tar.bz2
	http://www.gbevin.com/gentoo/svn-200202081440.tar.bz2"
...
src_bootstrap() {
	...
	unpack ${DISTDIR}/subversion-r909.tar.gz
...
src_install () {
	...
	do
		mv ${x} ${x}_orig
		sed -e "s#/var/tmp/portage/subversion-0.9_pre1/work/tmpinstall_svn#/usr/svn#g" \
			-e "s#/var/tmp/portage/subversion-0.9_pre1/work/tmpinstall_httpd#/usr/svn#g" \
			-e "s#/var/tmp/portage/subversion-0.9_pre1/work/tmpinstall_db-4.0.14#/usr/svn#g" \
			${x}_orig > ${x}
			rm ${x}_orig
	done
