...
# $Header: /var/cvsroot/gentoo-x86/dev-util/subversion/subversion-0.21.0.ebuild,v 1.3 2003/04/26 20:04:20 pauldv Exp $
...
pkg_setup() {
	if use apache2; then
		...
		einfo "case."
		ewarn ""
		ewarn "Currently this is broken, and will be fixed soon"
		die "Sorry compiling without apache2 is broken atm"
	fi
}
...
EOF
	...
	LDFLAGS="-L${S}/subversion/libsvn_client/.libs \
        -L${S}/subversion/apr/.libs \
        -L${S}/subversion/apr-util/.libs \
