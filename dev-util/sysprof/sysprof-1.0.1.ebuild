...
# $Header: /var/cvsroot/gentoo-x86/dev-util/sysprof/sysprof-1.0.1.ebuild,v 1.1 2006/01/14 00:21:02 vapier Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}"/${P}-INTERVAL_should_not_be_zero.patch
}
