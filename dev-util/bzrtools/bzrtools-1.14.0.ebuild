...
# $Header: /var/cvsroot/gentoo-x86/dev-util/bzrtools/bzrtools-1.14.0.ebuild,v 1.1 2009/04/11 16:07:42 pva Exp $
...
SRC_URI="http://launchpad.net/bzrtools/stable/${PV/.0}/+download/${P}.tar.gz"
