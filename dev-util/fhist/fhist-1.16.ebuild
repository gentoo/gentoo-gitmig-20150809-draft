...
# $Header: /var/cvsroot/gentoo-x86/dev-util/fhist/fhist-1.16.ebuild,v 1.5 2011/06/12 20:04:44 mattst88 Exp $
...
src_install () {
	emake -j1 RPM_BUILD_ROOT="${D}" NLSDIR="${D}/usr/share/locale" \
