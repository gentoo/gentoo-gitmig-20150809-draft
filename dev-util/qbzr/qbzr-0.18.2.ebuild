...
# $Header: /var/cvsroot/gentoo-x86/dev-util/qbzr/qbzr-0.18.2.ebuild,v 1.1 2010/03/02 15:50:37 fauli Exp $
...
SRC_URI="http://launchpad.net/qbzr/${PV%%.2}/${PV}/+download/${PN}-${PV}.tar.gz"
