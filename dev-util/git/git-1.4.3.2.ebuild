...
# $Header: /var/cvsroot/gentoo-x86/dev-util/git/git-1.4.3.2.ebuild,v 1.1 2006/10/24 07:48:39 ferdy Exp $
...
pkg_postinst() {
	...
	einfo "git-svnimport command. You should install dev-util/subversion "
	einfo "(with USE=perl) before."
	einfo
	einfo "If you want to manage subversion repositories using git, consider"
	einfo "using git-svn. You should install dev-util/subversion (preferably "
	einfo "with USE=perl) and dev-perl/libwww-perl."
	einfo
