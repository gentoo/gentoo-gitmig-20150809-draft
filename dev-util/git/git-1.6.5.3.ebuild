...
# $Header: /var/cvsroot/gentoo-x86/dev-util/git/git-1.6.5.3.ebuild,v 1.4 2009/11/17 23:04:04 robbat2 Exp $
...
if [ "$PV" != "9999" ]; then
	...
	KEYWORDS="~amd64 ~arm ~hppa ~mips ~ppc ~s390 ~sh ~sparc ~x86 ~sparc-fbsd ~x86-fbsd"
else
	SRC_URI=""
	EGIT_BRANCH="master"
