...
# $Header: /var/cvsroot/gentoo-x86/dev-util/global/global-5.8.ebuild,v 1.1 2010/02/20 20:13:32 arfrever Exp $
...
SRC_URI="ftp://ftp.gnu.org/pub/gnu/${PN}/${P}.tar.gz http://tamacom.com/${PN}/${P}.tar.gz"
LICENSE="GPL-3"
