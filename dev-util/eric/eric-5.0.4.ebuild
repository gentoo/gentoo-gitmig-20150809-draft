...
# $Header: /var/cvsroot/gentoo-x86/dev-util/eric/eric-5.0.4.ebuild,v 1.4 2011/01/30 16:00:17 phajdan.jr Exp $
...
pkg_postinst() {
	python_mod_optimize -x "/eric5/DebugClients/Python/" ${MY_PN}{,config.py,plugins}
