...
# $Header: /var/cvsroot/gentoo-x86/dev-util/valgrind/valgrind-3.3.1-r1.ebuild,v 1.1 2008/12/13 10:57:06 griffon26 Exp $
...
src_unpack() {
	...
	# Add suppression file for glibc 2.9 and don't bail out on configure
	epatch "${FILESDIR}/valgrind-3.3.1-glibc-2.9.patch"
