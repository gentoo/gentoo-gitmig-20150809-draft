...
# $Header: /var/cvsroot/gentoo-x86/dev-util/gambas/gambas-0.92-r1.ebuild,v 1.1 2004/04/10 02:33:03 genone Exp $
...
src_unpack() {
	...
	# patch to fix bug with tabstrips
	epatch ${FILESDIR}/gbx_exec_enum-0.92.patch
}
