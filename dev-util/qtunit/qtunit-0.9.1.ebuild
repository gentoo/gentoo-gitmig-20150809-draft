...
# $Header: /var/cvsroot/gentoo-x86/dev-util/qtunit/qtunit-0.9.1.ebuild,v 1.1 2002/01/08 16:04:17 gbevin Exp $

S=${WORKDIR}/${P}
DESCRIPTION="QtUnit is a unit testing framework for c++"
SRC_URI="http://prdownloads.sourceforge.net/qtunit/qtunit-0.9.1.tar.bz2"
