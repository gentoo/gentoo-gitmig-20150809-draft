...
# $Header: /var/cvsroot/gentoo-x86/dev-util/glimmer/glimmer-1.2.1-r2.ebuild,v 1.2 2002/08/16 04:04:41 murphy Exp $
...
src_install () {
	cd ${WORKDIR}/${P}
	make DESTDIR=${D} prefix=${D}/usr sysconfdir=${D}/etc/gnome install || die
