...
# $Header: /var/cvsroot/gentoo-x86/dev-util/mercurial/mercurial-0.9.1.ebuild,v 1.1 2006/08/08 19:04:00 agriffis Exp $
...
src_compile() {
	...
	rm -rf contrib/vim	# app-vim/hgcommand app-vim/hg-menu app-vim/patchreview
}
