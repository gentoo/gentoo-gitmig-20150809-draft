...
# $Header: /var/cvsroot/gentoo-x86/dev-util/pccts/pccts-1.33.33.ebuild,v 1.11 2004/11/06 15:55:55 pyrania Exp $
...
src_unpack() {
	...
	patch ${FILESDIR}/${PF}-gentoo.diff || die "epatch failed."
}
