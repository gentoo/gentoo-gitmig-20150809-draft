...
# $Header: /var/cvsroot/gentoo-x86/www-misc/fcgiwrap/fcgiwrap-1.0.3.ebuild,v 1.1 2010/09/15 07:12:12 pva Exp $
...
if [[ ${PV} == *9999* ]]; then
	...
	MY_REV="58ec209"
	SRC_URI="http://download.github.com/gnosek-${P}-4-g${MY_REV}.tar.gz -> ${P}.tar.gz"
