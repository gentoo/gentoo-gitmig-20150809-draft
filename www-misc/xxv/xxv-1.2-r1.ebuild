...
# $Header: /var/cvsroot/gentoo-x86/www-misc/xxv/xxv-1.2-r1.ebuild,v 1.3 2009/04/16 00:31:36 hd_brummy Exp $
...
db_update_check() {
	...
	DB_VERS_OLD="`cat /var/db/pkg/www-misc/xxv-*/xxv-*.ebuild | grep DB_VERS | cut -c10-11`"
