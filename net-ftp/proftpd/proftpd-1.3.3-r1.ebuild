...
# $Header: /var/cvsroot/gentoo-x86/net-ftp/proftpd/proftpd-1.3.3-r1.ebuild,v 1.1 2010/06/23 13:37:01 voyageur Exp $
...
src_prepare() {
	...
	# Fix Gentoo Bug #284853, support newer mit-krb5
	if use kerberos; then
		cd "${WORKDIR}"/mod_gss-${GSS_VER}/ || die "mod_gss cd failed"
		sed -i -e "s/krb5_principal2principalname/_\0/" \
			mod_auth_gss.c.in || die "mod_auth_gss.c.in sed failed"
