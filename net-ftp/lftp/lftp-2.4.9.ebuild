...
# $Header: /var/cvsroot/gentoo-x86/net-ftp/lftp/lftp-2.4.9.ebuild,v 1.1 2002/01/31 04:47:49 woodchip Exp $
...
RDEPEND="virtual/glibc >=sys-libs/ncurses-5.1 ssl? ( >=dev-libs/openssl-0.9.6 )"
