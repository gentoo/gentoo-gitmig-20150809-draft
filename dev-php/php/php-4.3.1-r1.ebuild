...
# $Header: /var/cvsroot/gentoo-x86/dev-php/php/php-4.3.1-r1.ebuild,v 1.6 2003/03/03 09:23:03 vapier Exp $
...
src_compile() {
	...
	econf \
		...
		# Causing breakages -- fork not supported on this architecture
		# messages, so disabling this option for now.
		# --enable-pcntl \
