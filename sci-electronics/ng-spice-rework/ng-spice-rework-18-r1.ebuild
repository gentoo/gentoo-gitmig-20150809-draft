...
# $Header: /var/cvsroot/gentoo-x86/sci-electronics/ng-spice-rework/ng-spice-rework-18-r1.ebuild,v 1.1 2010/06/24 10:41:52 jlec Exp $
...
src_configure() {
	...
	econf \
		...
		$(use_with X x) \
		$(use_with readline)
#	sed 's:INSTALL_STRIP_FLAG=-s:INSTALL_STRIP_FLAG=:g' -i Makefile src/Makefile
}
