...
# $Header: /var/cvsroot/gentoo-x86/app-sci/foldingathome/foldingathome-4.0.0-r1.ebuild,v 1.1 2004/04/22 10:01:17 phosphan Exp $
...
src_install() {
	...
	doexe foldingathome
	exeinto /etc/init.d
	newexe ${FILESDIR}/folding-init.d-r2 foldingathome
