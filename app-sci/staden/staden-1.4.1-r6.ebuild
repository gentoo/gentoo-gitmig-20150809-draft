...
# $Header: /var/cvsroot/gentoo-x86/app-sci/staden/staden-1.4.1-r6.ebuild,v 1.1 2004/09/18 18:59:56 ribosome Exp $
...
src_compile() {
	...
	# Remove the old "spin_emboss" (replaced by "spin2_emboss")
	rm -r ${S}/lib/spin_emboss
