...
# $Header: /var/cvsroot/gentoo-x86/www-client/chromium/chromium-20.0.1096.1.ebuild,v 1.1 2012/04/11 12:54:21 phajdan.jr Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-selinux-r0.patch"
