...
# $Header: /var/cvsroot/gentoo-x86/www-client/chromium-bin/chromium-bin-5.0.375.127.ebuild,v 1.1 2010/08/21 02:34:59 phajdan.jr Exp $
...
src_install() {
	...
	# Symlink ffmpeg libraries so the browser can find them.
