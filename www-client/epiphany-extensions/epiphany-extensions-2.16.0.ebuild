...
# $Header: /var/cvsroot/gentoo-x86/www-client/epiphany-extensions/epiphany-extensions-2.16.0.ebuild,v 1.1 2006/09/07 04:26:27 dang Exp $
...
pkg_setup() {
	local extensions="actions certificates error-viewer extensions-manager-ui \
		gestures livehttpheaders page-info sample sample-mozilla \
