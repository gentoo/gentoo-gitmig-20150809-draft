...
# $Header: /var/cvsroot/gentoo-x86/www-client/rekonq/rekonq-0.5.0-r1.ebuild,v 1.1 2010/10/12 18:11:58 tampakrap Exp $
...
if [[ ${PV} != *9999* ]]; then
	KDE_LINGUAS="cs da de en_GB es et fr hu it lt nds pt_BR pt ru sv uk zh_CN"
	KDE_DOC_DIRS="docs"
