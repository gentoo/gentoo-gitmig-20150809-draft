...
# $Header: /var/cvsroot/gentoo-x86/www-client/mozilla-firefox/mozilla-firefox-2.0_beta2.ebuild,v 1.3 2006/09/28 02:15:02 weeve Exp $

inherit flag-o-matic toolchain-funcs eutils mozconfig-2 mozilla-launcher makeedit multilib fdo-mime mozextension autotools

PVER="1.3"
LANGS="af ar bg ca cs da de el en-GB es-AR es-ES eu fi fr gu-IN hu it ja
ko lt mk mn nb-NO nl nso pa-IN pl ru sk sl sv-SE tr xh zh-CN zh-TW zu"
