...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-10.70_pre9044.ebuild,v 1.1 2010/09/08 17:47:23 jer Exp $
...
O_V="${PV/_pre/-}"
O_P="${PN}-${O_V}"
O_U="http://snapshot.opera.com/unix/accordion_${O_V}/"
