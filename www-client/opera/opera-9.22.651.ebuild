...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.22.651.ebuild,v 1.2 2007/07/09 01:28:35 vapier Exp $
...
# http://snapshot.opera.com/unix/Weekly-641/intel-linux/opera-9.21-20070510.1-static-qt.i386-en-641.tar.bz2
# http://snapshot.opera.com/unix/Weekly-641/intel-linux/opera-9.21-20070510.6-shared-qt.i386-en-641.tar.bz2
SRC_URI="
	x86? ( qt-static? (
	${OPERA_URI}intel-linux/${PN}-${OPERAVER}.1-static-qt.i386-${OPERALNG}-${OPERASUFF}.tar.bz2 ) )
