...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-10.00_pre4449.ebuild,v 1.1 2009/06/24 16:35:37 jer Exp $
...
MY_LINGUAS="be bg cs da de el en-GB es-ES es-LA et fi fr fr-CA fy hi hr hu id it ja ka ko lt mk nb nl nn pl pt pt-BR ro ru sk sr sv ta te tr uk zh-CN zh-TW"

for MY_LINGUA in ${MY_LINGUAS}; do
	IUSE="${IUSE} linguas_${MY_LINGUA/-/_}"
done

O_U="http://snapshot.opera.com/unix/snapshot-4449/"
O_P="${P/_pre/-}"
