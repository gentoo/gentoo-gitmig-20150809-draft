...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.50_beta2_p1729.ebuild,v 1.1 2007/12/21 17:15:04 jer Exp $
...
SRC_URI="
	...
	qt-static? (
		...
		x86-fbsd? ( ${O_URI}intel-freebsd/${PN}-${O_VER}.1-static-qt.i386.freebsd${O_LNG}-${O_SUFF}.tar.bz2 )
		)
	!qt-static? (
