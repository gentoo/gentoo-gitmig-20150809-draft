...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.63.ebuild,v 1.3 2008/12/18 18:36:17 dertobi123 Exp $
...
MY_LINGUAS="be bg cs da de el en en-GB es-ES es-LA et fi fr fr-CA fy hi hr hu id
	it ja ka ko lt mk nb nl nn pl pt pt-BR ru sv ta te tr uk zh-CN zh-TW"
...
SRC_URI="
	x86-fbsd? ( ${O_URI}unix/freebsd/963/en/intel/shared/${P}-freebsd5-shared-qt3.i386.tar.bz2 )
