...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-10.62_pre6437.ebuild,v 1.1 2010/09/03 14:51:09 jer Exp $
...
O_V="${PV/_pre/-}"
O_P="${PN}-${O_V}"
O_U="http://snapshot.opera.com/unix/stability_${O_V}/"
