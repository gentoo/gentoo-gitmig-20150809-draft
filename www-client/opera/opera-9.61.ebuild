...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.61.ebuild,v 1.3 2008/10/24 20:52:55 jer Exp $
...
MY_LINGUAS="be bg cs da de el en en-GB es-ES es-LA fi fr fr-CA fy hi hr hu id it ja ka ko lt mk nb nl nn pl pt pt-BR ru sv tr uk zh-CN zh-TW"
...
SRC_URI="
	x86-fbsd? ( ${O_URI}unix/freebsd/961/en/intel/shared/${P}-freebsd5-shared-qt3.i386.tar.bz2 )
