...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.50_rc1629.ebuild,v 1.3 2007/10/18 15:57:34 jer Exp $
...
SRC_URI="
	...
	x86-fbsd? (
		qt-static? ( ${O_URI}/intel-freebsd/${PN}-${O_VER}.5-static-qt.i386.freebsd${O_LNG}-${O_SUFF}.tar.bz2 )
