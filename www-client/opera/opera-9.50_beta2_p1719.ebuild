...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.50_beta2_p1719.ebuild,v 1.1 2007/12/14 17:16:19 jer Exp $
...
SRC_URI="
	...
	qt-static? (
		...
		x86? ( ${O_URI}intel-linux/${PN}-${O_VER}.10-static-qt.i386${O_LNG}-${O_SUFF}.tar.bz2 )
	...
	!qt-static? (
		...
		x86-fbsd? ( ${O_URI}intel-freebsd/${PN}-${O_VER}.7-shared-qt.i386.freebsd${O_LNG}-${O_SUFF}.tar.bz2 )
		)
	"
