...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.52_rc1.ebuild,v 1.1 2008/08/14 15:03:57 jer Exp $
...
SRC_URI="
	...
	ppc? ( ${O_URI}ppc-linux/${O_P}.gcc3-shared-qt3.ppc.tar.bz2 )
	qt-static? (
		qt3-static? (
			amd64? (
