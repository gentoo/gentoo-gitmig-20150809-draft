...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-10.10_pre4672.ebuild,v 1.4 2009/11/09 20:55:26 jer Exp $
...
O_U="mirror://opera/linux/1010b1/beta1/en/"
O_P="opera-10.10-b1"

SRC_URI="
	amd64? (
		!ia32? (
			qt-static? ( ${O_U}x86_64/${O_P}.gcc4-bundled-qt4.x86_64.tar.bz2 )
			!qt-static? (
				qt3? ( ${O_U}x86_64/${O_P}.gcc4-shared-qt3.x86_64.tar.bz2 )
				!qt3? ( ${O_U}x86_64/${O_P}.gcc4-qt4.x86_64.tar.bz2 )
			)
		)
		ia32? (
			qt-static? ( ${O_U}i386/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
			!qt-static? (
				qt3? ( ${O_U}i386/${O_P}.gcc4-shared-qt3.i386.tar.bz2 )
				!qt3? ( ${O_U}i386/${O_P}.gcc4-qt4.i386.tar.bz2 )
			)
		)
	)
	ppc? ( ${O_U}ppc/${O_P}.gcc4-shared-qt3.ppc.tar.bz2 )
	x86? (
		qt-static? ( ${O_U}i386/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
		!qt-static? (
			qt3? ( ${O_U}i386/${O_P}.gcc4-shared-qt3.i386.tar.bz2 )
	...
	x86-fbsd? ( mirror://opera/unix/freebsd/1010b1/en/intel/${O_P}-freebsd7-shared-qt3.i386.tar.bz2 )
	"
