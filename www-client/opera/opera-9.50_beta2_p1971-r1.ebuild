...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.50_beta2_p1971-r1.ebuild,v 1.1 2008/05/20 23:38:43 jer Exp $
...
O_SUFF="1971"
O_VER="${PN}-9.50-${O_SUFF}"
O_URI="http://snapshot.opera.com/unix/snapshot-${O_SUFF}/"

SRC_URI="
	amd64? ( ${O_URI}x86_64-linux/${O_VER}.gcc4-shared-qt3.x86_64.tar.bz2 )
	ppc? ( ${O_URI}ppc-linux/${O_VER}.gcc4-shared-qt3.ppc.tar.bz2 )
	x86-fbsd? ( ${O_URI}intel-freebsd/${O_VER}.freebsd5-shared-qt3.i386.tar.bz2 )
	qt-static? (
		x86? ( ${O_URI}intel-linux/${O_VER}.gcc4-qt4.i386.tar.bz2 )
	)
	!qt-static? (
		x86? ( ${O_URI}intel-linux/${O_VER}.gcc4-shared-qt3.i386.tar.bz2 )
	)
	"
