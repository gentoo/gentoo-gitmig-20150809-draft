...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.26.ebuild,v 1.4 2008/02/22 14:01:04 dertobi123 Exp $
...
O_SUFF="698"
O_VER="9.26-20080215"
O_FTP="926/final/${O_LNG}"

O_URI="mirror://opera/"
SRC_URI="
	x86? ( qt-static? ( ${O_URI}linux/${O_FTP}/i386/static/${PN}-${O_VER}.1-static-qt.i386-${O_LNG}.tar.bz2 ) )
	x86? ( !qt-static? ( ${O_URI}linux/${O_FTP}/i386/shared/${PN}-9.26-20080218.6-shared-qt.i386-${O_LNG}.tar.bz2 ) )
	amd64? ( qt-static? ( ${O_URI}linux/${O_FTP}/i386/static/${PN}-${O_VER}.1-static-qt.i386-${O_LNG}.tar.bz2 ) )
	amd64? ( !qt-static? ( ${O_URI}linux/${O_FTP}/i386/shared/${PN}-9.26-20080218.6-shared-qt.i386-${O_LNG}.tar.bz2 ) )
