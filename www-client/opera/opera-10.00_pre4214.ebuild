...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-10.00_pre4214.ebuild,v 1.4 2009/04/10 13:26:17 ulm Exp $
...
O_U="http://snapshot.opera.com/unix/10-turbo/"
O_P="${P/_pre/-}"
...
SRC_URI="
	qt-static? (
		qt3? (
			amd64? (
				ia32? ( ${O_U}intel-linux/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
				!ia32? ( ${O_U}x86_64-linux/${O_P}.gcc4-shared-qt3.x86_64.tar.bz2 )
			)
			x86? ( ${O_U}intel-linux/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
		)
		!qt3? (
			amd64? (
				ia32? ( ${O_U}intel-linux/${O_P}.gcc4-bundled-qt4.i386.tar.bz2 )
