...
# $Header: /var/cvsroot/gentoo-x86/www-client/opera/opera-9.64.ebuild,v 1.9 2009/08/22 19:37:04 williamh Exp $
...
MY_LINGUAS="be bg cs da de el en-GB es-ES es-LA et fi fr fr-CA fy hi hr hu id
...
O_URI="mirror://opera/"
O_VER="964"
O_FTP="/${O_VER}/final/en/"
O_SUFF="2480"

SRC_URI="
	x86-fbsd? ( ${O_URI}unix/freebsd/${O_VER}/en/intel/shared/${P}-freebsd5-shared-qt3.i386.tar.bz2 )
