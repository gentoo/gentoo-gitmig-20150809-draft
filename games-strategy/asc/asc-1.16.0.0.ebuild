...
# $Header: /var/cvsroot/gentoo-x86/games-strategy/asc/asc-1.16.0.0.ebuild,v 1.3 2005/07/30 10:08:53 vapier Exp $
...
src_install() {
	...
	dohtml -r doc/*
	make_desktop_entry asc "Advanced Strategic Command"
	prepgamesdirs
}
