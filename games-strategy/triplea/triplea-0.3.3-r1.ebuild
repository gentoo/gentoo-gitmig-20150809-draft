...
# $Header: /var/cvsroot/gentoo-x86/games-strategy/triplea/triplea-0.3.3-r1.ebuild,v 1.1 2004/04/10 23:24:18 mr_bones_ Exp $
...
src_unpack() {
	...
	sed -i \
		-e "s:home/sgb/dev/junit/junit3.8.1:usr/share/junit/lib:" \
			.ant.properties \
