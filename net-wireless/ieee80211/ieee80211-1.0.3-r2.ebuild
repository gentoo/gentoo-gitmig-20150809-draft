...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ieee80211/ieee80211-1.0.3-r2.ebuild,v 1.2 2005/09/08 08:21:57 brix Exp $
...
pkg_setup() {
	...
	if [[ -f ${KV_DIR}/include/net/ieee80211.h ]]; then
		eerror
		eerror "You kernel source contains an incompatible version of the"
