...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/kismet/kismet-2005.01.1.ebuild,v 1.3 2005/04/03 10:38:58 brix Exp $

inherit gnuconfig linux-info

MY_P=${P/\./-}
MY_P=${MY_P/./-R}
S=${WORKDIR}/${MY_P}

ETHEREAL_VERSION="0.10.8"
...
RDEPEND="virtual/libc
		...
		# above libs - 2005-01-R1 doesn't honor the --disable-gps flag
		# brix@gentoo.org
...
src_unpack() {
	...
	sed -i "s:-I/lib/modules/.*/build/include/:-I${KV_DIR}/include/:g" \
		${S}/configure
