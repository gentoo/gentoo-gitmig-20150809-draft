...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/kismet/kismet-2005.04.1-r1.ebuild,v 1.2 2005/07/07 09:56:30 brix Exp $
...
src_compile() {
	...
	if ! use gps; then
		...
		# libs in RDEPEND - 2005-04-R1 doesn't honor the --disable-gps flag
