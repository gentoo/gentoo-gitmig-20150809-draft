...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ipw2200/ipw2200-0.11.ebuild,v 1.2 2005/01/18 10:37:27 brix Exp $
...
src_install() {
	...
	# Create symbolic links for new hotplug firmware location
	dodir /lib/firmware
	dosym /usr/lib/hotplug/firmware/${PN}_boot.fw /lib/firmware/${PN}_boot.fw
	dosym /usr/lib/hotplug/firmware/${PN}_bss.fw /lib/firmware/${PN}_bss.fw
	dosym /usr/lib/hotplug/firmware/${PN}_ibss.fw /lib/firmware/${PN}_ibss.fw
	dosym /usr/lib/hotplug/firmware/${PN}_ucode.fw /lib/firmware/${PN}_ucode.fw
}
