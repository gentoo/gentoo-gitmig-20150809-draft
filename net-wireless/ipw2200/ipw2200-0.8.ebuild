...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ipw2200/ipw2200-0.8.ebuild,v 1.1 2004/09/19 21:31:59 jbms Exp $
...
src_compile() {
	...
	# Build WPA support
	emake KSRC=${ROOT}/usr/src/linux all CONFIG_IEEE80211_CRYPT_WPA=m \
		CONFIG_IEEE80211_CRYPT_TKIP=m \
		CONFIG_IEEE80211_CRYPT_CCMP=m || die
}
