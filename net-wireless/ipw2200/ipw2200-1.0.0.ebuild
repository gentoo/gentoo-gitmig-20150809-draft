...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ipw2200/ipw2200-1.0.0.ebuild,v 1.1 2005/02/01 16:32:27 jbms Exp $
...
MODULESD_IPW2100_DOCS="README.${PN}"
...
src_unpack() {
	...
	if ! use debug > /dev/null; then
		einfo "Patching Makefile to disable debugging"
