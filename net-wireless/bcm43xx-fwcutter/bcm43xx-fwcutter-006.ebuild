...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/bcm43xx-fwcutter/bcm43xx-fwcutter-006.ebuild,v 1.3 2008/03/22 15:59:01 josejx Exp $
...
pkg_postinst() {
	if ! [ -f /lib/firmware/${PN}_microcode2.fw ]; then
		...
		einfo "REAME in /usr/share/doc/${P}"
		einfo
	fi
