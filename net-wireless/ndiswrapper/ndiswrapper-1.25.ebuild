...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ndiswrapper/ndiswrapper-1.25.ebuild,v 1.1 2006/10/14 11:22:37 betelgeuse Exp $
...
pkg_postinst() {
	...
	einfo "information."
	echo
#	ewarn "Windows driver configuration file format has changed since 1.5."
#	ewarn "You must re-install Windows drivers if they were installed before."
