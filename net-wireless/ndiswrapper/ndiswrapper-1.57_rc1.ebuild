...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/ndiswrapper/ndiswrapper-1.57_rc1.ebuild,v 1.1 2011/10/29 08:14:01 angelos Exp $
...
SRC_URI="mirror://sourceforge/${PN}/testing/${PV/_/-}/${PN}-${MY_PV}.tar.gz"
