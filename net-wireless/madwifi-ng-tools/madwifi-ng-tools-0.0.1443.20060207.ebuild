...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/madwifi-ng-tools/madwifi-ng-tools-0.0.1443.20060207.ebuild,v 1.1 2006/07/09 18:24:03 brix Exp $

inherit toolchain-funcs

MY_P=madwifi-ng-r${PV:4:4}-${PV:9:10}
S=${WORKDIR}/${MY_P}
