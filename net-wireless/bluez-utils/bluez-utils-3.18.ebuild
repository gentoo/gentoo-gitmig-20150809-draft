...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/bluez-utils/bluez-utils-3.18.ebuild,v 1.1 2007/09/03 14:28:16 betelgeuse Exp $
...
src_unpack() {
	...
	# bundled glib
	cd "${S}"
	epatch "${FILESDIR}/3.18-a2dp.patch"
