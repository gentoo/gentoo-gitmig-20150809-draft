...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/wireless-tools/wireless-tools-27_pre26-r1.ebuild,v 1.1 2004/09/26 10:46:28 brix Exp $
...
src_unpack() {
	...
	sed -i "s:^CFLAGS=:CFLAGS=${CFLAGS} -I/usr/src/linux/include :" \
		${S}/Makefile
}
