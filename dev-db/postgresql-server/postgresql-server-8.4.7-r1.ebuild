...
# $Header: /var/cvsroot/gentoo-x86/dev-db/postgresql-server/postgresql-server-8.4.7-r1.ebuild,v 1.1 2011/03/21 03:50:18 titanofold Exp $
...
src_install() {
	...
	rm -r "${ED}/usr/share/postgresql-${SLOT}/man/man7/" "${ED}/usr/share/doc/postgresql-${SLOT}/html" || die
...
pkg_postinst() {
	...
	elog
	elog "If you have users and/or services that you would like to utilize the socket, you"
	elog "must add them to the 'postgres' system group:"
