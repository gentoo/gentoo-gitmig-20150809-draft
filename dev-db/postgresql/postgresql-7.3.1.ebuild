...
# $Header: /var/cvsroot/gentoo-x86/dev-db/postgresql/postgresql-7.3.1.ebuild,v 1.2 2003/01/31 21:24:09 rphillips Exp $
...
DEPEND="virtual/glibc
		...
		java? ( >=dev-java/sun-jdk-1.3* >=dev-java/ant-1.3 ) 
