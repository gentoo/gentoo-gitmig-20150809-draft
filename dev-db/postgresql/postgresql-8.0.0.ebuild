...
# $Header: /var/cvsroot/gentoo-x86/dev-db/postgresql/postgresql-8.0.0.ebuild,v 1.2 2005/01/23 05:03:22 eradicator Exp $
...
MY_PV=${PV/_/}
MY_P=${PN}-${MY_PV}
SRC_URI="mirror://postgresql/source/v8.0.0/${PN}-base-${MY_PV}.tar.bz2
	mirror://postgresql/source/v8.0.0/${PN}-opt-${MY_PV}.tar.bz2
	doc? ( mirror://postgresql/source/v8.0.0/${PN}-docs-${MY_PV}.tar.bz2 )"
