...
# $Header: /var/cvsroot/gentoo-x86/gnome-apps/nautilus/nautilus-1.0.4-r2.ebuild,v 1.1 2001/09/03 20:45:00 hallski Exp $
...
src_unpack() {
	unpack ${A}
	cd ${S}
	patch -p1 < ${FILESDIR}/nautilus-1.0.4-mozilla-0.9.3.patch
}
