...
# $Header: /var/cvsroot/gentoo-x86/app-shells/bash-completion/bash-completion-20050121-r2.ebuild,v 1.1 2005/02/07 15:08:00 ka0ttic Exp $

inherit eutils

GENCOMP_VERS="20050207"
...
#    epatch ${FILESDIR}/gentoo-bashcomp-${GENCOMP_VERS}-XXX.diff
}
