...
# $Header: /var/cvsroot/gentoo-x86/app-shells/bash/bash-3.1_p5-r2.ebuild,v 1.1 2006/01/15 22:25:13 vapier Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/readline-5.1-terminal-autowrap.patch #118205
	cd ../..
