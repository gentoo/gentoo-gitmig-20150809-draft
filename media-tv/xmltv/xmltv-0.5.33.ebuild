...
# $Header: /var/cvsroot/gentoo-x86/media-tv/xmltv/xmltv-0.5.33.ebuild,v 1.2 2004/06/25 00:35:02 agriffis Exp $
...
[ -z "${XMLTV_OPTS}" ] || has tv_grab_na_icons ${XMLTV_OPTS} \
	&& DEPEND="${DEPEND} >=dev-perl/WWW-Mechanize"
...
[ -z "${XMLTV_OPTS}" ] || has tv_grab_no ${XMLTV_OPTS} \
	&& DEPEND="${DEPEND} dev-perl/HTML-LinkExtractor"
