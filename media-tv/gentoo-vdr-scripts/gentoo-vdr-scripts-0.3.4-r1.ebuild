...
# $Header: /var/cvsroot/gentoo-x86/media-tv/gentoo-vdr-scripts/gentoo-vdr-scripts-0.3.4-r1.ebuild,v 1.1 2006/06/12 20:08:55 zzam Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/vdr-bg-quoting.patch
}
