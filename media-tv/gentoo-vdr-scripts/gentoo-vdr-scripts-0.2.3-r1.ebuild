...
# $Header: /var/cvsroot/gentoo-x86/media-tv/gentoo-vdr-scripts/gentoo-vdr-scripts-0.2.3-r1.ebuild,v 1.2 2006/03/20 16:03:49 zzam Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-0.2.2-config-comment-irctrl.patch
	epatch ${FILESDIR}/${P}-sed-path.patch
}
