...
# $Header: /var/cvsroot/gentoo-x86/media-tv/gentoo-vdr-scripts/gentoo-vdr-scripts-0.2.2-r1.ebuild,v 1.1 2006/02/13 22:17:08 zzam Exp $
...
src_unpack() {
	...
	epatch ${FILESDIR}/${PN}-0.2.3-sed-path.patch
}
